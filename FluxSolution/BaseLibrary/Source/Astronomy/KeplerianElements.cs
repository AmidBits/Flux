namespace Flux
{
    ...
    where TSelf : System.Numerics.IFloatingPointIeee754<TSelf>
  {
    ...
    public Flux.Matrix4<TSelf> ToMatrix4()
    {
    ...
    public static EulerAngles<TSelf> ToEulerAngles(CoordinateSystems.CartesianCoordinate3<TSelf> x, CoordinateSystems.CartesianCoordinate3<TSelf> y, CoordinateSystems.CartesianCoordinate3<TSelf> z)
    {
      x = x.Normalized();
      y = y.Normalized();
      z = z.Normalized();
