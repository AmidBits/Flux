namespace Flux
{
	public static partial class BitOps
	{
		...
		/// <summary>Determines the index position of the specified power-of-two bit value. The value must be power of two, i.e. only a single bit set, or the result will be -1. For the same result of an arbitrary number, use Log2() or MostSignificant1Bit().</summary>
