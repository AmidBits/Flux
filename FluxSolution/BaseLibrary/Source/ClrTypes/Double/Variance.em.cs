namespace Flux
{
  public static partial class XtensionsDouble
  {
    ...
    public static (int count, double mean, double sampleVariance, double variance) Variance(this System.Collections.Generic.IEnumerable<double> source)
    {
      var count = 0;
      ...
      return (count >= 2) ? (count, mean, M2 / (count - 1), M2 / count) : throw new System.ArgumentException(@"The sequence must contain at least two elements.");
    }
  }
}
