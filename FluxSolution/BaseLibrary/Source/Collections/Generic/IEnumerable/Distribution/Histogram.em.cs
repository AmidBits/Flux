namespace Flux
{
  public static partial class SystemCollectionsGenericIEnumerableEm
  {
    ...
    public static System.Collections.Generic.SortedDictionary<TKey, int> Histogram<TSource, TKey>(this System.Collections.Generic.IEnumerable<TSource> source, System.Func<TSource, int, TKey> keySelector, out int sumOfAllFrequencies, System.Collections.Generic.IComparer<TKey> comparer)
      where TKey : notnull
    {
      ...
      foreach (var item in source)
      {
        ...
        histogram[key] = histogram.TryGetValue(key, out var value) ? value + 1 : 1;
      }
    ...
    /// <see cref="https://en.wikipedia.org/wiki/Histogram"/>
    public static System.Collections.Generic.SortedDictionary<TKey, int> Histogram<TSource, TKey>(this System.Collections.Generic.IEnumerable<TSource> source, System.Func<TSource, int, TKey> keySelector, out int sumOfAllFrequencies)
      where TKey : notnull
    ...
    /// <see cref="https://en.wikipedia.org/wiki/Histogram"/>
    public static System.Collections.Generic.SortedDictionary<TKey, int> Histogram<TSource, TKey>(this System.Collections.Generic.IEnumerable<TSource> source, System.Func<TSource, int, TKey> keySelector, System.Func<TSource, int, int> frequencySelector, out int sumOfAllFrequencies)
      where TKey : notnull
