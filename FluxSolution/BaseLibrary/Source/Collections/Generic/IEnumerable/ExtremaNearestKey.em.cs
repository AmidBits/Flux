namespace Flux
{
  public static partial class ExtensionMethods
  {
    ...
    public static (TSource elementMaxLt, int indexMaxLt, TSource elementMinGt, int indexMinGt) ExtremaNearestKey<TSource, TKey>(this System.Collections.Generic.IEnumerable<TSource> source, System.Func<TSource, TKey> keySelector, TKey proximityKey, System.Collections.Generic.IComparer<TKey> comparer)
    {
    ...
    /// <summary>Locate the max element that is less than and the min element that is greater than the specified reference value identified by the <see cref="keySelector"/>. Uses the specified comparer.</summary>
    public static (TSource elementMaxLt, int indexMaxLt, TSource elementMinGt, int indexMinGt) ExtremaNearestKey<TSource, TValue>(this System.Collections.Generic.IEnumerable<TSource> source, System.Func<TSource, TValue> valueSelector, TValue proximityKey)
      => ExtremaNearestKey(source, valueSelector, proximityKey, System.Collections.Generic.Comparer<TValue>.Default);
  }
}
