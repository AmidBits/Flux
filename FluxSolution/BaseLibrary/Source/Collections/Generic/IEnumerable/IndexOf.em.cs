...
namespace Flux
{
  public static partial class XtendCollections
  {
    ...
    /// <summary>Invokes a transform on each element of a generic sequence and returns the index of the minimum value.</summary>
    public static int IndexOfMin<T, TResult>(this System.Collections.Generic.IEnumerable<T> source, System.Func<T, TResult> selector, System.Collections.Generic.IComparer<TResult>? comparer = null)
    {
      if (source is null) throw new System.ArgumentOutOfRangeException(nameof(source));
      else if (selector is null) throw new System.ArgumentNullException(nameof(selector));
