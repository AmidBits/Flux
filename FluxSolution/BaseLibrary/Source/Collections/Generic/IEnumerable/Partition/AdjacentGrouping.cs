namespace Flux
{
	...
	{
		private System.Collections.Immutable.IImmutableList<TElement> m_elements = System.Collections.Immutable.ImmutableList<TElement>.Empty;

		public int Count
			=> m_elements.Count;

		public void Add(TElement element)
			=> m_elements = m_elements.Add(element);
