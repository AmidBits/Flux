namespace Flux
{
  public static partial class ExtensionMethods
  {
    ...
    /// <summary>Creates a new array from the specified array from the specified offset to the end.</summary>
    public static T[] ToArray<T>(this System.Collections.Generic.IList<T> source, int offset)
      => ToArray(source, offset, (source ?? throw new System.ArgumentNullException(nameof(source))).Count - offset);

    /// <summary>Creates a new array from the specified array from the specified offset and count.</summary>
    public static T[] ToArray<T>(this System.Collections.Generic.IList<T> source, int offset, int count, int countEmptyPreElements, int countEmptyPostElements)
    {
      if (source is null) throw new System.ArgumentNullException(nameof(source));
      if (offset < 0 || offset >= source.Count) throw new System.ArgumentOutOfRangeException(nameof(offset));
      if (count < 0 || count + offset >= source.Count) throw new System.ArgumentOutOfRangeException(nameof(count));
