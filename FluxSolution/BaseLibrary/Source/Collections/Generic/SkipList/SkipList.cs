...
//		private int _count;
//		private System.Random _rndNum;
//		private System.Collections.Generic.IComparer<T> comparer = System.Collections.Generic.Comparer<T>.Default;
//		#endregion

//		#region Constructors
//		public SkipList() : this(-1, null) { }
//		public SkipList(int randomSeed) : this(randomSeed, null) { }
//		public SkipList(System.Collections.Generic.IComparer<T> comparer) : this(-1, comparer) { }
//		public SkipList(int randomSeed, System.Collections.Generic.IComparer<T> comparer)
//		{
...
//			_count++;
//			if (randomSeed < 0)
//				_rndNum = new System.Random();
//			else
//				_rndNum = new System.Random(randomSeed);
