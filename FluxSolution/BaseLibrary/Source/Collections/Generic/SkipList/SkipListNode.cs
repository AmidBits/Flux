...
//		/// <summary>Returns the height of the SkipListNode.</summary>
//		public int Height
//			=> base.Neighbors.Count;

//		/// <summary>Provides ordinally-indexed access to the neighbors of the SkipListNode.</summary>
//		public SkipListNode<T> this[int index] 
//		{ get { return (SkipListNode<T>)base.Neighbors[index]; } set { base.Neighbors[index] = value; } }
//	}
//}
