...
//	public class SkipListNodeList<T>
//		: NodeList<T>
//	{
//		public SkipListNodeList(int height)
//			: base(height) { }

//		/// <summary>Increases the size of the SkipListNodeList by one, adding a default SkipListNode.</summary>
...
//		/// <summary>Decreases the size of the SkipListNodeList by one, removing the "top-most" SkipListNode.</summary>
//		internal void DecrementHeight()
//		{
//			base.Items.RemoveAt(base.Items.Count - 1); // Delete the last entry.
//		}
//	}
//}
