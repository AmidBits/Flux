...
namespace Flux.Collections.Immutable
{
    ...
    where TKey : System.IComparable<TKey>
  {
    ...
    public IBinarySearchTree<TKey, TValue> Add(TKey key, TValue value) => key.CompareTo(Key) > 0 ? new BinarySearchTree<TKey, TValue>(Key, Value, Left, Right.Add(key, value)) : new BinarySearchTree<TKey, TValue>(Key, Value, Left.Add(key, value), Right);
      ...
      : IBinarySearchTree<TKey, TValue>
    {
      ...
      public IBinarySearchTree<TKey, TValue> Add(TKey key, TValue value) => new BinarySearchTree<TKey, TValue>(key, value, this, this);
