namespace Flux
{
	public static partial class SetSortEm
	{
		...
		public static void ApplyHeapSort<T>(this System.Collections.Generic.IList<T> source, Sequence.Sort.HeapSortType type, System.Collections.Generic.IComparer<T> comparer)
			=> new Sequence.Sort.HeapSort<T>(type, comparer).SortInPlace((T[])source);
		/// <summary>Sorts the content of the sequence using heap sort.</summary>
		public static void ApplyHeapSort<T>(this System.Collections.Generic.IList<T> source, Sequence.Sort.HeapSortType type)
			=> ApplyHeapSort(source, type, System.Collections.Generic.Comparer<T>.Default);

		/// <summary>Sorts the content of the sequence using heap sort.</summary>
		public static void ApplyHeapSort<T>(this System.Span<T> source, Sequence.Sort.HeapSortType type, System.Collections.Generic.IComparer<T> comparer)
			=> new Sequence.Sort.HeapSort<T>(type, comparer).SortInPlace(source);
		/// <summary>Sorts the content of the sequence using heap sort.</summary>
		public static void ApplyHeapSort<T>(this System.Span<T> source, Sequence.Sort.HeapSortType type)
			=> ApplyHeapSort(source, type, System.Collections.Generic.Comparer<T>.Default);
	}
