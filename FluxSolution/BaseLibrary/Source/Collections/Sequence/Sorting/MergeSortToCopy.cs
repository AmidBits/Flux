namespace Flux
{
	public static partial class SetSortEm
	{
		...
		public static System.Collections.Generic.IList<T> MergeSortToCopy<T>(this System.Collections.Generic.IList<T> source, Sequence.Sort.MergeSortType type, System.Collections.Generic.IComparer<T> comparer)
			=> new Sequence.Sort.MergeSortToCopy<T>(type, comparer).SortToCopy((T[])source);
		/// <summary>Sorts the content of the sequence using merge sort.</summary>
		public static System.Collections.Generic.IList<T> MergeSortToCopy<T>(this System.Collections.Generic.IList<T> source, Sequence.Sort.MergeSortType type)
			=> new Sequence.Sort.MergeSortToCopy<T>(type, System.Collections.Generic.Comparer<T>.Default).SortToCopy((T[])source);
	}
