namespace Flux
{
  public static partial class XtendSequencing
  {
    ...
    public static void HeapSort<T>(this System.Span<T> source, HeapSortType type, System.Collections.Generic.IComparer<T> comparer)
      => new HeapSort<T>(type, comparer).Sort(source);
    /// <summary>Sorts the content of the sequence using heap sort.</summary>
    public static void HeapSort<T>(this System.Span<T> source, HeapSortType type)
