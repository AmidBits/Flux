namespace Flux
{
  ...
  public sealed class SequenceBuilder<T>
  {
    ...
    {
      var powerOf2Capacity = BitOps.NearestPow2AwayFromZero(capacity, false, out int _);
    ...
    private void EnsureUniformSpace(int length)
    {
      ...
      {
        var allocateLength = BitOps.NearestPow2AwayFromZero(length * 2, false, out int _);
    ...
    private void EnsureAppendSpace(int length)
    {
      ...
      {
        var allocateLength = BitOps.NearestPow2AwayFromZero(length, false, out int _);
