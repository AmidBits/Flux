namespace Flux
{
  public static partial class Xtensions
  {
    ...
    public static System.Data.DataTable RotateLeft(this System.Data.DataTable source, out string[] sourceColumnNames, params string[] targetColumnNames)
    {
    ...
    /// <param name="sourceColumnNames">Outputs the column names of the source data table.</param>
    /// <param name="targetColumnNames">If less target column names than needed are specified, "Column_[ordinalIndex]" will be used.</param>
    public static System.Data.DataTable RotateRight(this System.Data.DataTable source, out string[] sourceColumnNames, params string[] targetColumnNames)
    {
      if (source is null) throw new System.ArgumentNullException(nameof(source));
