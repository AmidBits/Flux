namespace Flux.Data
{
		...
		: Disposable, System.Data.IDataReader, System.Collections.Generic.IEnumerable<System.Data.IDataRecord>
	{
		...
		public System.Collections.Generic.List<bool> FieldAllowDBNulls { get; } = new System.Collections.Generic.List<bool>();
		/// <summary>An array of the T-SQL data types for the result.</summary>
		public System.Collections.Generic.List<string> FieldTsqlDataTypes { get; } = new System.Collections.Generic.List<string>();
