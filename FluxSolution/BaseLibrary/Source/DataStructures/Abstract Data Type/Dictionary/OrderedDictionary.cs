namespace Flux
{
  ...
  {
    /// <summary>
    /// <para>Creates a new <see cref="DataStructure.OrderedDictionary{TKey, TValue}"/> with the specified <paramref name="equalityComparer"/> and all items from <paramref name="source"/> using <paramref name="keySelector"/> and <paramref name="valueSelector"/> for each item.</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Creates a new <see cref="DataStructure.OrderedDictionary{TKey, TValue}"/> with all key-value-pairs from <paramref name="source"/>.</para>
    /// </summary>
    /// <typeparam name="TKey"></typeparam>
    /// <typeparam name="TValue"></typeparam>
    /// <param name="source"></param>
    /// <param name="equalityComparer"></param>
    /// <returns></returns>
    public static DataStructure.OrderedDictionary<TKey, TValue> ToOrderedDictionary<TKey, TValue>(this System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<TKey, TValue>> source, System.Collections.Generic.IEqualityComparer<TKey>? equalityComparer = null)
      where TKey : notnull
      => source.ToOrderedDictionary((e, i) => e.Key, (e, i) => e.Value, equalityComparer);
  }
