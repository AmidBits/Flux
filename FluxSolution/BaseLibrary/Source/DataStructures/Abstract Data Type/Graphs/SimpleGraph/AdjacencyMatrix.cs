namespace Flux.DataStructures.Graphs
{
    ...
    where TEdgeValue : notnull
  {
    ...
    {
      m_matrix = (int[,])matrix.AssertDimensionallySymmetrical(out var _); // matrix.IsSymmetrical() ? matrix : throw new System.ArgumentOutOfRangeException(nameof(matrix));
    ...
    public override string ToString()
    {
      ...
      sb.Append(string.Join(System.Environment.NewLine, grid.Rank2ToConsole(new ConsoleStringOptions() { UniformWidth = true, CenterContent = true })));
