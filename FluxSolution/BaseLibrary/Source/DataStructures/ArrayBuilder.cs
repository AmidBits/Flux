//namespace Flux
//{
//  public record class ArrayBuilder<T>
...
//    }
//    public ArrayBuilder() : this(DefaultBufferSize) { }

//    public ArrayBuilder(T value) : this() => Append(value);
//    public ArrayBuilder(System.ReadOnlySpan<T> readOnlySpan) : this(readOnlySpan.Length) => Append(readOnlySpan);
//    public ArrayBuilder(System.Span<T> span) : this(span.Length) => Append(span);
//    public ArrayBuilder(System.Collections.Generic.IEnumerable<T> collection) : this() => Append(collection);
...
//    {
//      var totalCapacity = (sideCapacity + Length + sideCapacity);
...
//      {
//        var array = System.Buffers.ArrayPool<T>.Shared.Rent(totalCapacity.Pow2AwayFromZero(false, out int _));
...
//      {
//        var totalCapacity = PrependCapacity + Length + appendCapacity;

//        if (Capacity <= totalCapacity) // Not enough total capacity.
//        {
//          var array = System.Buffers.ArrayPool<T>.Shared.Rent(totalCapacity.Pow2AwayFromZero(false, out int _));

//          System.Array.Copy(m_array, m_head, array, m_head, Length); // Copy old content.

//          System.Buffers.ArrayPool<T>.Shared.Return(m_array); // Recycle the old array.

//          m_array = array;
//        }
//        else // Enough capacity, so center content.
//        {
//          var head = (Capacity - Length) / 2;
//          var tail = head + Length;
...
//          m_tail = tail;
//        }
//        else // Enough total capacity, so center content.
//        {
//          var head = (Capacity - Length) / 2;
//          var tail = head + Length;
...
//    public ArrayBuilder<T> Append(T value, int count = 1)
//    {
//      m_version++;
...
//    public ArrayBuilder<T> Append(System.ReadOnlySpan<T> values, int count = 1)
//    {
//      m_version++;

//      EnsureAppendCapacity(values.Length);
...
//    public ArrayBuilder<T> Append(System.Collections.Generic.IEnumerable<T> collection)
//    {
//      m_version++;
...
//    public ArrayBuilder<T> CopyOver(int fromIndex, int toIndex, int count)
//    {
...
//    public ArrayBuilder<T> Duplicate(System.ReadOnlySpan<T> values, int count, System.Collections.Generic.IEqualityComparer<T>? equalityComparer = null)
//    {
...
//    public ArrayBuilder<T> Insert(int startAt, T value, int count = 1)
//    {
//      m_version++;
...
//    public ArrayBuilder<T> Insert(int startAt, System.ReadOnlySpan<T> values)
//    {
//      m_version++;

//      EnsureUniformCapacity(values.Length);

//      startAt += m_head;

//      if (m_head >= m_array.Length - m_tail) // Grow from start.
//      {
//        System.Array.Copy(m_array, m_head, m_array, m_head - values.Length, startAt - m_head);
//        values.CopyTo(m_array, startAt - values.Length);
//        m_head -= values.Length;
//      }
//      else // Otherwise grow from end.
//      {
//        System.Array.Copy(m_array, startAt, m_array, startAt + values.Length, m_tail - startAt);
//        values.CopyTo(m_array, startAt);
//        m_tail += values.Length;
//      }
...
//    public ArrayBuilder<T> Insert(int startAt, System.Collections.Generic.IEnumerable<T> collection)
//    {
//      m_version++;
...
//    public ArrayBuilder<T> NormalizeAdjacent(System.Collections.Generic.IList<T> values, System.Collections.Generic.IEqualityComparer<T>? equalityComparer = null)
//    {
//      equalityComparer ??= System.Collections.Generic.EqualityComparer<T>.Default;
...
//    public ArrayBuilder<T> NormalizeAll(T normalizedValue, System.Func<T, bool> predicate)
//    {
...
//    public ArrayBuilder<T> NormalizeAll(T normalizedValue, System.Collections.Generic.IList<T> normalizeValues, System.Collections.Generic.IEqualityComparer<T>? equalityComparer = null)
//    {
//      equalityComparer ??= System.Collections.Generic.EqualityComparer<T>.Default;
...
//    public ArrayBuilder<T> PadEven(int totalWidth, T paddingLeft, T paddingRight, bool leftBias = true)
//    {
...
//    }
//    /// <summary>Pad evenly on both sides to the specified width by the specified <paramref name="paddingLeft"/> and <paramref name="paddingRight"/> respectively.</summary>
//    public ArrayBuilder<T> PadEven(int totalWidth, System.ReadOnlySpan<T> paddingLeft, System.ReadOnlySpan<T> paddingRight, bool leftBias = true)
//    {
//      if (totalWidth > Length)
//      {
//        var quotient = System.Math.DivRem(totalWidth - Length, 2, out var remainder);
...
//    public ArrayBuilder<T> PadLeft(int totalWidth, T padding)
//    {
...
//    }
//    /// <summary>Pad on the left with the specified <paramref name="padding"/>.</summary>
//    public ArrayBuilder<T> PadLeft(int totalWidth, System.ReadOnlySpan<T> padding)
//    {
...
//    public ArrayBuilder<T> PadRight(int totalWidth, T padding)
//      => Append(padding, totalWidth - Length);
//    /// <summary>Pad on the right with the specified <paramref name="padding"/>.</summary>
//    public ArrayBuilder<T> PadRight(int totalWidth, System.ReadOnlySpan<T> padding)
//    {
//      while (Length < totalWidth)
//        Append(padding);
...
//    public ArrayBuilder<T> Prepend(T value, int count = 1)
//    {
//      m_version++;

//      EnsurePrependCapacity(1);
...
//    public ArrayBuilder<T> Prepend(System.ReadOnlySpan<T> values, int count = 1)
//    {
//      m_version++;

//      EnsurePrependCapacity(values.Length);

//      while (count-- > 0)
//        values.CopyTo(m_array, m_head -= values.Length);

//      return this;
//    }

//    /// <summary>Removes the specified range of values from the builder.</summary>
//    public ArrayBuilder<T> Remove(int startAt, int count)
//    {
//      m_version++;
...
//    public ArrayBuilder<T> RemoveAll(System.Func<T, bool> predicate)
//    {
//      if (predicate is null) throw new System.ArgumentNullException(nameof(predicate));
...
//    public ArrayBuilder<T> RemoveAll(System.Collections.Generic.IList<T> removeValues, System.Collections.Generic.IEqualityComparer<T>? equalityComparer = null)
//    {
//      equalityComparer ??= System.Collections.Generic.EqualityComparer<T>.Default;
...
//    public ArrayBuilder<T> Repeat(int count)
//    {
...
//    public ArrayBuilder<T> ReplaceAll(System.Func<T, T> replacementSelector)
//    {
...
//    public ArrayBuilder<T> ReplaceAll(T replacement, System.Func<T, bool> predicate)
//    {
//      if (predicate is null) throw new System.ArgumentNullException(nameof(predicate));
...
//    public ArrayBuilder<T> ReplaceAll(T replacement, System.Collections.Generic.IList<T> replaceValues, System.Collections.Generic.IEqualityComparer<T>? equalityComparer = null)
//    {
//      equalityComparer ??= System.Collections.Generic.EqualityComparer<T>.Default;
...
//    public ArrayBuilder<T> ReplaceIfEqualAt(int startAt, System.ReadOnlySpan<T> key, System.ReadOnlySpan<T> value, System.Collections.Generic.IEqualityComparer<T>? equalityComparer = null)
//    {
...
//    public ArrayBuilder<T> Reverse(int startIndex, int endIndex)
//    {
...
//    public ArrayBuilder<T> Shuffle(System.Random? rng)
//    {
...
//    public System.Collections.Generic.IEnumerable<ArrayBuilder<T>> Split(System.StringSplitOptions options, System.Collections.Generic.IList<T> separators, System.Collections.Generic.IEqualityComparer<T>? equalityComparer = null)
//    {
//      equalityComparer ??= System.Collections.Generic.EqualityComparer<T>.Default;
...
//    public ArrayBuilder<T> Swap(int indexA, int indexB)
//    {
//      if (indexA != indexB)
//      {
//        m_version++;
