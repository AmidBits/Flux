namespace Flux
{
  public static partial class ExtensionMethodsSequenceBuilder
  {
    ...
    public static SequenceBuilder<char> InsertOrdinalIndicatorSuffix(this SequenceBuilder<char> source, System.Func<string, string, bool> predicate)
    {
    ...
    /// <see cref="https://en.wikipedia.org/wiki/Ordinal_indicator"/>
    public static SequenceBuilder<char> InsertOrdinalIndicatorSuffix(this SequenceBuilder<char> source)
