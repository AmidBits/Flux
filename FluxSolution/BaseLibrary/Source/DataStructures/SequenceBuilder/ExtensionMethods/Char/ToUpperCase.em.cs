namespace Flux
{
  public static partial class ExtensionMethodsSequenceBuilder
  {
    ...
    public static SequenceBuilder<char> ToUpperCase(this SequenceBuilder<char> source, int startIndex, int length, System.Globalization.CultureInfo? culture = null)
    {
