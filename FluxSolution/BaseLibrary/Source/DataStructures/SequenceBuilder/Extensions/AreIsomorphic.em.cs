namespace Flux
{
  public static partial class ExtensionMethodsSequenceBuilderT
  {
    ...
    public static bool AreIsomorphic<T>(this SequenceBuilder<T> source, System.ReadOnlySpan<T> target, System.Collections.Generic.IEqualityComparer<T>? equalityComparer = null)
      where T : notnull
    {
