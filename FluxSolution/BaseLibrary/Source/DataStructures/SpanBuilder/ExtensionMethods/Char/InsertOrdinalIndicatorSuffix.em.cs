namespace Flux
{
  public static partial class ExtensionMethodsSequenceBuilder
  {
    ...
    public static SpanBuilder<char> InsertOrdinalIndicatorSuffix(this SpanBuilder<char> source, System.Func<string, string, bool> predicate)
    {
    ...
    /// <see cref="https://en.wikipedia.org/wiki/Ordinal_indicator"/>
    public static SpanBuilder<char> InsertOrdinalIndicatorSuffix(this SpanBuilder<char> source)
