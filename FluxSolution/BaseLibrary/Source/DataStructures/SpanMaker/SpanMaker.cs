namespace Flux
{
  public ref struct SpanMaker<T>
  {
    ...
    public SpanMaker<T> Append(T value)
      => Append(1, value);

    /// <summary>Append <paramref name="collection"/>.</summary>
    public SpanMaker<T> Append(System.Collections.Generic.ICollection<T> collection)
      => Append(1, collection);

    /// <summary>Append <paramref name="span"/>.</summary>
    public SpanMaker<T> Append(System.ReadOnlySpan<T> span)
      => Append(1, span);
