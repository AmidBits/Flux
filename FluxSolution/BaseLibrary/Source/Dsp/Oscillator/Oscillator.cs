namespace Flux.Dsp.Synthesis
{
    ...
    : IOscillator
  {
    ...
    public double Next(double? normalizedFrequency)
    {
      ...
      if (AmplitudeModulator != null && m_amplitudeModulation > Constants.EpsilonCpp32)
      {
      ...
      if (RingModulator != null && m_ringModulation > Constants.EpsilonCpp32)
      ...
      m_phase = (m_phase + phaseShift).Wrap(0, 1); // Ensure phase wraps within cycle.
