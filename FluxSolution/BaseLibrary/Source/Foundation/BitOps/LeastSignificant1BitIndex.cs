namespace Flux
{
  ...
  {
    public static int LeastSignificant1BitIndex(System.Numerics.BigInteger value)
    ...
    public static int LeastSignificant1BitIndex(int number)
      => LeastSignificant1BitIndex(unchecked((uint)number));
    public static int LeastSignificant1BitIndex(long number)
    ...
    public static int LeastSignificant1BitIndex(uint number)
