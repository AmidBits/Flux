namespace Flux
{
  public static partial class BitOps
  {
    ...
    public static System.Numerics.BigInteger MostSignificant1Bit(this System.Numerics.BigInteger value)
      => value == 0
      ? 0
    ...
    public static int MostSignificant1Bit(this int value)
      => value < 0
      ? int.MinValue
      : unchecked((int)MostSignificant1Bit((uint)value));
    /// <summary>Extracts the most significant 1 bit (highest numbered element of a bit set).</summary>
    public static long MostSignificant1Bit(this long value)
      => value < 0
      ? long.MinValue
    ...
    public static uint MostSignificant1Bit(this uint value)
      => value == 0
      ? 0
      : 1U << System.Numerics.BitOperations.Log2(value);
    /// <summary>Extracts the most significant 1 bit (highest numbered element of a bit set).</summary>
    [System.CLSCompliant(false)]
    public static ulong MostSignificant1Bit(this ulong value)
      => value == 0
      ? 0
