namespace Flux
{
  ...
  public static partial class BitOps
  {
    ...
    public static int MostSignificant1BitIndex(this int number)
      => MostSignificant1BitIndex(unchecked((uint)number));
    public static int MostSignificant1BitIndex(this long number)
    ...
    /// <summary>Converts a power-of-2 value (only a single bit set to 1).</summary>
    [System.CLSCompliant(false)]
    public static int PowerOf2BitToIndex(this ulong number)
