namespace Flux
{
  ...
  {
    public static int PowerOf2BitIndex(this System.Numerics.BigInteger value)
    ...
    public static int PowerOf2BitIndex(this int value)
      => PowerOf2BitIndex(unchecked((uint)value));
    public static int PowerOf2BitIndex(this long value)
    ...
    public static int PowerOf2BitIndex(this uint value)
    ...
    /// <summary>Converts a power-of-2 value (only a single bit set to 1).</summary>
    [System.CLSCompliant(false)]
    public static int PowerOf2BitIndex(this ulong value)
      => value > uint.MaxValue
