namespace Flux
{
  ...
  namespace CoordinateSystems
  {
      ...
      : System.IEquatable<CartesianCoordinate2>
    {
      ...
      public static CartesianCoordinate2 InterpolateCubic(CartesianCoordinate2 source, CartesianCoordinate2 target, CartesianCoordinate2 preSource, CartesianCoordinate2 postTarget, double mu)
      {
        var mu2 = mu * mu;
      ...
      /// <summary>Creates a new vector by interpolating between the specified vectors and a unit interval [0, 1].</summary>
      public static CartesianCoordinate2 InterpolateHermite(CartesianCoordinate2 source, CartesianCoordinate2 target, CartesianCoordinate2 preSource, CartesianCoordinate2 postTarget, double mu, double tension, double bias)
      {
        var mu2 = mu * mu;
        var mu3 = mu2 * mu;
      ...
      public static CartesianCoordinate2 Slerp(CartesianCoordinate2 source, CartesianCoordinate2 target, double mu)
      {
        ...
        return new CartesianCoordinate2(source.m_x * cos + (target.m_x - source.m_x) * dot * sin, source.m_y * cos + (target.m_y - source.m_y) * dot * sin);
      }
