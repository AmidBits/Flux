...
namespace Flux
{
    ...
    where T : System.Numerics.INumber<T> //, System.Numerics.IRootFunctions<T> //, System.Numerics.IPowerFunctions<T>, System.Numerics.IRootFunctions<T>, System.Numerics.ITrigonometricFunctions<T>
  {
    ...
    [System.Diagnostics.Contracts.Pure] public T LineSlopeX => T.CopySign(m_x / m_y, m_x);

    /// <summary>Returns the Y-slope of the line to the point (x, y).</summary>
    [System.Diagnostics.Contracts.Pure] public T LineSlopeY => T.CopySign(m_y / m_x, m_y);
