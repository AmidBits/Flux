namespace Flux
{
  ...
  public static partial class ExtensionMethods
  {
    ...
    public static CartesianCoordinate3 ToCartesianCoordinate3(this CartesianCoordinateI3 source)
    ...
    public static CartesianCoordinate3 ToCartesianCoordinate3(this System.Numerics.Vector3 source)
      => new(source.X, source.Y, source.Z);
    public static CartesianCoordinateI3 ToPoint3(this CartesianCoordinate3 source, System.Func<double, double> transformSelector)
    ...
    public static CartesianCoordinateI3 ToPoint3(this CartesianCoordinate3 source, HalfRounding behavior)
    ...
    : System.IEquatable<CartesianCoordinate3>
  {
    ...
    /// <summary>Converts the <see cref="CartesianCoordinate3"/> to a <see cref="CartesianCoordinateI3"/> using the specified <see cref="System.MidpointRounding"/>.</summary>
    [System.Diagnostics.Contracts.Pure]
    ...
    /// <summary>Converts the <see cref="CartesianCoordinate3"/> to a <see cref="CartesianCoordinateI3"/> using the specified <see cref="Flux.FullRounding"/>.</summary>
    [System.Diagnostics.Contracts.Pure]
    ...
    /// <summary>Converts the <see cref="CartesianCoordinate3"/> to a <see cref="CartesianCoordinateI3"/> using the specified <see cref="Flux.HalfRounding"/>.</summary>
    [System.Diagnostics.Contracts.Pure]
