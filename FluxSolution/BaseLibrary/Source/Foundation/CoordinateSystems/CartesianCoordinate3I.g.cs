namespace Flux
{
  ...
  public readonly struct CartesianCoordinate3I<T>
    : System.IEquatable<CartesianCoordinate3I<T>>
      where T : System.Numerics.IBinaryInteger<T>
  {
    /// <summary>Returns the vector (0,0).</summary>
    public static readonly CartesianCoordinate3I<T> Zero;
    ...
    public static double ChebyshevDistance(CartesianCoordinate3I<T> p1, CartesianCoordinate3I<T> p2)
      => ChebyshevLength(p2 - p1);
    /// <summary>Compute the Chebyshev distance between the vectors.</summary>
    /// <see cref="https://en.wikipedia.org/wiki/Chebyshev_distance"/>
    public static double ChebyshevLength(CartesianCoordinate3I<T> p)
    ...
    public static CartesianCoordinate3I<T> CrossProduct(CartesianCoordinate3I<T> p1, CartesianCoordinate3I<T> p2)
    ...
    public static CartesianCoordinate3I<T> DivideCeiling(CartesianCoordinate3I<T> p, double value)
      => new((int)System.Math.Ceiling(p.m_x / value), (int)System.Math.Ceiling(p.m_y / value), (int)System.Math.Ceiling(p.m_z / value));
    /// <summary>Create a new vector with the floor(quotient) from each member divided by the value.</summary>
    public static CartesianCoordinate3I<T> DivideFloor(CartesianCoordinate3I<T> p, double value)
    ...
    public static int DotProduct(CartesianCoordinate3I<T> p1, CartesianCoordinate3I<T> p2)
    ...
    public static double EuclideanDistance(CartesianCoordinate3I<T> p1, CartesianCoordinate3I<T> p2)
      => EuclideanLength(p2 - p1);
    /// <summary>Compute the euclidean distance squared of the vector.</summary>
    /// <see cref="https://en.wikipedia.org/wiki/Norm_(mathematics)#Euclidean_norm"/>
    public static double EuclideanDistanceSquare(CartesianCoordinate3I<T> p1, CartesianCoordinate3I<T> p2)
      => EuclideanLengthSquared(p2 - p1);
    /// <summary>Compute the length (or magnitude) of the vector.</summary>
    /// <see cref="https://en.wikipedia.org/wiki/Norm_(mathematics)#Euclidean_norm"/>
    public static double EuclideanLength(CartesianCoordinate3I<T> p)
    ...
    /// <see cref="https://en.wikipedia.org/wiki/Norm_(mathematics)#Euclidean_norm"/>
    public static double EuclideanLengthSquared(CartesianCoordinate3I<T> p)
    ...
    public static CartesianCoordinate3I<T> FromRandomAbsolute(int toExclusiveX, int toExclusiveY, int toExclusiveZ)
    ...
    public static CartesianCoordinate3I<T> FromRandomCenterZero(int toExclusiveX, int toExclusiveY, int toExclusiveZ)
    ...
    public static CartesianCoordinate3I<T> FromUniqueIndex(long index, int gridWidth, int gridHeight)
    {
    ...
    public static CartesianCoordinate3I InterpolateCosine(CartesianCoordinate3I<T> p1, CartesianCoordinate3I<T> p2, double mu)
    ...
    /// <summary>Creates a new vector by interpolating between the specified vectors and a unit interval [0, 1].</summary>
    public static CartesianCoordinate3I InterpolateCubic(CartesianCoordinate3I<T> p0, CartesianCoordinate3I<T> p1, CartesianCoordinate3I<T> p2, CartesianCoordinate3I<T> p3, double mu)
    ...
    /// <summary>Creates a new vector by interpolating between the specified vectors and a unit interval [0, 1].</summary>
    public static CartesianCoordinate3I InterpolateHermite2(CartesianCoordinate3I<T> p0, CartesianCoordinate3I<T> p1, CartesianCoordinate3I<T> p2, CartesianCoordinate3I<T> p3, double mu, double tension, double bias)
    ...
    /// <summary>Creates a new vector by interpolating between the specified vectors and a unit interval [0, 1].</summary>
    public static CartesianCoordinate3I InterpolateLinear(CartesianCoordinate3I<T> p1, CartesianCoordinate3I<T> p2, double mu)
    ...
    public static CartesianCoordinate3I<T> Lerp(CartesianCoordinate3I<T> source, CartesianCoordinate3I<T> target, double mu)
    {
      var imu = 1 - mu;
    ...
    public static int ManhattanDistance(CartesianCoordinate3I<T> p1, CartesianCoordinate3I<T> p2)
      => ManhattanLength(p2 - p1);
    /// <summary>Compute the Manhattan distance between the vectors.</summary>
    /// <see cref="https://en.wikipedia.org/wiki/Taxicab_geometry"/>
    public static int ManhattanLength(CartesianCoordinate3I<T> p)
    ...
    public static CartesianCoordinate3I<T> MultiplyCeiling(CartesianCoordinate3I<T> p, double value)
      => new((int)System.Math.Ceiling(p.m_x * value), (int)System.Math.Ceiling(p.m_y * value), (int)System.Math.Ceiling(p.m_z * value));
    /// <summary>Create a new vector with the floor(product) from each member multiplied with the value.</summary>
    public static CartesianCoordinate3I MultiplyFloor(CartesianCoordinate3I<T> p, double value)
      => new((int)System.Math.Floor(p.m_x * value), (int)System.Math.Floor(p.m_y * value), (int)System.Math.Floor(p.m_z * value));
    ...
    public static int OrthantBinaryNumber(CartesianCoordinate3I<T> p, CartesianCoordinate3I<T> center)
    ...
    /// <see cref="https://en.wikipedia.org/wiki/Octant_(solid_geometry)"/>
    public static int OctantNumber(CartesianCoordinate3I<T> p, CartesianCoordinate3I<T> center)
    ...
    public static CartesianCoordinate3I<T> Parse(string pointAsString)
      ...
      ? new CartesianCoordinate3I<T>(x, y, z)
      : throw new System.ArgumentOutOfRangeException(nameof(pointAsString));
    public static bool TryParse(string pointAsString, out CartesianCoordinate3I<T> point)
    {
      try
      {
    ...
    public static int ScalarTripleProduct(CartesianCoordinate3I<T> p1, CartesianCoordinate3I<T> p2, CartesianCoordinate3I<T> p3)
    ...
    public static CartesianCoordinate3I Slerp(CartesianCoordinate3I<T> source, CartesianCoordinate3I<T> target, double mu)
    {
    ...
    public static CartesianCoordinate3I<T> VectorTripleProduct(CartesianCoordinate3I<T> p1, CartesianCoordinate3I<T> p2, CartesianCoordinate3I<T> p3)
    ...
    public static bool operator ==(CartesianCoordinate3I<T> p1, CartesianCoordinate3I<T> p2)
      => p1.Equals(p2);
    public static bool operator !=(CartesianCoordinate3I<T> p1, CartesianCoordinate3I<T> p2)
      => !p1.Equals(p2);

    public static CartesianCoordinate3I<T> operator -(CartesianCoordinate3I<T> p)
    ...
    public static CartesianCoordinate3I<T> operator +(CartesianCoordinate3I<T> p1, CartesianCoordinate3I<T> p2)
      => new(p1.m_x + p2.m_x, p1.m_y + p2.m_y, p1.m_z + p2.m_z);
    public static CartesianCoordinate3I<T> operator +(CartesianCoordinate3I<T> p, int v)
      => new(p.m_x + v, p.m_y + v, p.m_z + v);
    public static CartesianCoordinate3I<T> operator +(int v, CartesianCoordinate3I<T> p)
    ...
    public static CartesianCoordinate3I<T> operator *(CartesianCoordinate3I<T> p, int v)
      => new(p.m_x * v, p.m_y * v, p.m_z * v);
    public static CartesianCoordinate3I<T> operator *(CartesianCoordinate3I<T> p, double v)
      => new((int)(p.m_x * v), (int)(p.m_y * v), (int)(p.m_z * v));
    public static CartesianCoordinate3I<T> operator *(int v, CartesianCoordinate3I<T> p)
      => new(v * p.m_x, v * p.m_y, v * p.m_z);
    public static CartesianCoordinate3I<T> operator *(double v, CartesianCoordinate3I<T> p)
    ...
    public bool Equals(CartesianCoordinate3I<T> other)
      => m_x == other.m_x && m_y == other.m_y && m_z == other.m_z;
    #endregion Implemented interfaces

    #region Object overrides
    public override bool Equals(object? obj)
      => obj is CartesianCoordinate3I<T> o && Equals(o);
