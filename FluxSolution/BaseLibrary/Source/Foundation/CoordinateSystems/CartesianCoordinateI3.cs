namespace Flux
{
  ...
  public struct CartesianCoordinateI3
    : System.IEquatable<CartesianCoordinateI3>
  {
    /// <summary>Returns the vector (0,0).</summary>
    public static readonly CartesianCoordinateI3 Zero;

    private readonly int m_x;
    private readonly int m_y;
    private readonly int m_z;

    public CartesianCoordinateI3(int x, int y, int z)
    {
      m_x = x;
      m_y = y;
      m_z = z;
    }
    public CartesianCoordinateI3(int value)
      : this(value, value, value)
    { }
    public CartesianCoordinateI3(int[] array, int startIndex)
    {
    ...
    /// <summary>Converts the <see cref="CartesianCoordinateI3"/> to a <see cref="CartesianCoordinateR3"/>.</summary>
    [System.Diagnostics.Contracts.Pure]
    public CartesianCoordinateR3 ToCartesianCoordinateR3()
      => new(m_x, m_y, m_z);
    /// <summary>Converts the <see cref="CartesianCoordinateI3"/> to a <see cref="CylindricalCoordinate"/>.</summary>
    [System.Diagnostics.Contracts.Pure]
    ...
    /// <summary>Converts the <see cref="CartesianCoordinateI3"/> to a <see cref="PolarCoordinate"/>.</summary>
    [System.Diagnostics.Contracts.Pure]
    public PolarCoordinate ToPolarCoordinate()
      => new(System.Math.Sqrt(m_x * m_x + m_y * m_y), System.Math.Atan2(m_y, m_x));
    /// <summary>Converts the <see cref="CartesianCoordinateI3"/> to a <see cref="Size3"/>.</summary>
    [System.Diagnostics.Contracts.Pure]
    public Size3 ToSize3()
      => new(m_x, m_y, m_z);
    /// <summary>Converts the <see cref="CartesianCoordinateI3"/> to a <see cref="SphericalCoordinate"/>.</summary>
    [System.Diagnostics.Contracts.Pure]
    ...
    /// <summary>Converts the <see cref="CartesianCoordinateI3"/> to a 'mapped' unique index. This index is uniquely mapped using the specified <paramref name="gridWidth"/> and <paramref name="gridHeight"/>.</summary>
    [System.Diagnostics.Contracts.Pure]
    public long ToUniqueIndex(int gridWidth, int gridHeight)
      => ToUniqueIndex(m_x, m_y, m_z, gridWidth, gridHeight);
    /// <summary>Converts the <see cref="CartesianCoordinateI3"/> to a <see cref="System.Numerics.Vector3"/>.</summary>
    [System.Diagnostics.Contracts.Pure]
    ...
    public static double ChebyshevDistance(CartesianCoordinateI3 p1, CartesianCoordinateI3 p2)
      => ChebyshevLength(p2 - p1);
    /// <summary>Compute the Chebyshev distance between the vectors.</summary>
    /// <see cref="https://en.wikipedia.org/wiki/Chebyshev_distance"/>
    public static double ChebyshevLength(CartesianCoordinateI3 p)
    ...
    public static CartesianCoordinateI3 CrossProduct(CartesianCoordinateI3 p1, CartesianCoordinateI3 p2)
    ...
    public static CartesianCoordinateI3 DivideCeiling(CartesianCoordinateI3 p, double value)
      => new((int)System.Math.Ceiling(p.m_x / value), (int)System.Math.Ceiling(p.m_y / value), (int)System.Math.Ceiling(p.m_z / value));
    /// <summary>Create a new vector with the floor(quotient) from each member divided by the value.</summary>
    public static CartesianCoordinateI3 DivideFloor(CartesianCoordinateI3 p, double value)
    ...
    public static int DotProduct(CartesianCoordinateI3 p1, CartesianCoordinateI3 p2)
    ...
    public static double EuclideanDistance(CartesianCoordinateI3 p1, CartesianCoordinateI3 p2)
      => EuclideanLength(p2 - p1);
    /// <summary>Compute the euclidean distance squared of the vector.</summary>
    /// <see cref="https://en.wikipedia.org/wiki/Norm_(mathematics)#Euclidean_norm"/>
    public static double EuclideanDistanceSquare(CartesianCoordinateI3 p1, CartesianCoordinateI3 p2)
      => EuclideanLengthSquared(p2 - p1);
    /// <summary>Compute the length (or magnitude) of the vector.</summary>
    /// <see cref="https://en.wikipedia.org/wiki/Norm_(mathematics)#Euclidean_norm"/>
    public static double EuclideanLength(CartesianCoordinateI3 p)
    ...
    /// <see cref="https://en.wikipedia.org/wiki/Norm_(mathematics)#Euclidean_norm"/>
    public static double EuclideanLengthSquared(CartesianCoordinateI3 p)
    ...
    public static CartesianCoordinateI3 FromRandomAbsolute(int toExclusiveX, int toExclusiveY, int toExclusiveZ)
    ...
    public static CartesianCoordinateI3 FromRandomCenterZero(int toExclusiveX, int toExclusiveY, int toExclusiveZ)
    ...
    /// <summary>Convert a 'mapped' unique index to a <see cref="CartesianCoordinateI3"/>. This index is uniquely mapped using the specified <paramref name="gridWidth"/> and <paramref name="gridHeight"/>.</summary>
    public static CartesianCoordinateI3 FromUniqueIndex(long index, int gridWidth, int gridHeight)
    {
    ...
    public static CartesianCoordinateI3 InterpolateCosine(CartesianCoordinateI3 p1, CartesianCoordinateI3 p2, double mu)
    ...
    /// <summary>Creates a new vector by interpolating between the specified vectors and a unit interval [0, 1].</summary>
    public static CartesianCoordinateI3 InterpolateCubic(CartesianCoordinateI3 p0, CartesianCoordinateI3 p1, CartesianCoordinateI3 p2, CartesianCoordinateI3 p3, double mu)
    ...
    /// <summary>Creates a new vector by interpolating between the specified vectors and a unit interval [0, 1].</summary>
    public static CartesianCoordinateI3 InterpolateHermite2(CartesianCoordinateI3 p0, CartesianCoordinateI3 p1, CartesianCoordinateI3 p2, CartesianCoordinateI3 p3, double mu, double tension, double bias)
    ...
    /// <summary>Creates a new vector by interpolating between the specified vectors and a unit interval [0, 1].</summary>
    public static CartesianCoordinateI3 InterpolateLinear(CartesianCoordinateI3 p1, CartesianCoordinateI3 p2, double mu)
    ...
    public static CartesianCoordinateI3 Lerp(CartesianCoordinateI3 source, CartesianCoordinateI3 target, double mu)
    {
      var imu = 1 - mu;
    ...
    public static int ManhattanDistance(CartesianCoordinateI3 p1, CartesianCoordinateI3 p2)
      => ManhattanLength(p2 - p1);
    /// <summary>Compute the Manhattan distance between the vectors.</summary>
    /// <see cref="https://en.wikipedia.org/wiki/Taxicab_geometry"/>
    public static int ManhattanLength(CartesianCoordinateI3 p)
    ...
    public static CartesianCoordinateI3 MultiplyCeiling(CartesianCoordinateI3 p, double value)
      => new((int)System.Math.Ceiling(p.m_x * value), (int)System.Math.Ceiling(p.m_y * value), (int)System.Math.Ceiling(p.m_z * value));
    /// <summary>Create a new vector with the floor(product) from each member multiplied with the value.</summary>
    public static CartesianCoordinateI3 MultiplyFloor(CartesianCoordinateI3 p, double value)
      => new((int)System.Math.Floor(p.m_x * value), (int)System.Math.Floor(p.m_y * value), (int)System.Math.Floor(p.m_z * value));
    ...
    /// <see cref="https://en.wikipedia.org/wiki/Octant_(solid_geometry)"/>
    public static int OctantNumber(CartesianCoordinateI3 p, CartesianCoordinateI3 center)
    ...
    public static int OrthantNumber(CartesianCoordinateI3 p, CartesianCoordinateI3 center)
    ...
    public static CartesianCoordinateI3 Parse(string pointAsString)
      ...
      ? new CartesianCoordinateI3(x, y, z)
      : throw new System.ArgumentOutOfRangeException(nameof(pointAsString));
    public static bool TryParse(string pointAsString, out CartesianCoordinateI3 point)
    {
      try
      {
    ...
    public static int ScalarTripleProduct(CartesianCoordinateI3 p1, CartesianCoordinateI3 p2, CartesianCoordinateI3 p3)
    ...
    public static CartesianCoordinateI3 Slerp(CartesianCoordinateI3 source, CartesianCoordinateI3 target, double mu)
    {
    ...
    public static CartesianCoordinateI3 VectorTripleProduct(CartesianCoordinateI3 p1, CartesianCoordinateI3 p2, CartesianCoordinateI3 p3)
    ...
    public static bool operator ==(CartesianCoordinateI3 p1, CartesianCoordinateI3 p2)
      => p1.Equals(p2);
    public static bool operator !=(CartesianCoordinateI3 p1, CartesianCoordinateI3 p2)
      => !p1.Equals(p2);

    public static CartesianCoordinateI3 operator -(CartesianCoordinateI3 p)
    ...
    public static CartesianCoordinateI3 operator +(CartesianCoordinateI3 p1, CartesianCoordinateI3 p2)
      => new(p1.m_x + p2.m_x, p1.m_y + p2.m_y, p1.m_z + p2.m_z);
    public static CartesianCoordinateI3 operator +(CartesianCoordinateI3 p, int v)
      => new(p.m_x + v, p.m_y + v, p.m_z + v);
    public static CartesianCoordinateI3 operator +(int v, CartesianCoordinateI3 p)
    ...
    public static CartesianCoordinateI3 operator *(CartesianCoordinateI3 p, int v)
      => new(p.m_x * v, p.m_y * v, p.m_z * v);
    public static CartesianCoordinateI3 operator *(CartesianCoordinateI3 p, double v)
      => new((int)(p.m_x * v), (int)(p.m_y * v), (int)(p.m_z * v));
    public static CartesianCoordinateI3 operator *(int v, CartesianCoordinateI3 p)
      => new(v * p.m_x, v * p.m_y, v * p.m_z);
    public static CartesianCoordinateI3 operator *(double v, CartesianCoordinateI3 p)
    ...
    public bool Equals(CartesianCoordinateI3 other)
      => m_x == other.m_x && m_y == other.m_y && m_z == other.m_z;
    #endregion Implemented interfaces

    #region Object overrides
    public override bool Equals(object? obj)
      => obj is CartesianCoordinateI3 o && Equals(o);
