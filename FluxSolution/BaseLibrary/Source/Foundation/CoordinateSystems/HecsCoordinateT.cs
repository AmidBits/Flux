...
namespace Flux
{
  ...
  public readonly struct HecsCoordinate<T>
    : System.IEquatable<HecsCoordinate<T>>
    where T : System.Numerics.INumber<T>
  {
    ...
    public HecsCoordinate(T a, T r, T c)
    {
      m_a = a;
      m_r = r;
      m_c = c;
    ...
    [System.Diagnostics.Contracts.Pure] public T A { get => m_a; init => m_a = value; }
    [System.Diagnostics.Contracts.Pure] public T R { get => m_r; init => m_r = value; }
    [System.Diagnostics.Contracts.Pure] public T C { get => m_c; init => m_c = value; }

    [System.Diagnostics.Contracts.Pure]
    public HecsCoordinate<T>[] NearestNeighborsCcw()
    {
      var cPa = m_c + m_a;
      var rPa = m_r + m_a;
      var uMa = T.One - m_a;
      ...
      return new HecsCoordinate<T>[]
      {
        new HecsCoordinate<T>(m_a, m_r, m_c + T.One),
        new HecsCoordinate<T>(uMa, rMu, cPa),
        new HecsCoordinate<T>(uMa, rMu, cMu),
        new HecsCoordinate<T>(m_a, m_r, m_c - T.One),
        new HecsCoordinate<T>(uMa, rPa, cMu),
        new HecsCoordinate<T>(uMa, rPa, cPa),
      };
    }
    [System.Diagnostics.Contracts.Pure]
    public HecsCoordinate<T>[] NearestNeighborsCw()
    {
      var cPa = m_c + m_a;
      var rPa = m_r + m_a;
      var uMa = T.One - m_a;
