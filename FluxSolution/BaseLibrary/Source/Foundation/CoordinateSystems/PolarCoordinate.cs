namespace Flux
{
    ...
    : System.IEquatable<PolarCoordinate>
  {
    ...
    [System.Diagnostics.Contracts.Pure] public override string ToString() => $"{GetType().Name} {{ Radius = {m_radius}, Azimuth = {Azimuth.ToUnitValue(AngleUnit.Degree):N1}{Angle.UnicodeDegreeSign} }}";
