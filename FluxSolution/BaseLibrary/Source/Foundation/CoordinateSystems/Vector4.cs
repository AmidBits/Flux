...
namespace BaseLibrary.Source.Foundation.CoordinateSystems
{
...
#endif
  {
        ...
        private readonly Vector256<double> m_v256d;

        /// <summary>Constructs a vector with the specified Vector256.</summary>
        public Vector4(Vector256<double> v256d)
          => m_v256d = v256d;
...
#region Operator overloads
        public static explicit operator Vector256<double>(Vector4 v)
          => v.m_v256d;
        public static explicit operator Vector4(Vector256<double> v)
          => new(v);
