namespace Flux2
{
  ...
  public static partial class ExtensionMethods
  {
    ...
    public static System.Collections.Generic.IEnumerable<TSource> Duplicates<TKey, TValue>(this System.Collections.Generic.IEnumerable<IHierarchy<TKey, TValue>> source, System.Func<IHierarchy<TKey, TValue>, TKey> selector)
  ...
  //: System.IEquatable<Hierarchy<T>>//, System.Collections.Generic.IEnumerable<Hierarchy<T>>, System.Collections.Generic.IEnumerable<T>
  {
    ...
    private System.Collections.Generic.List<Hierarchy<TKey, TValue>> m_children = new System.Collections.Generic.List<Hierarchy<TKey, TValue>>();
    private TKey m_key;
    private TValue m_value;
    private IHierarchy<TKey, TValue> m_parent;
    ...
    public static IEnumerable<Hierarchy<T>> CreateTree<TId>(IEnumerable<T> values, Func<T, TId> idSelector, Func<T, TId?> parentIdSelector)
        where TId : struct
    {
      var valuesCache = values.ToList();
      if (!valuesCache.Any())
        return System.Linq.Enumerable.Empty<Hierarchy<T>>();
      ...
      var nodes = valuesCache.Select(v => new Hierarchy<T>(v));
      return CreateTree(nodes, idSelector, parentIdSelector);

    }

    public static IEnumerable<Hierarchy<T>> CreateTree<TId>(IEnumerable<Hierarchy<TKey,TValue>> rootNodes, Func<T, TId> idSelector, Func<T, TId?> parentIdSelector)
        where TId : struct
