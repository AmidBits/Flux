  ...
  namespace DataStructures
  {
      ...
      where T : notnull
    {
      ...
      public bool IsProperSubsetOf(System.Collections.Generic.IEnumerable<T> other)
        => this.Counts(other, false) is var (unfoundCount, uniqueCount) && unfoundCount > 0 && uniqueCount == Count;
      public bool IsProperSupersetOf(System.Collections.Generic.IEnumerable<T> other)
        => this.Counts(other, true) is var (unfoundCount, uniqueCount) && unfoundCount == 0 && uniqueCount < Count;
