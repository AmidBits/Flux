namespace Flux
{
  ...
  public sealed class SequenceBuilder<T>
  {
    ...
    {
      var powerOf2Capacity = BitOps.NearestPow2AwayFromZero(capacity, false);
    ...
    private void EnsureUniformSpace(int length)
    {
      ...
      {
        var allocateLength = BitOps.NearestPow2AwayFromZero(length * 2, false);
    ...
    private void EnsureAppendSpace(int length)
    {
      ...
      {
        var allocateLength = BitOps.NearestPow2AwayFromZero(length, false);
