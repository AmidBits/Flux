namespace Flux.Dsp
{
  public interface IWaveFilterMono
  {
    static IWaveFilterMono Empty => EmptyAudioFilterMono.Instance;
    ...
    private class EmptyAudioFilterMono
      : IWaveFilterMono
    {
      public static IWaveFilterMono Instance = new EmptyAudioFilterMono();
