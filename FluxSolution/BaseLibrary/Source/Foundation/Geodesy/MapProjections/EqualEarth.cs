...
//#pragma warning disable CA1822 // Mark members as static
    public CartesianCoordinateR3 ProjectForward(GeographicCoordinate location)
    {
      ...
      return new CartesianCoordinateR3(x, y, location.Altitude.Value);
    }
    public GeographicCoordinate ProjectReverse(CartesianCoordinateR3 location)
    {
      const double A1 = 1.340264;
      const double A2 = -0.081106;
      const double A3 = 0.000893;
