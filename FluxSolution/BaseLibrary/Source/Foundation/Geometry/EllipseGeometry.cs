namespace Flux
{
    ...
    : System.IComparable<EllipseGeometry>, System.IEquatable<EllipseGeometry>, ISurfaceArea, ISurfaceContains, ISurfacePerimeter
  {
    ...
    public bool GetSurfaceContains(CartesianCoordinateR2 point)
    ...
    public static CartesianCoordinateR2 ToCartesianCoordinate2(double semiMajorAxis, double semiMinorAxis, double angle)
