namespace Flux
{
    ...
    : System.IEquatable<Quaternion>
  {
    ...
    public static Quaternion FromTwoVectors(CartesianCoordinateR3 u, CartesianCoordinateR3 v)
    {
      var norm_u_norm_v = (float)System.Math.Sqrt(CartesianCoordinateR3.DotProduct(u, u) * CartesianCoordinateR3.DotProduct(v, v));
      var real_part = norm_u_norm_v + CartesianCoordinateR3.DotProduct(u, v);

      CartesianCoordinateR3 w;
      ...
      if (real_part < Maths.Epsilon1E7 * norm_u_norm_v)
      {
        ...
        w = System.Math.Abs(u.X) > System.Math.Abs(u.Z) ? new CartesianCoordinateR3(-u.Y, u.X, 0f) : new CartesianCoordinateR3(0f, -u.Z, u.Y);
      }
      else
      {
        w = CartesianCoordinateR3.CrossProduct(u, v);
      }
