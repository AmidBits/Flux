namespace Flux
{
    ...
    : System.IEquatable<Size3>
  {
    ...
    /// <summary>Convert the <see cref="Size3"/> to a <see cref="GridCoordinate3"/>.</summary>
    public GridCoordinate3 ToCartesianCoordinate3I()
      => new(m_width, m_height, m_depth);

    /// <summary>Convert a mapped index to a 3D point. This index is uniquely mapped using the size.</summary>
    public GridCoordinate3 UniqueIndexToPoint(long index)
    {
      var xy = (long)m_width * (long)m_height;
      var irxy = index % xy;

      return new GridCoordinate3((int)(irxy % m_width), (int)(irxy / m_width), (int)(index / xy));
    }
    ...
    /// <summary>Converts the 3D point to a mapped index. This index is uniquely mapped using the size.</summary>
    public long PointToUniqueIndex(in GridCoordinate3 point)
    ...
    /// <summary>Creates a <see cref='GridCoordinate3'/> from a <see cref='Size3'/>.</summary>
    public static GridCoordinate3 ToPoint3(in Size3 size)
