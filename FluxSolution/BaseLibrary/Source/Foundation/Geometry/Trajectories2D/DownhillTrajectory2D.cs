namespace Flux.Mechanics
{
    ...
    : System.IEquatable<DownhillTrajectory2D>, ITrajectory2D
  {
    ...
    public double MaxHeight
      => m_verticalDifference.DefaultUnitValue + System.Math.Pow(m_initialVelocity.DefaultUnitValue, 2) * System.Math.Pow(System.Math.Sin(m_initialAngle.DefaultUnitValue), 2) / (2 * m_gravitationalAcceleration.DefaultUnitValue);
    public double MaxRange
      => m_initialVelocity.DefaultUnitValue * System.Math.Cos(m_initialAngle.DefaultUnitValue) * MaxTime;
    public double MaxTime
      => m_initialVelocity.DefaultUnitValue * System.Math.Sin(m_initialAngle.DefaultUnitValue) / m_gravitationalAcceleration.DefaultUnitValue + System.Math.Sqrt(2 * MaxHeight / m_gravitationalAcceleration.DefaultUnitValue);
