namespace Flux.Mechanics
{
    ...
    : System.IEquatable<UphillTrajectory2D>, ITrajectory2D
  {
    ...
    public double MaxTime
      => m_initialVelocity.GeneralUnitValue * System.Math.Sin(m_initialAngle.GeneralUnitValue) / m_gravitationalAcceleration.GeneralUnitValue + System.Math.Sqrt(2 * (MaxHeight - m_verticalDifference.GeneralUnitValue) / m_gravitationalAcceleration.GeneralUnitValue);
