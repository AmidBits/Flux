namespace Flux.Mechanics
{
    ...
    : System.IEquatable<UphillTrajectory2D>, ITrajectory2D
  {
    ...
    public double MaxTime
      => m_initialVelocity.StandardUnitValue * System.Math.Sin(m_initialAngle.StandardUnitValue) / m_gravitationalAcceleration.StandardUnitValue + System.Math.Sqrt(2 * (MaxHeight - m_verticalDifference.StandardUnitValue) / m_gravitationalAcceleration.StandardUnitValue);
