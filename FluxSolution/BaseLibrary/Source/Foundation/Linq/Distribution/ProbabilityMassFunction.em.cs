...
namespace Flux
{
  public static partial class Enumerable
  {
    ...
    public static System.Collections.Generic.SortedDictionary<TKey, double> ProbabilityMassFunction<TKey>(this System.Collections.Generic.IDictionary<TKey, int> source, int frequencySum, double factor = 1)
      where TKey : notnull
    {
      ...
      foreach (var kvp in source.OrderBy(kvp => kvp.Key))
        pmf.Add(kvp.Key, kvp.Value / (double)frequencySum * factor);
