namespace Flux
{
		...
		: IFactorialFunction
	{
		...
		public static async System.Threading.Tasks.Task<System.Numerics.BigInteger> ComputeProductAsync(System.Numerics.BigInteger number)
		{
		...
		public System.Numerics.BigInteger ComputeProduct(System.Numerics.BigInteger number)
		{
			var task = ComputeProductAsync(number);
			task.Wait();
			return task.Result;
		}
	}
