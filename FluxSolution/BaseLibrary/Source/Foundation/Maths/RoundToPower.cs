...
//  {
//    public static System.Numerics.BigInteger RoundToNearestPower(System.Numerics.BigInteger value, int radix, System.MidpointRounding mode)
//      => value < 0
...
//    public static double RoundToNearestPower(double value, int radix, System.MidpointRounding mode)
//      => value < 0
...
//    /// <param name="value">Number to be rounded.</param>
//    /// <param name="radix">The basis to whose powers to round to. Must be positive.</param>
//    public static float RoundToNearestPower(float value, int radix, System.MidpointRounding mode)
//      => (float)RoundToNearestPower((double)value, radix, mode);

//    public static int RoundToNearestPower(int value, int radix, System.MidpointRounding mode)
//      => System.Convert.ToInt32(RoundToNearestPower((double)value, radix, mode));
//    public static long RoundToNearestPower(long value, int radix, System.MidpointRounding mode)
