...
//{
//  public static class AMetrical<T>
//  {
...
//    //public static System.Collections.Generic.List<T> Backtrack(int[,] matrix, System.ReadOnlySpan<T> source, System.ReadOnlySpan<T> target, int sourceIndex, int targetIndex, T placeholder, System.Collections.Generic.IEqualityComparer<T> equalityComparer)
//    //{
...
//    //public static void OptimizeEnds(System.ReadOnlySpan<T> source, System.ReadOnlySpan<T> target, out System.ReadOnlySpan<T> sourceSlice, out System.ReadOnlySpan<T> targetSlice, out int sourceCount, out int targetCount, out int atStart, out int atEnd, System.Collections.Generic.IEqualityComparer<T> equalityComparer)
//    //{
//    //  sourceSlice = source;
//    //  targetSlice = target;
