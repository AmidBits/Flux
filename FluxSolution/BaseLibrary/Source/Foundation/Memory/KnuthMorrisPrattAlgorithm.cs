namespace Flux
{
  ...
  {
    public static System.Collections.Generic.List<int> FindIndicesOfKMP<T>(ref this SpanBuilder<T> source, System.ReadOnlySpan<T> target, System.Collections.Generic.IEqualityComparer<T> equalityComparer)
      where T : notnull
      => FindIndicesOfKMP(source.AsReadOnlySpan(), target, equalityComparer);
    public static System.Collections.Generic.List<int> FindIndicesOfKMP<T>(ref this SpanBuilder<T> source, System.ReadOnlySpan<T> target)
      where T : notnull
      => FindIndicesOfKMP(source.AsReadOnlySpan(), target);
    ...
    /// <summary>Searches a text for all indices of a substring. Returns an empty list if not found. Uses the specified equality comparer.</summary>
    public static System.Collections.Generic.List<int> FindIndicesOfKMP<T>(this System.ReadOnlySpan<T> source, System.ReadOnlySpan<T> target, System.Collections.Generic.IEqualityComparer<T> equalityComparer)
    {
    ...
    public static System.Collections.Generic.List<int> FindIndicesOfKMP<T>(this System.ReadOnlySpan<T> source, System.ReadOnlySpan<T> target)
      => FindIndicesOfKMP(source, target, System.Collections.Generic.EqualityComparer<T>.Default);
  }
