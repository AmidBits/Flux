namespace Flux
{
  public static partial class ReadOnlySpanEm
  {
    ...
    public static bool EndsWith<T>(ref this SpanBuilder<T> source, System.ReadOnlySpan<T> target, System.Collections.Generic.IEqualityComparer<T> equalityComparer)
    {
    ...
    public static bool EndsWith<T>(ref this SpanBuilder<T> source, System.ReadOnlySpan<T> target)
