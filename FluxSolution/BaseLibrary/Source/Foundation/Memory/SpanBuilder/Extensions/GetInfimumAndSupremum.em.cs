namespace Flux
{
  public static partial class ReadOnlySpanEm
  {
    ...
    public static (int indexLessThan, int indexGreaterThan) GetInfimumAndSupremum<TSource, TValue>(ref this SpanBuilder<TSource> source, TValue referenceValue, System.Func<TSource, TValue> valueSelector, System.Collections.Generic.IComparer<TValue> comparer)
    {
    ...
    public static (int indexLessThan, int indexGreaterThan) GetInfimumAndSupremum<TSource, TValue>(ref this SpanBuilder<TSource> source, TValue referenceValue, System.Func<TSource, TValue> valueSelector)
      => GetInfimumAndSupremum(ref source, referenceValue, valueSelector, System.Collections.Generic.Comparer<TValue>.Default);
  }
}
