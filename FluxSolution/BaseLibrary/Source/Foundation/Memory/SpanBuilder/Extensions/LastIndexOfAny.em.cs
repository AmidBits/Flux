namespace Flux
{
  public static partial class ReadOnlySpanEm
  {
    ...
    public static int LastIndexOfAny<T>(ref this SpanBuilder<T> source, System.Collections.Generic.IEqualityComparer<T> equalityComparer, params T[] values)
    {
    ...
    public static int LastIndexOfAny<T>(ref this SpanBuilder<T> source, params T[] values)
      => LastIndexOfAny(ref source, System.Collections.Generic.EqualityComparer<T>.Default, values);
  }
}
