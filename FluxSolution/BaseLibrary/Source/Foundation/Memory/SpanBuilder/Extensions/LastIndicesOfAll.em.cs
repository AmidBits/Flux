namespace Flux
{
  public static partial class ReadOnlySpanEm
  {
    ...
    public static int[] LastIndicesOfAll<T>(ref this SpanBuilder<T> source, System.Collections.Generic.IEqualityComparer<T> equalityComparer, params T[] values)
    {
    ...
    public static int[] LastIndicesOfAll<T>(ref this SpanBuilder<T> source, params T[] values)
      => LastIndicesOfAll(ref source, System.Collections.Generic.EqualityComparer<T>.Default, values);
  }
}
