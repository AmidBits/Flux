namespace Flux
{
  public static partial class ReadOnlySpanEm
  {
    ...
    public static T[] LongestAlternatingSubsequence<T>(ref this SpanBuilder<T> source, System.Collections.Generic.IComparer<T> comparer)
    ...
    /// <see cref="https://en.wikipedia.org/wiki/Longest_increasing_subsequence"/>
    public static T[] LongestAlternatingSubsequence<T>(ref this SpanBuilder<T> source)
      => LongestAlternatingSubsequence(ref source, System.Collections.Generic.Comparer<T>.Default);
  }
}
