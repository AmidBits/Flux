...
//    public static void CreateMinMax<T>(ref this SpanBuilder<T> source, out T min, out T max)
...
//      UpdateMinMax(ref source, ref min, ref max);
//    }
...
//    public static void UpdateMinMax<T>(ref this SpanBuilder<T> source, ref T min, ref T max)
//      where T : System.IComparable<T>
//    {
//      if (source.Length == 0) throw new System.ArgumentOutOfRangeException(nameof(source));
