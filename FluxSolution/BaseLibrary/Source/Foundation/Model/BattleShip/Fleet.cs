  ...
  public record class Fleet
  {
    ...
    public System.Collections.Generic.List<Vessel> CreateFleet()
    {
      ...
      foreach (var size in m_shipSizes)
      {
        ...
        do
        {
          ship = new Vessel(size, new CartesianCoordinate2I(Randomization.NumberGenerator.Crypto.Next(m_seaSize.Width), Randomization.NumberGenerator.Crypto.Next(m_seaSize.Height)), (VesselOrientation)Randomization.NumberGenerator.Crypto.Next(2));
        }
