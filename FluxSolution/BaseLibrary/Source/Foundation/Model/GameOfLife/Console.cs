namespace Flux.Model.GameOfLife
{
  public class Console
  {
    ...
    public void Run(int millisecondsFrameFreeze = 100)
    {
      Setup();
    ...
    private void Setup()
    {
      ...
      var width = 2 * System.Math.Max(m_game.CellGrid.Width, 8) + 1; // Multiply by 2 for a symmetrical double-width for each cell.
      var height = System.Math.Max(m_game.CellGrid.Height, 8) + 1;
