namespace Flux.Midi.Protocol
{
  public sealed class SystemRealtime
  {
    ...
    public static byte[] TimingClock()
      => new byte[] { (byte)Status.TimingClock };
    public static byte[] Start()
      => new byte[] { (byte)Status.Start };
    public static byte[] Continue()
      => new byte[] { (byte)Status.Continue };
    public static byte[] Stop()
      => new byte[] { (byte)Status.Stop };
    public static byte[] ActiveSensing()
      => new byte[] { (byte)Status.ActiveSensing };
    public static byte[] Reset()
      => new byte[] { (byte)Status.Reset };
  }
}
