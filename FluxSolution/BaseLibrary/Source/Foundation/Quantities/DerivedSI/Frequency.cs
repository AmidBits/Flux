namespace Flux.Quantity
{
    ...
    : System.IComparable<Frequency>, System.IEquatable<Frequency>, IUnitValueGeneralized<double>, IValueDerivedUnitSI<double>
  {
    ...
    public static Frequency ComputePitchShift(Frequency frequency, Music.Cent cents)
      => new(frequency.GeneralUnitValue * Music.Cent.ConvertCentToFrequencyRatio(cents.Cents));
    ...
    public static Frequency ComputePitchShift(Frequency frequency, Music.Semitone semitones)
      => new(frequency.GeneralUnitValue * Music.Semitone.ConvertSemitoneToFrequencyRatio(semitones.Semitones));
