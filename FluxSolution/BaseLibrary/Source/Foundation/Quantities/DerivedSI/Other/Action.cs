namespace Flux
{
  public static partial class ActionUnitEm
  {
    public static string GetUnitString(this ActionUnit unit, bool useFullName = false, bool preferUnicode = false)
  ...
  public struct Action
    : System.IComparable, System.IComparable<Action>, System.IConvertible, System.IEquatable<Action>, System.IFormattable, IMetricOneQuantifiable, ISiDerivedUnitQuantifiable<double, ActionUnit>
  {
    ...
    [System.Diagnostics.Contracts.Pure] public static explicit operator double(Action v) => v.m_value;
    [System.Diagnostics.Contracts.Pure] public static explicit operator Action(double v) => new(v);

    [System.Diagnostics.Contracts.Pure] public static bool operator <(Action a, Action b) => a.CompareTo(b) < 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator <=(Action a, Action b) => a.CompareTo(b) <= 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator >(Action a, Action b) => a.CompareTo(b) > 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator >=(Action a, Action b) => a.CompareTo(b) >= 0;

    [System.Diagnostics.Contracts.Pure] public static bool operator ==(Action a, Action b) => a.Equals(b);
    [System.Diagnostics.Contracts.Pure] public static bool operator !=(Action a, Action b) => !a.Equals(b);

    [System.Diagnostics.Contracts.Pure] public static Action operator -(Action v) => new(-v.m_value);
    [System.Diagnostics.Contracts.Pure] public static Action operator +(Action a, double b) => new(a.m_value + b);
    [System.Diagnostics.Contracts.Pure] public static Action operator +(Action a, Action b) => a + b.m_value;
    [System.Diagnostics.Contracts.Pure] public static Action operator /(Action a, double b) => new(a.m_value / b);
    [System.Diagnostics.Contracts.Pure] public static Action operator /(Action a, Action b) => a / b.m_value;
    [System.Diagnostics.Contracts.Pure] public static Action operator *(Action a, double b) => new(a.m_value * b);
    [System.Diagnostics.Contracts.Pure] public static Action operator *(Action a, Action b) => a * b.m_value;
    ...
    // IComparable<>
    [System.Diagnostics.Contracts.Pure] public int CompareTo(Action other) => m_value.CompareTo(other.m_value);
    // IComparable
    [System.Diagnostics.Contracts.Pure] public int CompareTo(object? other) => other is not null && other is Action o ? CompareTo(o) : -1;
    ...
    [System.Diagnostics.Contracts.Pure] public override bool Equals(object? obj) => obj is Action o && Equals(o);
