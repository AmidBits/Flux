namespace Flux
{
  ...
  {
    public static string GetUnitString(this AngularVelocityUnit unit, bool preferUnicode, bool useFullName = false)
      => useFullName ? unit.ToString() : unit switch
      {
        AngularVelocityUnit.RadianPerSecond => preferUnicode ? "\u33AE" : "rad/s",
    ...
    : System.IComparable, System.IComparable<AngularVelocity>, System.IConvertible, System.IEquatable<AngularVelocity>, System.IFormattable, IUnitQuantifiable<double, AngularVelocityUnit>
  {
    ...
    // IUnitQuantifiable<>
    [System.Diagnostics.Contracts.Pure]
    public string ToUnitString(AngularVelocityUnit unit = DefaultUnit, string? format = null, bool preferUnicode = false, bool useFullName = false)
