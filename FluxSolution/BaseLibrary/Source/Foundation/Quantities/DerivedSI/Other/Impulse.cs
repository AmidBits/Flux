namespace Flux
{
  ...
  {
    public static string GetUnitString(this ImpulseUnit unit, bool preferUnicode, bool useFullName = false)
  ...
  public readonly struct Impulse
    : System.IComparable, System.IComparable<Impulse>, System.IConvertible, System.IEquatable<Impulse>, System.IFormattable, IUnitQuantifiable<double, ImpulseUnit>
  {
    ...
    [System.Diagnostics.Contracts.Pure] public static explicit operator double(Impulse v) => v.m_value;
    [System.Diagnostics.Contracts.Pure] public static explicit operator Impulse(double v) => new(v);

    [System.Diagnostics.Contracts.Pure] public static bool operator <(Impulse a, Impulse b) => a.CompareTo(b) < 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator <=(Impulse a, Impulse b) => a.CompareTo(b) <= 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator >(Impulse a, Impulse b) => a.CompareTo(b) > 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator >=(Impulse a, Impulse b) => a.CompareTo(b) >= 0;

    [System.Diagnostics.Contracts.Pure] public static bool operator ==(Impulse a, Impulse b) => a.Equals(b);
    [System.Diagnostics.Contracts.Pure] public static bool operator !=(Impulse a, Impulse b) => !a.Equals(b);

    [System.Diagnostics.Contracts.Pure] public static Impulse operator -(Impulse v) => new(-v.m_value);
    [System.Diagnostics.Contracts.Pure] public static Impulse operator +(Impulse a, double b) => new(a.m_value + b);
    [System.Diagnostics.Contracts.Pure] public static Impulse operator +(Impulse a, Impulse b) => a + b.m_value;
    [System.Diagnostics.Contracts.Pure] public static Impulse operator /(Impulse a, double b) => new(a.m_value / b);
    [System.Diagnostics.Contracts.Pure] public static Impulse operator /(Impulse a, Impulse b) => a / b.m_value;
    [System.Diagnostics.Contracts.Pure] public static Impulse operator *(Impulse a, double b) => new(a.m_value * b);
    [System.Diagnostics.Contracts.Pure] public static Impulse operator *(Impulse a, Impulse b) => a * b.m_value;
    ...
    // IComparable<>
    [System.Diagnostics.Contracts.Pure] public int CompareTo(Impulse other) => m_value.CompareTo(other.m_value);
    // IComparable
    [System.Diagnostics.Contracts.Pure] public int CompareTo(object? other) => other is not null && other is Impulse o ? CompareTo(o) : -1;
    ...
    // IUnitQuantifiable<>
    [System.Diagnostics.Contracts.Pure]
    public string ToUnitString(ImpulseUnit unit = DefaultUnit, string? format = null, bool preferUnicode = false, bool useFullName = false)
    ...
    [System.Diagnostics.Contracts.Pure] public override bool Equals(object? obj) => obj is Impulse o && Equals(o);
