namespace Flux
{
  ...
  {
    public static string GetUnitString(this ImpulseUnit unit, bool useNameInsteadOfSymbol = false, bool useUnicodeIfAvailable = false)
    ...
    : System.IComparable<Impulse>, System.IConvertible, System.IEquatable<Impulse>, ISiDerivedUnitQuantifiable<double, ImpulseUnit>
  {
    ...
    public static explicit operator double(Impulse v)
      => v.m_value;
    public static explicit operator Impulse(double v)
      => new(v);

    public static bool operator <(Impulse a, Impulse b)
      => a.CompareTo(b) < 0;
    public static bool operator <=(Impulse a, Impulse b)
      => a.CompareTo(b) <= 0;
    public static bool operator >(Impulse a, Impulse b)
    ...
    public static Impulse operator -(Impulse v)
      => new(-v.m_value);
    public static Impulse operator +(Impulse a, double b)
      => new(a.m_value + b);
