namespace Flux
{
  public static partial class IrradianceUnitEm
  {
    public static string GetUnitString(this IrradianceUnit unit, bool useFullName = false, bool preferUnicode = false)
  ...
  public struct Irradiance
    : System.IComparable, System.IComparable<Irradiance>, System.IConvertible, System.IEquatable<Irradiance>, System.IFormattable, IMetricOneQuantifiable, ISiDerivedUnitQuantifiable<double, IrradianceUnit>
  {
    ...
    [System.Diagnostics.Contracts.Pure] public static explicit operator double(Irradiance v) => v.m_value;
    [System.Diagnostics.Contracts.Pure] public static explicit operator Irradiance(double v) => new(v);

    [System.Diagnostics.Contracts.Pure] public static bool operator <(Irradiance a, Irradiance b) => a.CompareTo(b) < 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator <=(Irradiance a, Irradiance b) => a.CompareTo(b) <= 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator >(Irradiance a, Irradiance b) => a.CompareTo(b) > 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator >=(Irradiance a, Irradiance b) => a.CompareTo(b) >= 0;

    [System.Diagnostics.Contracts.Pure] public static bool operator ==(Irradiance a, Irradiance b) => a.Equals(b);
    [System.Diagnostics.Contracts.Pure] public static bool operator !=(Irradiance a, Irradiance b) => !a.Equals(b);

    [System.Diagnostics.Contracts.Pure] public static Irradiance operator -(Irradiance v) => new(-v.m_value);
    [System.Diagnostics.Contracts.Pure] public static Irradiance operator +(Irradiance a, double b) => new(a.m_value + b);
    [System.Diagnostics.Contracts.Pure] public static Irradiance operator +(Irradiance a, Irradiance b) => a + b.m_value;
    [System.Diagnostics.Contracts.Pure] public static Irradiance operator /(Irradiance a, double b) => new(a.m_value / b);
    [System.Diagnostics.Contracts.Pure] public static Irradiance operator /(Irradiance a, Irradiance b) => a / b.m_value;
    [System.Diagnostics.Contracts.Pure] public static Irradiance operator *(Irradiance a, double b) => new(a.m_value * b);
    [System.Diagnostics.Contracts.Pure] public static Irradiance operator *(Irradiance a, Irradiance b) => a * b.m_value;
    ...
    // IComparable<>
    [System.Diagnostics.Contracts.Pure] public int CompareTo(Irradiance other) => m_value.CompareTo(other.m_value);
    // IComparable
    [System.Diagnostics.Contracts.Pure] public int CompareTo(object? other) => other is not null && other is Irradiance o ? CompareTo(o) : -1;
    ...
    [System.Diagnostics.Contracts.Pure] public override bool Equals(object? obj) => obj is Irradiance o && Equals(o);
