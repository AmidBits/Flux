namespace Flux
{
  ...
  {
    public static string GetUnitString(this ElectricChargeUnit unit, bool useFullName = false, bool preferUnicode = false)
  ...
  public struct ElectricCharge
    : System.IComparable, System.IComparable<ElectricCharge>, System.IConvertible, System.IEquatable<ElectricCharge>, ISiDerivedUnitQuantifiable<double, ElectricChargeUnit>
  {
    ...
    [System.Diagnostics.Contracts.Pure] public static explicit operator double(ElectricCharge v) => v.m_value;
    [System.Diagnostics.Contracts.Pure] public static explicit operator ElectricCharge(double v) => new(v);

    [System.Diagnostics.Contracts.Pure] public static bool operator <(ElectricCharge a, ElectricCharge b) => a.CompareTo(b) < 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator <=(ElectricCharge a, ElectricCharge b) => a.CompareTo(b) <= 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator >(ElectricCharge a, ElectricCharge b) => a.CompareTo(b) > 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator >=(ElectricCharge a, ElectricCharge b) => a.CompareTo(b) >= 0;

    [System.Diagnostics.Contracts.Pure] public static bool operator ==(ElectricCharge a, ElectricCharge b) => a.Equals(b);
    [System.Diagnostics.Contracts.Pure] public static bool operator !=(ElectricCharge a, ElectricCharge b) => !a.Equals(b);

    [System.Diagnostics.Contracts.Pure] public static ElectricCharge operator -(ElectricCharge v) => new(-v.m_value);
    [System.Diagnostics.Contracts.Pure] public static ElectricCharge operator +(ElectricCharge a, double b) => new(a.m_value + b);
    [System.Diagnostics.Contracts.Pure] public static ElectricCharge operator +(ElectricCharge a, ElectricCharge b) => a + b.m_value;
    [System.Diagnostics.Contracts.Pure] public static ElectricCharge operator /(ElectricCharge a, double b) => new(a.m_value / b);
    [System.Diagnostics.Contracts.Pure] public static ElectricCharge operator /(ElectricCharge a, ElectricCharge b) => a / b.m_value;
    [System.Diagnostics.Contracts.Pure] public static ElectricCharge operator *(ElectricCharge a, double b) => new(a.m_value * b);
    [System.Diagnostics.Contracts.Pure] public static ElectricCharge operator *(ElectricCharge a, ElectricCharge b) => a * b.m_value;
    ...
    // IComparable<>
    [System.Diagnostics.Contracts.Pure] public int CompareTo(ElectricCharge other) => m_value.CompareTo(other.m_value);
    // IComparable
    [System.Diagnostics.Contracts.Pure] public int CompareTo(object? other) => other is not null && other is ElectricCharge o ? CompareTo(o) : -1;
    ...
    // IEquatable<>
    [System.Diagnostics.Contracts.Pure] public bool Equals(ElectricCharge other) => m_value == other.m_value;
    #endregion Implemented interfaces

    #region Object overrides
    [System.Diagnostics.Contracts.Pure] public override bool Equals(object? obj) => obj is ElectricCharge o && Equals(o);
