namespace Flux
{
  public static partial class InductanceUnitEm
  {
    public static string GetUnitString(this InductanceUnit unit, bool useFullName = false, bool preferUnicode = false)
