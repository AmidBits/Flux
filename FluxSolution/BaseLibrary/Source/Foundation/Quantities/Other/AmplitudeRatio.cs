namespace Flux
{
  ...
  {
    public static string GetUnitString(this AmplitudeRatioUnit unit, bool preferUnicode, bool useFullName = false)
      => unit switch
      {
    ...
    : System.IComparable, System.IComparable<AmplitudeRatio>, System.IConvertible, System.IEquatable<AmplitudeRatio>, System.IFormattable, IUnitQuantifiable<double, AmplitudeRatioUnit>
  {
    ...
    // IUnitQuantifiable<>
    [System.Diagnostics.Contracts.Pure]
    public string ToUnitString(AmplitudeRatioUnit unit = DefaultUnit, string? format = null, bool preferUnicode = false, bool useFullName = false)
