namespace Flux.Quantity
{
  ...
  public struct Rate<TNumerator, TDenominator>
    ...
    where TNumerator : IUnitValueDefaultable<double>
    where TDenominator : IUnitValueDefaultable<double>
  {
    ...
    public double Ratio
      => m_numerator.DefaultUnitValue / m_denominator.DefaultUnitValue;
    public double InverseRatio
      => m_denominator.DefaultUnitValue / m_numerator.DefaultUnitValue;
    ...
    public override int GetHashCode()
      => System.HashCode.Combine(m_numerator.DefaultUnitValue, m_denominator.DefaultUnitValue);
