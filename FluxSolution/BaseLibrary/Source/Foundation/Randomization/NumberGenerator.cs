namespace Flux.Randomization
{
  public static class NumberGenerator
  {
    ...
    private static readonly System.Threading.ThreadLocal<System.Random> m_isaac = new(() => new Randomization.IsaacRandom());
    /// <summary>Gets the IsaacRandom rng.</summary>
    public static System.Random Isaac
      => m_isaac.Value!;

    private static readonly System.Threading.ThreadLocal<System.Random> m_simple = new(() => new Randomization.SimpleRng());
    /// <summary>Gets the SimpleRng rng.</summary>
    public static System.Random Simple
      => m_simple.Value!;

    private static readonly System.Threading.ThreadLocal<System.Random> m_splitMix64 = new(() => new Randomization.SplitMix64());
    /// <summary>Gets the SplitMix64 rng.</summary>
    public static System.Random SplitMix64
      => m_splitMix64.Value!;

    private static readonly System.Threading.ThreadLocal<System.Random> m_xoshiro256p = new(() => new Randomization.Xoshiro256P());
    /// <summary>Gets the Xoshiro256P rng.</summary>
    public static System.Random Xoshiro256P
      => m_xoshiro256p.Value!;

    private static readonly System.Threading.ThreadLocal<System.Random> m_xoshiro256ss = new(() => new Randomization.Xoshiro256SS());
