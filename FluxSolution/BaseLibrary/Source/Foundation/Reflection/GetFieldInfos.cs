namespace Flux
{
  ...
  {
    /// <summary>Enumerates all FieldInfo matching the specified binding flags and predicate. If the source is a System.Type, the fields are enumerated from the type, otherwise the instance is used.</summary>
