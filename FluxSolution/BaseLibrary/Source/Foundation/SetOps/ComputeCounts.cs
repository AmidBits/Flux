namespace Flux
{
  public static partial class SetOps
  {
    ...
    public static (int unfoundCount, int uniqueCount) ComputeCounts<T>(System.Collections.Generic.ICollection<T> source, System.Collections.Generic.IEnumerable<T> target, bool returnIfUnfound)
      => ComputeCounts(source, target, returnIfUnfound, System.Collections.Generic.EqualityComparer<T>.Default);
  }
}
