namespace Flux
{
  public static partial class SetOps
  {
    ...
    public static (int unfoundCount, int uniqueCount) Counts<T>(this System.Collections.Generic.ICollection<T> source, System.Collections.Generic.IEnumerable<T> target, bool returnIfUnfound, System.Collections.Generic.IEqualityComparer<T> equalityComparer)
    {
      var unfoundCount = 0;
    ...
    public static (int unfoundCount, int uniqueCount) Counts<T>(this System.Collections.Generic.ICollection<T> source, System.Collections.Generic.IEnumerable<T> target, bool returnIfUnfound)
