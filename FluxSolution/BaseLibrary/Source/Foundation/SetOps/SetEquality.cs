namespace Flux
{
  public static partial class SetOps
  {
    ...
    public static bool SetEquality<T>(System.Collections.Generic.ICollection<T> source, System.Collections.Generic.IEnumerable<T> target, System.Collections.Generic.IEqualityComparer<T> equalityComparer)
      ...
      && SetCounts(source, target, true, equalityComparer) is var (uniqueCount, unfoundCount) && unfoundCount == 0 && uniqueCount == source.Count;
    ...
    public static bool SetEquality<T>(System.Collections.Generic.ICollection<T> source, System.Collections.Generic.IEnumerable<T> target)
      => SetEquality(source, target, System.Collections.Generic.EqualityComparer<T>.Default);
  }
}
