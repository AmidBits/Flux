namespace Flux
{
  public static partial class SetOps
  {
    ...
    public static System.Collections.Generic.IEnumerable<T> SetSymmetricDifference<T>(System.Collections.Generic.ICollection<T> source, System.Collections.Generic.IEnumerable<T> target, System.Collections.Generic.IEqualityComparer<T> equalityComparer)
    {
      ...
      ? source
      : System.Linq.Enumerable.Concat(SetSourceDifference(source, target, equalityComparer), SetTargetDifference(source, target));
    }
    ...
    public static System.Collections.Generic.IEnumerable<T> SetSymmetricDifference<T>(System.Collections.Generic.ICollection<T> source, System.Collections.Generic.IEnumerable<T> target)
      => SetSymmetricDifference(source, target, System.Collections.Generic.EqualityComparer<T>.Default);
  }
}
