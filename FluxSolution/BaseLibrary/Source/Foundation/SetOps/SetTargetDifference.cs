namespace Flux
{
  public static partial class SetOps
  {
    ...
    public static System.Collections.Generic.IEnumerable<T> SetTargetDifference<T>(System.Collections.Generic.ICollection<T> source, System.Collections.Generic.IEnumerable<T> target) 
