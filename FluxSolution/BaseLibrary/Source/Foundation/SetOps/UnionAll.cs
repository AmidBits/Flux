namespace Flux
{
  public static partial class SetOps
  {
    ...
    public static System.Collections.Generic.IEnumerable<T> UnionAll<T>(System.Collections.Generic.IEnumerable<T> source, System.Collections.Generic.IEnumerable<T> target)
