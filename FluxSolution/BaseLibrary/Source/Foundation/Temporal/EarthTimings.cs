namespace Flux
{
  public static class EarthTimings
  {
    ...
    public static decimal GetGeocentricCoordinateTimeDifference(System.DateTime dateTime)
      => Lg * (dateTime.ToJulianDate(ConversionCalendar.GregorianCalendar).GeneralUnitValue - 2443144.5003725m) * 86400;
    ...
    public static decimal GetBarycentricCoordinateTimeDifference(System.DateTime dateTime)
      => Lb * (dateTime.ToJulianDate(ConversionCalendar.GregorianCalendar).GeneralUnitValue - 2443144.5003725m) * 86400;
  }
}
