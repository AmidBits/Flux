...
namespace Flux
{
  public static partial class Zamplez
  {
    ...
    {
      var ipaes = Flux.Reflect.GetTypesDerivedFrom(typeof(Flux.Text.IPhoneticAlgorithmEncoder)).Select(t => (Flux.Text.IPhoneticAlgorithmEncoder?)System.Activator.CreateInstance(t));
