...
{
  /// <summary>A ratio indicates how many times one number contains another. This struct stores the ratio as both of its constituting numbers (numerator and denominator).</summary>
