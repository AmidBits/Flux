namespace Flux.Geometry
{
  ...
  public record class HexagonShape
  {
    ...
    public static double RatioOfOuterToInnerDiameter => Constants.TheodorusConstant / 2.0;

    public const double SixtyDegreesInRadians = Constants.PiOver180 * 60.0;
    ...
    public static double SurfaceArea(double length)
      => 3 * length * length * Constants.TheodorusConstant / 2.0;
    ...
    public static double SurfaceInnerDiameter(double length)
      => length * Constants.TheodorusConstant;
    ...
    public static double SurfaceInnerRadius(double length)
      => length * Constants.TheodorusConstant / 2.0;
