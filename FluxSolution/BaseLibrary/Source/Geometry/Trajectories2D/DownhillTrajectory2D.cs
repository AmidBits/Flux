namespace Flux.Mechanics
{
    ...
    : ITrajectory2D
  {
    ...
    public DownhillTrajectory2D(Length verticalDifference, Angle initialAngle, LinearVelocity initialVelocity, Acceleration gravitationalAcceleration)
    {
    ...
    public DownhillTrajectory2D(Length verticalDifference, Angle initialAngle, LinearVelocity initialVelocity)
