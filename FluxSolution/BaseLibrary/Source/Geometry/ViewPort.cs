namespace Flux.Geometry
{
  ...
  public readonly record struct ViewPort
  {
    ...
    public CartesianCoordinate3<double> TransformWorldToCamera(CartesianCoordinate3<double> source)
    ...
    /// <seealso cref="http://www.scratchapixel.com/lessons/3d-basic-rendering/computing-pixel-coordinates-of-3d-point/mathematics-computing-2d-coordinates-of-3d-points"/>
    public static CartesianCoordinate2<double> TransformCameraToCanvas(CartesianCoordinate3<double> source)
    ...
    /// <seealso cref="http://www.scratchapixel.com/lessons/3d-basic-rendering/computing-pixel-coordinates-of-3d-point/mathematics-computing-2d-coordinates-of-3d-points"/>
    public CartesianCoordinate2<double> TransformCameraToCanvas(CartesianCoordinate3<double> source, out bool visible)
    {
    ...
    /// <seealso cref="http://www.scratchapixel.com/lessons/3d-basic-rendering/computing-pixel-coordinates-of-3d-point/mathematics-computing-2d-coordinates-of-3d-points"/>
    public CartesianCoordinate2<double> TransformCanvasToNdc(CartesianCoordinate2<double> source)
    ...
    /// <seealso cref="http://www.scratchapixel.com/lessons/3d-basic-rendering/computing-pixel-coordinates-of-3d-point/mathematics-computing-2d-coordinates-of-3d-points"/>
    public CartesianCoordinate2<double> TransformNdcToRaster(CartesianCoordinate2<double> ndc)
