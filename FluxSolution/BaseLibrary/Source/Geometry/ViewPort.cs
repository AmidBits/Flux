namespace Flux.Geometry
{
  ...
  public readonly record struct ViewPort
  {
    ...
    public CoordinateSystems.CartesianCoordinate3<double> TransformWorldToCamera(CoordinateSystems.CartesianCoordinate3<double> source)
      => System.Numerics.Vector3.Transform(source.ToVector3(), m_worldToCamera.ToQuaternion()).ToCartesianCoordinate3<double>();

    /// <summary>Transform from camera space to vector on the canvas. Use perspective projection.</summary>
    /// <seealso cref="http://www.scratchapixel.com/lessons/3d-basic-rendering/computing-pixel-coordinates-of-3d-point/mathematics-computing-2d-coordinates-of-3d-points"/>
    public static CoordinateSystems.CartesianCoordinate2<double> TransformCameraToCanvas(CoordinateSystems.CartesianCoordinate3<double> source)
    ...
    /// <seealso cref="http://www.scratchapixel.com/lessons/3d-basic-rendering/computing-pixel-coordinates-of-3d-point/mathematics-computing-2d-coordinates-of-3d-points"/>
    public CoordinateSystems.CartesianCoordinate2<double> TransformCameraToCanvas(CoordinateSystems.CartesianCoordinate3<double> source, out bool visible)
    {
    ...
    /// <seealso cref="http://www.scratchapixel.com/lessons/3d-basic-rendering/computing-pixel-coordinates-of-3d-point/mathematics-computing-2d-coordinates-of-3d-points"/>
    public CoordinateSystems.CartesianCoordinate2<double> TransformCanvasToNdc(CoordinateSystems.CartesianCoordinate2<double> source)
    ...
    /// <seealso cref="http://www.scratchapixel.com/lessons/3d-basic-rendering/computing-pixel-coordinates-of-3d-point/mathematics-computing-2d-coordinates-of-3d-points"/>
    public CoordinateSystems.CartesianCoordinate2<double> TransformNdcToRaster(CoordinateSystems.CartesianCoordinate2<double> ndc)
