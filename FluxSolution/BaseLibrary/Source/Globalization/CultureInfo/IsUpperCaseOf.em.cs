namespace Flux
{
  ...
  {
    public static bool IsUpperCaseOf_en(char character) => character is >= 'A' and <= 'Z';
    public static bool IsUpperCaseOf_se(char character) => IsUpperCaseOf_en(character) || character is '\u00C5' or '\u00C4' or '\u00D6'; // 'Å', 'Ä', 'Ö'
