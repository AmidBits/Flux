namespace Flux.Globalization
{
  public static partial class Number
  {
    ...
    public static System.Text.RegularExpressions.Regex RegexDecimalNumber(this System.Globalization.CultureInfo culture) => new($"[-+]?[0-9]*\\{(culture ?? System.Globalization.CultureInfo.InvariantCulture).NumberFormat.NumberDecimalSeparator}?[0-9]+");
