...
namespace Flux
{
  ...
  public static partial class Unicode
  {
    ...
    public static string ToStringLiteral(int codePoint) => codePoint < 0 ? throw new System.ArgumentOutOfRangeException(nameof(codePoint)) : codePoint <= 0xFFFF ? @"\u" + codePoint.ToString(@"x4") : @"\U" + codePoint.ToString(@"X8");
    ...
    public static string ToUnicodeNotation(int codePoint) => @"U+" + codePoint.ToString(@"X4");
