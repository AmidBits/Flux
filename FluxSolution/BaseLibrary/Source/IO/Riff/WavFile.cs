...
//    [System.CLSCompliant(false)] public override uint ChunkSize { get => Numerics.BitConverter.BigEndian.ToUInt32(m_buffer, 4); set { Numerics.BitConverter.BigEndian.GetBytes(value).CopyTo(m_buffer, 4); } }

//    public BaseChunk(int totalBufferSize)
//      : base(totalBufferSize)
//    { }
//    public BaseChunk(string chunkID, int chunkDataSize)
//      : base(chunkID, chunkDataSize)
//    { }
//    public BaseChunk(byte[] bytes)
//      : base(bytes)
//    { }
...
//        yield return chunk;
//    }
//    public static BaseChunk ReadChunk(System.IO.Stream stream)
//    {
//      if (stream is null) throw new System.ArgumentNullException(nameof(stream));
...
//          //chunk = new Smf.TrackChunk(chunk.m_buffer);
//          break;
//        default:
//          break;
//      }
...
//    public override string ToString()
//      => base.ToString().Replace(">", $"xx, {GetFormatName((int)Format)}, {SampleChannels} ch., {SampleRate} Hz, {SampleBitDepth}-bit>", System.StringComparison.Ordinal);
//  }
