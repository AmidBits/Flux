...
namespace Flux
{
  public static partial class Enumerable
  {
    ...
    public static System.Collections.Generic.IEnumerable<TResult> PartitionByCount<TSource, TResult>(this System.Collections.Generic.ICollection<TSource> source, int countOfPartitions, System.Func<System.Collections.Generic.IEnumerable<TSource>, int, TResult> resultSelector)
    {
      ...
      var quotient = System.Math.DivRem(source.ThrowIfNull().Count(), countOfPartitions, out var remainder);
