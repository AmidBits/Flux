...
namespace Flux
{
  public static partial class Enumerable
  {
    ...
    public static System.Collections.Generic.IEnumerable<TResult> PermuteHeapsAlgorithm<TSource, TResult>(this TSource[] source, System.Func<TSource[], TResult> resultSelector)
    {
    ...
    /// <summary>
    /// <para>Heap's algorithm generates all possible permutations of n objects by allocating new arrays for each permutation.</para>
    /// <see href="https://en.wikipedia.org/wiki/Heap%27s_algorithm"/>
    /// </summary>
    /// <exception cref="System.ArgumentNullException"/>
