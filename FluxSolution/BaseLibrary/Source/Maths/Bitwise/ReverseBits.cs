...
namespace Flux
{
  ...
  {
    private static System.Collections.Generic.IReadOnlyList<int>? m_byteReverseBits;
    /// <summary></summary>
    ...
    public static System.Collections.Generic.IReadOnlyList<int> ByteReverseBits
      => m_byteReverseBits ??= System.Linq.Enumerable.Range(0, 256).Select(n => (int)((uint)Maths.ReverseBits(n) >> 24)).ToList();
    ...
    /// <summary></summary>
    /// <seealso cref="https://stackoverflow.com/questions/33910399/reverse-the-order-of-bits-in-a-bit-array"/>
