namespace Flux
{
  public static partial class Bits
  {
    ...
    public static int IntegerLog2<TSelf>(this TSelf value) where TSelf : System.Numerics.IBinaryInteger<TSelf>
      => int.CreateChecked(TSelf.Log2(value));

    public static void IntegerLog2<TSelf>(this TSelf value, out int ilog2TowardZero, out int ilog2AwayFromZero) where TSelf : System.Numerics.IBinaryInteger<TSelf>
    {
