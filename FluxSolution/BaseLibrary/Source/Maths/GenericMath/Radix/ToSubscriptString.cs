namespace Flux
{
  public static partial class GenericMath
  {
    ...
    public static string ToSubscriptString<TSelf>(this TSelf number, int radix)
      ...
      => new Text.PositionalNotation(Text.RuneSequences.SubscriptDecimalDigitRunes.AsSpan()[..AssertRadix(radix, Text.RuneSequences.SubscriptDecimalDigitRunes.Length)]).NumberToText(number.ToBigInteger()).ToString();
