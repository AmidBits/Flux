namespace Flux
{
  public static partial class GenericMath
  {
    ...
    public static string ToSuperscriptString<TSelf>(this TSelf number, int radix)
      ...
      => new Text.PositionalNotation(Text.RuneSequences.SuperscriptDecimalDigitRunes.AsSpan()[..AssertRadix(radix, Text.RuneSequences.SuperscriptDecimalDigitRunes.Length)]).NumberToText(number.ToBigInteger()).ToString();
