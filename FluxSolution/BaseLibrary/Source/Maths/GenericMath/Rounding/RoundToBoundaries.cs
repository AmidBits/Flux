namespace Flux
{
  public static partial class Maths
  {
    ...
    public static TBound RoundToBoundaries<TValue, TBound, TDistance>(this TValue value, RoundingMode mode, TBound boundaryTowardsZero, TBound boundaryAwayFromZero, TDistance distanceTowardsZero, TDistance distanceAwayFromZero)
    ...
    public static TBound RoundToBoundaries<TValue, TBound>(this TValue value, RoundingMode mode, TBound boundaryTowardsZero, TBound boundaryAwayFromZero)
      ...
      where TBound : System.Numerics.INumber<TBound>
    {
      ComputeDistanceToBoundaries(value, boundaryTowardsZero, boundaryAwayFromZero, out TValue distanceTowardsZero, out TValue distanceAwayFromZero);

      return RoundToBoundaries(value, mode, boundaryTowardsZero, boundaryAwayFromZero, distanceTowardsZero, distanceAwayFromZero);
    }
    ...
    /// <param name="maxDistanceToBoundaries">The maximum distance considered to be within range of one or both of the boundaries. The indicator is returned by the method.</param>
    /// <returns>Whether <paramref name="distanceTowardsZero"/> or <paramref name="distanceAwayFromZero"/> are within <paramref name="maxDistanceToBoundaries"/>.</returns>
    public static void ComputeDistanceToBoundaries(this double x, double boundaryTowardsZero, double boundaryAwayFromZero, out double distanceTowardsZero, out double distanceAwayFromZero)
    {
      var origin = x;
    ...
    public static double RoundToBoundaries(this double x, RoundingMode mode, double boundaryTowardsZero, double boundaryAwayFromZero, double distanceTowardsZero, double distanceAwayFromZero)
      => mode switch
      {
        // First we take care of the direct rounding cases.
        RoundingMode.AwayFromZero => boundaryAwayFromZero,
        RoundingMode.TowardZero => boundaryTowardsZero,
        RoundingMode.ToNegativeInfinity => x < 0 ? boundaryAwayFromZero : boundaryTowardsZero,
        RoundingMode.ToPositiveInfinity => x < 0 ? boundaryTowardsZero : boundaryAwayFromZero,
        // If not applicable, and since we're comparing a value against two boundaries, if the distances from the value to the two boundaries are not equal, we can avoid halfway checks.
        _ => (distanceTowardsZero < distanceAwayFromZero) ? boundaryTowardsZero // A clear win for towards-zero.
          : (distanceTowardsZero > distanceAwayFromZero) ? boundaryAwayFromZero // A clear win for away-from-zero.
          : mode switch // If the distances are equal, i.e. exactly halfway, we use the appropriate rounding strategy to resolve a winner.
    ...
    /// <summary>Rounds a value to the nearest boundary. Computes the distance to both boundaries and then calls the alternate <see cref="Round(TSelf, TSelf, TSelf, RoundingMode, TSelf, TSelf)"/>.</summary>
    public static double RoundToBoundaries(this double x, RoundingMode mode, double boundaryTowardsZero, double boundaryAwayFromZero)
    {
      ComputeDistanceToBoundaries(x, boundaryTowardsZero, boundaryAwayFromZero, out double distanceTowardsZero, out double distanceAwayFromZero);

      return RoundToBoundaries(x, mode, boundaryTowardsZero, boundaryAwayFromZero, distanceTowardsZero, distanceAwayFromZero);
    }
    ...
    /// <param name="maxDistanceToBoundaries">The maximum distance considered to be within range of one or both of the boundaries. The indicator is returned by the method.</param>
    /// <returns>Whether <paramref name="distanceTowardsZero"/> or <paramref name="distanceAwayFromZero"/> are within <paramref name="maxDistanceToBoundaries"/>.</returns>
    public static void ComputeDistanceToBoundaries(this System.Numerics.BigInteger x, System.Numerics.BigInteger boundaryTowardsZero, System.Numerics.BigInteger boundaryAwayFromZero, out System.Numerics.BigInteger distanceTowardsZero, out System.Numerics.BigInteger distanceAwayFromZero)
    {
      var origin = x;

      distanceTowardsZero = System.Numerics.BigInteger.Abs(origin - boundaryTowardsZero); // Distance from value to the boundary towardsZero.
      distanceAwayFromZero = System.Numerics.BigInteger.Abs(boundaryAwayFromZero - origin); // Distance from value to the boundary awayFromZero;
    }

    /// <summary>Rounds a value to the nearest boundary. The distance computation is a slight optimization for special cases, e.g. when rounding to multiple of. The mode specifies how to round when between two intervals.</summary>
    public static System.Numerics.BigInteger RoundToBoundaries(this System.Numerics.BigInteger x, RoundingMode mode, System.Numerics.BigInteger boundaryTowardsZero, System.Numerics.BigInteger boundaryAwayFromZero, System.Numerics.BigInteger distanceTowardsZero, System.Numerics.BigInteger distanceAwayFromZero)
      => mode switch
      {
        // First we take care of the direct rounding cases.
        RoundingMode.AwayFromZero => boundaryAwayFromZero,
    ...
    /// <summary>Rounds a value to the nearest boundary. Computes the distance to both boundaries and then calls the alternate <see cref="Round(TSelf, TSelf, TSelf, RoundingMode, TSelf, TSelf)"/>.</summary>
    public static System.Numerics.BigInteger RoundToBoundaries(this System.Numerics.BigInteger x, RoundingMode mode, System.Numerics.BigInteger boundaryTowardsZero, System.Numerics.BigInteger boundaryAwayFromZero)
    {
      ComputeDistanceToBoundaries(x, boundaryTowardsZero, boundaryAwayFromZero, out System.Numerics.BigInteger distanceTowardsZero, out System.Numerics.BigInteger distanceAwayFromZero);
