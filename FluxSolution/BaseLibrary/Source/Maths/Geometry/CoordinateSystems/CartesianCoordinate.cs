...
namespace Flux
{
  ...
  {
    /// <summary>Creates a <see cref="Geometry.CartesianCoordinate{double}"/> from the <see cref="Geometry.CylindricalCoordinate"/>.</summary>
    /// <remarks>All angles in radians.</remarks>
    public static Geometry.CartesianCoordinate<double> ToCartesianCoordinate(this Geometry.CylindricalCoordinate source, double w = 0)
    {
      var (sin, cos) = System.Math.SinCos(source.Azimuth);
    ...
    public static Geometry.CartesianCoordinate<double> ToCartesianCoordinate(this Geometry.PolarCoordinate source, double z = 0, double w = 0)
    {
      var (sin, cos) = System.Math.SinCos(source.Azimuth);
    ...
    /// <remarks>All angles in radians.</remarks>
    public static Geometry.CartesianCoordinate<double> ToCartesianCoordinate(this Geometry.SphericalCoordinate source, double w = 0)
    {
    ...
    public static Geometry.CylindricalCoordinate ToCylindricalCoordinate(this Geometry.CartesianCoordinate<double> source)
    ...
    public static Geometry.PolarCoordinate ToPolarCoordinate(this Geometry.CartesianCoordinate<double> source)
      => new(
        System.Math.Sqrt(source.X * source.X + source.Y * source.Y),
    ...
    public static Geometry.SphericalCoordinate ToSphericalCoordinate(this Geometry.CartesianCoordinate<double> source)
    {
    ...
    public static System.Runtime.Intrinsics.Vector128<double> ToVector128XY(this Geometry.CartesianCoordinate<double> source)
      => System.Runtime.Intrinsics.Vector128.Create(source.X, source.Y);

    public static System.Runtime.Intrinsics.Vector256<double> ToVector256XY(this Geometry.CartesianCoordinate<double> source, double z = 0, double w = 0)
      => System.Runtime.Intrinsics.Vector256.Create(source.X, source.Y, z, w);

    public static System.Runtime.Intrinsics.Vector256<double> ToVector256XYZ(this Geometry.CartesianCoordinate<double> source, double w = 0)
      => System.Runtime.Intrinsics.Vector256.Create(source.X, source.Y, source.Z, w);

    public static Geometry.CartesianCoordinate<double> ToCartesianCoordinate(this System.Numerics.Vector2 source, double z = 0, double w = 0)
      => new(source.X, source.Y, z, w);

    public static Geometry.CartesianCoordinate<double> ToCartesianCoordinate(this System.Numerics.Vector3 source, double w = 0)
  ...
  namespace Geometry
  {
    ...
    public readonly record struct CartesianCoordinate<TSelf>
      : System.IFormattable//, ICartesianCoordinate4<double>
      where TSelf : System.Numerics.INumber<TSelf>
    {
      ...
      public CartesianCoordinate(TSelf x, TSelf y, TSelf z, TSelf w)
      {
        m_x = x;
        m_y = y;
        m_z = z;
      ...
      //public CartesianCoordinate(double x, double y, double z) : this(x, y, z, 0) { }
      //public CartesianCoordinate(double x, double y) : this(x, y, 0, 0) { }

      /// <summary>The X (1st) component of the vector.</summary>
      public TSelf X => m_x;

      /// <summary>The Y (2nd) component of the vector.</summary>
      public TSelf Y => m_y;

      /// <summary>The Z (3rd) component of the vector.</summary>
      public TSelf Z => m_z;

      /// <summary>The W (4th) component of the vector.</summary>
      public TSelf W => m_w;
      ...
      public TSelf ToLinearIndex2D(TSelf width) => m_x + (m_y * width);
      ...
      public TSelf ToLinearIndex3D(TSelf width, TSelf height) => m_x + (m_y * width) + (m_z * width * height);

      public System.Numerics.Vector2 ToVector2() => new(float.CreateChecked(m_x), float.CreateChecked(m_y));
      public System.Numerics.Vector3 ToVector3() => new(float.CreateChecked(m_x), float.CreateChecked(m_y), float.CreateChecked(m_z));
      public System.Numerics.Vector4 ToVector4() => new(float.CreateChecked(m_x), float.CreateChecked(m_y), float.CreateChecked(m_z), float.CreateChecked(m_w));

      #region Static methods

      /// <summary>Converts cartesian 2D (<paramref name="x"/>, <paramref name="y"/>) coordinates to a linear index of a grid with the <paramref name="width"/>.</summary>
      public static TSelf ConvertCartesian2ToLinearIndex(TSelf x, TSelf y, TSelf width)
        => x + (y * width);

      /// <summary>Converts cartesian 3D (<paramref name="x"/>, <paramref name="y"/>, <paramref name="z"/>) coordinates to a linear index of a cube with the <paramref name="width"/> and <paramref name="height"/>.</summary>
      public static TSelf ConvertCartesian3ToLinearIndex(TSelf x, TSelf y, TSelf z, TSelf width, TSelf height)
      ...
      public static (TSelf x, TSelf y) ConvertLinearIndexToCartesian2(TSelf linearIndex, TSelf width)
         => (
          linearIndex % width,
          linearIndex / width
        );
      ...
      public static (TSelf x, TSelf y, TSelf z) ConvertLinearIndexToCartesian3(TSelf linearIndex, TSelf width, TSelf height)
      {
        var xy = width * height;
      ...
      public static CartesianCoordinate<TSelf> FromLinearIndexToCartesian2(TSelf linearIndex, TSelf width) => (CartesianCoordinate<TSelf>)ConvertLinearIndexToCartesian2(linearIndex, width);

      public static CartesianCoordinate<TSelf> FromLinearIndexToCartesian3(TSelf linearIndex, TSelf width, TSelf height) => (CartesianCoordinate<TSelf>)ConvertLinearIndexToCartesian3(linearIndex, width, height);

      #endregion // Static methods

      #region Operator overloads

      public static explicit operator System.ValueTuple<TSelf, TSelf>(CartesianCoordinate<TSelf> cc) => new(cc.X, cc.Y);
      public static explicit operator CartesianCoordinate<TSelf>(System.ValueTuple<TSelf, TSelf> vt) => new(vt.Item1, vt.Item2, TSelf.Zero, TSelf.Zero);

      public static explicit operator System.ValueTuple<TSelf, TSelf, TSelf>(CartesianCoordinate<TSelf> cc) => new(cc.X, cc.Y, cc.Z);
      public static explicit operator CartesianCoordinate<TSelf>(System.ValueTuple<TSelf, TSelf, TSelf> vt) => new(vt.Item1, vt.Item2, vt.Item3, TSelf.Zero);

      public static explicit operator System.ValueTuple<TSelf, TSelf, TSelf, TSelf>(CartesianCoordinate<TSelf> cc) => new(cc.X, cc.Y, cc.Z, cc.W);
      public static explicit operator CartesianCoordinate<TSelf>(System.ValueTuple<TSelf, TSelf, TSelf, TSelf> vt) => new(vt.Item1, vt.Item2, vt.Item3, vt.Item4);

      #endregion // Operator overloads

      public string ToString(string? format, IFormatProvider? formatProvider) => $"<{m_x}, {m_y}, {m_z}, {m_w}>";
