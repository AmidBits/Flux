namespace Flux
{
  ...
  public static partial class GeometryExtensionMethods
  {
    ...
    public static TSelf AbsoluteSum<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source)
    ...
    /// </summary>
    public static TSelf AngleTo<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> a, Geometry.ICartesianCoordinate2<TSelf> b)
      ...
      => TSelf.Acos(TSelf.Clamp(Geometry.ICartesianCoordinate2<TSelf>.DotProduct(a, b) / (a.EuclideanLength() * b.EuclideanLength()), -TSelf.One, TSelf.One));
    ...
    public static TSelf ChebyshevLength<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source, TSelf edgeLength)
      where TSelf : System.Numerics.INumber<TSelf>
    ...
    public static TSelf DotProductEx<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> a, Geometry.ICartesianCoordinate2<TSelf> b)
      where TSelf : System.Numerics.INumber<TSelf>, System.Numerics.IRootFunctions<TSelf>
      => Geometry.ICartesianCoordinate2<TSelf>.DotProduct(a, b) / TSelf.Sqrt(a.EuclideanLengthSquared() * b.EuclideanLengthSquared());

    /// <summary>Compute the Euclidean length of the vector.</summary>
    public static TSelf EuclideanLength<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>, System.Numerics.IRootFunctions<TSelf>
      => TSelf.Sqrt(source.EuclideanLengthSquared());

    /// <summary>Compute the Euclidean length squared of the vector.</summary>
    public static TSelf EuclideanLengthSquared<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>
    ...
    public static Geometry.CartesianCoordinate2<TSelf> Lerp<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source, Geometry.ICartesianCoordinate2<TSelf> target, TSelf mu)
    ...
    public static TSelf ManhattanLength<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source, TSelf edgeLength)
      where TSelf : System.Numerics.INumber<TSelf>
    ...
    public static Geometry.CartesianCoordinate2<TSelf> Nlerp<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source, Geometry.ICartesianCoordinate2<TSelf> target, TSelf mu)
      where TSelf : System.Numerics.IFloatingPointIeee754<TSelf>
    ...
    public static Geometry.CartesianCoordinate2<TSelf> Normalized<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source)
      where TSelf : System.Numerics.IFloatingPointIeee754<TSelf>
      => source.EuclideanLength() is var m && m != TSelf.Zero ? new Geometry.CartesianCoordinate2<TSelf>(source.X, source.Y) / m : new Geometry.CartesianCoordinate2<TSelf>(source.X, source.Y);

    /// <summary>Returns the orthant (quadrant) of the 2D vector using the specified center and orthant numbering.</summary>
    /// <see cref="https://en.wikipedia.org/wiki/Orthant"/>
    public static int OrthantNumber<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source, Geometry.ICartesianCoordinate2<TSelf> center, OrthantNumbering numbering)
      where TSelf : System.Numerics.INumber<TSelf>
      => numbering switch
      {
    ...
    public static Geometry.CartesianCoordinate2<TSelf> PerpendicularCcw<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>
      => new(
        -source.Y,
        source.X
    ...
    public static Geometry.CartesianCoordinate2<TSelf> PerpendicularCw<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>
      => new(
        source.Y,
        -source.X
    ...
    public static Geometry.CartesianCoordinate2<TSelf> Slerp<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source, Geometry.ICartesianCoordinate2<TSelf> target, TSelf mu)
      where TSelf : System.Numerics.INumber<TSelf>, System.Numerics.ITrigonometricFunctions<TSelf>
    {
      var dp = TSelf.Clamp(Geometry.ICartesianCoordinate2<TSelf>.DotProduct(source, target), -TSelf.One, TSelf.One); // Ensure precision doesn't exceed acos limits.
    ...
    /// <summary>Creates a new <see cref="Geometry.PolarCoordinate{TSelf}"/> from a <see cref=" Geometry.ICartesianCoordinate2{TSelf}"/>.</summary>
    public static Geometry.PolarCoordinate ToPolarCoordinate<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source)
      where TSelf : System.Numerics.IFloatingPointIeee754<TSelf>
      => new(
    ...
    /// <summary>Converts the <see cref="Geometry.CartesianCoordinate2{TSelf}"/> to a <see cref="System.Numerics.Vector2"/>.</summary>
    public static System.Numerics.Vector2 ToVector2<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>
    ...
    public static System.Runtime.Intrinsics.Vector128<double> ToVector128<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>
    ...
    public static System.Runtime.Intrinsics.Vector256<double> ToVector256<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source, TSelf z, TSelf w)
      where TSelf : System.Numerics.INumber<TSelf>
    ...
    public static System.Runtime.Intrinsics.Vector256<double> ToVector256<TSelf>(this Geometry.ICartesianCoordinate2<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>
