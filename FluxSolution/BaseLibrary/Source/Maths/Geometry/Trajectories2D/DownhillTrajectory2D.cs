namespace Flux.Mechanics
{
    ...
    : ITrajectory2D
  {
    ...
    public DownhillTrajectory2D(Units.Length verticalDifference, Units.Angle initialAngle, Units.LinearVelocity initialVelocity, Units.Acceleration gravitationalAcceleration)
    {
    ...
    public DownhillTrajectory2D(Units.Length verticalDifference, Units.Angle initialAngle, Units.LinearVelocity initialVelocity)
