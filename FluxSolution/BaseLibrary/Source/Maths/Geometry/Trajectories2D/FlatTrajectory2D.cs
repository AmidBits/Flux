namespace Flux.Mechanics
{
    ...
    : ITrajectory2D
  {
    ...
    public FlatTrajectory2D(double initialAngle, double initialVelocity) : this(initialAngle, initialVelocity, 9.80665) { }
    ...
    public double MaxRange => m_initialVelocity * MaxTime * System.Math.Cos(m_initialAngle);
    public double MaxTime => 2 * m_initialVelocity * System.Math.Sin(m_initialAngle) / m_gravitationalAcceleration;
