namespace Flux.Mechanics
{
    ...
    : ITrajectory2D
  {
    ...
    public UphillTrajectory2D(double verticalDifference, double initialAngle, double initialVelocity)
    ...
    public double MaxTime
      => m_initialVelocity * System.Math.Sin(m_initialAngle) / m_gravitationalAcceleration + System.Math.Sqrt(2 * (MaxHeight - m_verticalDifference) / m_gravitationalAcceleration);
