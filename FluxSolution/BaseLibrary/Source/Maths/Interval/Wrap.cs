namespace Flux
{
  ...
  {
    /// <summary>Returns the <paramref name="value"/> indefinitely wrapped (overflowed) around the boundaries of the closed interval [<paramref name="minimum"/>, <paramref name="maximum"/>].</summary>
