namespace Flux
{
  ...
  public enum RoundingBehavior
  {
    ...
    HalfTowardZero = System.MidpointRounding.ToZero,
    ...
    HalfToNegativeInfinity = System.MidpointRounding.ToNegativeInfinity,
    ...
    HalfToPositiveInfinity = System.MidpointRounding.ToPositiveInfinity,
  ...
  public static partial class Maths
  {
    ...
    public static decimal RoundToNearest(decimal value, RoundingBehavior mode)
      => mode switch
      {
    ...
    /// <summary>Rounds the <paramref name="value"/> to the nearest integer. The <paramref name="mode"/> specifies how to round if it is midway between two numbers.</summary>
    public static double RoundToNearest(double value, RoundingBehavior mode)
      => mode switch
      {
    ...
    /// <summary>Rounds the <paramref name="value"/> to the nearest integer. The <paramref name="mode"/> specifies how to round if it is midway between two numbers.</summary>
    public static float RoundToNearest(float value, RoundingBehavior mode)
