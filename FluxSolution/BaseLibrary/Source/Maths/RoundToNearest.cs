namespace Flux
{
  public static partial class Maths
  {
    ...
    public static decimal RoundToNearest(decimal value, FullRoundingBehavior mode)
      => mode switch
      {
    ...
    /// <summary>Rounds the <paramref name="value"/> to the nearest integer. The <paramref name="mode"/> specifies how to round if it is midway between two numbers.</summary>
    public static double RoundToNearest(double value, FullRoundingBehavior mode)
      => mode switch
      {
        FullRoundingBehavior.AwayFromZero => System.Math.Sign(value) < 0 ? System.Math.Floor(value) : System.Math.Ceiling(value),
        FullRoundingBehavior.Ceiling => System.Math.Ceiling(value),
    ...
    /// <summary>Rounds the <paramref name="value"/> to the nearest integer. The <paramref name="mode"/> specifies how to round if it is midway between two numbers.</summary>
    public static float RoundToNearest(float value, FullRoundingBehavior mode)
      => (float)RoundToNearest((double)value, mode);

    /// <summary>Rounds the <paramref name="value"/> to the nearest integer. The <paramref name="mode"/> specifies how to round if it is midway between two numbers.</summary>
    public static decimal RoundToNearest(decimal value, HalfRoundingBehavior mode)
      => mode switch
      {
    ...
    /// <summary>Rounds the <paramref name="value"/> to the nearest integer. The <paramref name="mode"/> specifies how to round if it is midway between two numbers.</summary>
    public static double RoundToNearest(double value, HalfRoundingBehavior mode)
      => mode switch
      {
    ...
    /// <summary>Rounds the <paramref name="value"/> to the nearest integer. The <paramref name="mode"/> specifies how to round if it is midway between two numbers.</summary>
    public static float RoundToNearest(float value, HalfRoundingBehavior mode)
      => (float)RoundToNearest((double)value, mode);
  }
}
