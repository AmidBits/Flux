...
namespace Flux
{
  ...
  {
    /// <summary>Returns the unit (or Heaviside) step of the specified value using the half-maximum convention, i.e. 0.0 when less than zero (negative), 1.0 when greater than zero (positive), 0.5 when zero.</summary>
