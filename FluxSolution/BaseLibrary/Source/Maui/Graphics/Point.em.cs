...
namespace Flux
{
  public static partial class ExtensionMethods
  {
    ...
    public static double AngleBetween(this in Geometry.Point2 source, in Geometry.Point2 before, in Geometry.Point2 after)
    ...
    /// </summary>
    public static double AngleTo(this in Geometry.Point2 source, in Geometry.Point2 target)
    ...
    public static double ChebyshevDistanceTo(this in Geometry.Point2 a, in Geometry.Point2 b, in double edgeLength = 1)
    ...
    public static Geometry.Point2 ComputeCentroid(this System.Collections.Generic.IEnumerable<Geometry.Point2> source)
      => source.Aggregate(Geometry.Point2.Zero, (a, e, i) => a + e, (a, c) => a / c);
    ...
    public static double CrossProduct(this in Geometry.Point2 p1, in Geometry.Point2 p2)
      => p1.X * p2.Y - p1.Y * p2.X;
    /// <summary>Returns the dot product of the two vectors.</summary>
    public static double DotProduct(this in Geometry.Point2 p1, in Geometry.Point2 p2)
      => p1.X * p2.X + p1.Y * p2.Y;

    public static double EuclideanDistanceSquaredTo(this in Geometry.Point2 a, in Geometry.Point2 b)
      => (a.X - b.X) * (a.X - b.X) + (a.Y - b.Y) * (a.Y - b.Y);
    public static double EuclideanDistanceTo(this in Geometry.Point2 a, in Geometry.Point2 b)
      => System.Math.Sqrt(EuclideanDistanceSquaredTo(a, b));

    /// <summary>Returns the length (squared) of the vector.</summary>
    public static double EuclideanLengthSquared(this in Geometry.Point2 v)
      => v.X * v.X + v.Y * v.Y;
    /// <summary>Returns the length of the vector.</summary>
    public static double EuclideanLength(this in Geometry.Point2 v)
    ...
    public static int InsidePolygon(this System.Collections.Generic.IList<Geometry.Point2> source, in Geometry.Point2 vector)
    {
    ...
    public static Geometry.Point2 InterpolateCosine(this in Geometry.Point2 y1, in Geometry.Point2 y2, double mu)
      => mu >= 0 && mu <= 1 && ((1.0 - System.Math.Cos(mu * System.Math.PI)) / 2.0) is double mu2
      ? (y1 * (1.0 - mu2) + y2 * mu2)
      : throw new System.ArgumentNullException(nameof(mu));
    public static Geometry.Point2 InterpolateCubic(this in Geometry.Point2 y0, in Geometry.Point2 y1, in Geometry.Point2 y2, Geometry.Point2 y3, double mu)
    {
      var mu2 = mu * mu;
    ...
    public static Geometry.Point2 InterpolateHermite(this in Geometry.Point2 y0, in Geometry.Point2 y1, in Geometry.Point2 y2, Geometry.Point2 y3, double mu, double tension, double bias)
    {
      var mu2 = mu * mu;
      var mu3 = mu2 * mu;
    ...
    public static Geometry.Point2 InterpolateLinear(this in Geometry.Point2 y1, in Geometry.Point2 y2, double mu)
      => y1 * (1 - mu) + y2 * mu;
    ...
    public static Geometry.Point2 LerpTo(this in Geometry.Point2 source, in Geometry.Point2 target, in double percent = 0.5)
    ...
    public static double ManhattanDistanceTo(this in Geometry.Point2 a, in Geometry.Point2 b, float edgeLength = 1)
      => System.Math.Abs(b.X - a.X) / edgeLength + System.Math.Abs(b.Y - a.Y) / edgeLength;

    public static Geometry.Point2 NlerpTo(this in Geometry.Point2 source, in Geometry.Point2 target, in double percent = 0.5)
      => source.NlerpTo(target, percent).Normalize();

    public static Geometry.Point2 Normalize(this in Geometry.Point2 source)
    {
    ...
    public static Geometry.Point2 PerpendicularCcw(this in Geometry.Point2 source)
    ...
    public static Geometry.Point2 PerpendicularCw(this in Geometry.Point2 source)
      => new Geometry.Point2(source.Y, -source.X);

    /// <summary>Perpendicular distance to the to the line.</summary>
    public static double PerpendicularDistance(this in Geometry.Point2 source, in Geometry.Point2 a, in Geometry.Point2 b)
    {
      var ab = b - a;
    ...
    public static double PerpendicularDistance(this in Geometry.Point2 source, double a, double b, double c)
    ...
    /// <param name="c">Represents c of the line equation (ax+by+c=0).</param>
    /// <param name="source">A given point.</param>
    //public static Geometry.Point2 PerpendicularFoot(this in Geometry.Point2 source, double a, double b, double c)
    ...
    /// <see cref="https://en.wikipedia.org/wiki/Quadrant_(plane_geometry)"/>
    public static int QuadrantNumber(this in Geometry.Point2 source, in Geometry.Point2 center)
    ...
    public static Geometry.Point2 Remainder(this in Geometry.Point2 p1, in Geometry.Point2 p2)
    ...
    //public static Geometry.Point2 Remainder(this in Geometry.Point2 p, double value)
    ...
    public static int SideTest(this in Geometry.Point2 source, in Geometry.Point2 a, in Geometry.Point2 b)
    ...
    public static Geometry.Point2 SlerpTo(this Geometry.Point2 source, in Geometry.Point2 target, double percent = 0.5)
    {
