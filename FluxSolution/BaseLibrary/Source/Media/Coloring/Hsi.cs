namespace Flux.Coloring
{
		...
		: System.IEquatable<Hsi>
	{
		...
		public static Hsi FromRng(System.Random? rng)
		{
			rng ??= new System.Random();

			return new Hsi(rng.NextDouble(), rng.NextDouble(), rng.NextDouble(), rng.NextDouble());
		}
		...
		public override string ToString()
			=> $"<{nameof(Hsi)}: {Alpha}, {Hue}, {Saturation}, {Intensity}>";
	}
}
