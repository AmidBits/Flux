...
//    public Hwb(double hue, double white, double black, double alpha)
//    {
...
//      m_alpha = alpha >= 0 && alpha <= 1 ? alpha : throw new System.ArgumentOutOfRangeException(nameof(white));
//    }
//    public Hwb(double hue, double saturation, double intensity)
...
//      return new Hwb(rng.NextDouble(0, 360), rng.NextDouble(), rng.NextDouble(), rng.NextDouble());
//    }
...
//      => Alpha == other.Alpha && Hue == other.Hue && White == other.White && Black == other.Black;

//    // Object (overrides)
//    public override bool Equals(object? obj)
//      => obj is Hwb o && Equals(o);
//    public override int GetHashCode()
//      => System.HashCode.Combine(Hue, White, Black, Alpha);
//    public override string ToString()
//      => $"<{GetType().Name}: {Hue}, {White}, {Black}, {Alpha}>";
//  }
//}
