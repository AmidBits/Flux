namespace Flux.Media.Dsp
{
  ...
  public static class FourierTransform
  {
    ...
    public static void FFT(System.Numerics.Complex[] data, Direction direction)
    {
      ...
      var n = data.Length;
      var m = (int)Numerics.BitOps.Log2(n);
    ...
    public static void FFT2(System.Numerics.Complex[,] data, Direction direction)
    {
      ...
      if ((!Numerics.BitOps.IsPowerOf2(k)) || (!Numerics.BitOps.IsPowerOf2(n)) || (k < minLength) || (k > maxLength) || (n < minLength) || (n > maxLength))
      {
    ...
    private static void ReorderData(System.Numerics.Complex[] data)
    {
      ...
      // check data length
      if ((len < minLength) || (len > maxLength) || (!Numerics.BitOps.IsPowerOf2(len)))
      {
        throw new System.ArgumentException("Incorrect data length.");
      }

      var rBits = GetReversedBits((int)Numerics.BitOps.Log2(len));
