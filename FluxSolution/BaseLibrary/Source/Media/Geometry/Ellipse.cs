namespace Flux.Media.Geometry
{
		...
		: System.IEquatable<Ellipse>, System.IFormattable
	{
		...
		[System.Runtime.InteropServices.FieldOffset(0)] private readonly double m_width;
		[System.Runtime.InteropServices.FieldOffset(4)] private readonly double m_height;
		[System.Runtime.InteropServices.FieldOffset(8)] private readonly double m_angle;
		...
		public string ToString(string? format, System.IFormatProvider? provider)
			=> $"<{nameof(Ellipse)}: {Width.ToString(format, provider)}, {Height.ToString(format, provider)}, {m_angle.ToString(format, provider)}>";
