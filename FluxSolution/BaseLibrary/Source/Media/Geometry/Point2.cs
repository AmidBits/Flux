...
namespace Flux.Media.Geometry
{
    ...
    : System.IEquatable<Point2>
  {
    ...
    public (string column, string row) ToLabels(System.Collections.Generic.IList<string> columnLabels, System.Collections.Generic.IList<string> rowLabels)
      => (columnLabels[m_x], rowLabels[m_y]);
    ...
    public static Point2 operator /(Point2 p1, int p2) => Divide(p1, p2);

    public static Point2 operator %(Point2 p1, int p2) => Remainder(p1, p2);
    public static Point2 operator %(Point2 p1, double p2) => Remainder(p1, p2);

    public static Point2 operator &(Point2 p1, Point2 p2) => BitwiseAnd(p1, p2);
    public static Point2 operator &(Point2 p1, int p2) => BitwiseAnd(p1, p2);

    public static Point2 operator |(Point2 p1, Point2 p2) => BitwiseOr(p1, p2);
    public static Point2 operator |(Point2 p1, int p2) => BitwiseOr(p1, p2);

    public static Point2 operator ^(Point2 p1, Point2 p2) => Xor(p1, p2);
    public static Point2 operator ^(Point2 p1, int p2) => Xor(p1, p2);

    public static Point2 operator <<(Point2 p1, int p2) => LeftShift(p1, p2);
    public static Point2 operator >>(Point2 p1, int p2) => RightShift(p1, p2);
