namespace Flux
{
  ...
  namespace Geometry
  {
    ...
    public struct Point3
      : System.IEquatable<Point3>, System.IFormattable
    {
      ...
      public static Point3 Add(in Point3 v1, in Point3 v2)
        => new Point3(v1.X + v2.X, v1.Y + v2.Y, v1.Z + v2.Z);
      ...
      public static Point3 LeftShift(in Point3 v, int count)
        => new Point3(v.X << count, v.Y << count, v.Z << count);
      ...
      public static Point3 OnesComplement(in Point3 v)
        => new Point3(~v.X, ~v.Y, ~v.Z); // .NET performs a one's complement (bitwise logical NOT) on integral types.
      ...
      public static double ChebyshevDistance(in Point3 v1, in Point3 v2)
        => Maths.Max(System.Math.Abs(v2.X - v1.X), System.Math.Abs(v2.Y - v1.Y), System.Math.Abs(v2.Z - v1.Z));
      ...
      public static Point3 CrossProduct(in Point3 v1, in Point3 v2)
        => new Point3(v1.Y * v2.Z - v1.Z * v2.Y, v1.Z * v2.X - v1.X * v2.Z, v1.X * v2.Y - v1.Y * v2.X);
      ...
      public static Point3 DivideCeiling(in Point3 v, double value)
        => new Point3((int)System.Math.Ceiling(v.X / value), (int)System.Math.Ceiling(v.Y / value), (int)System.Math.Ceiling(v.Z / value));
      /// <summary>Create a new vector with the floor(quotient) from each member divided by the value.</summary>
      public static Point3 DivideFloor(in Point3 v, double value)
        => new Point3((int)System.Math.Floor(v.X / value), (int)System.Math.Floor(v.Y / value), (int)System.Math.Floor(v.Z / value));
      ...
      public static int ManhattanDistance(in Point3 v1, in Point3 v2)
        => System.Math.Abs(v2.X - v1.X) + System.Math.Abs(v2.Y - v1.Y) + System.Math.Abs(v2.Z - v1.Z);
      ...
      public static Point3 Negate(in Point3 v)
        => new Point3(-v.X, -v.Y, -v.Z); // Negate the members of the vector.
      ...
      public static Point3 Remainder(in Point3 v, double value)
        => new Point3((int)(v.X % value), (int)(v.Y % value), (int)(v.Z % value));
      ...
      public static Point3 FromUniqueIndex(long index, in Point3 length)
      {
        ...
        return new Point3((int)(irxy % length.X), (int)(irxy / length.X), (int)(index / xy));
      }
      /// <summary>Converts the vector to a "mapped" index. This index is uniquely mapped using the specified size vector.</summary>
      public static long ToUniqueIndex(in Point3 vector, in Point3 length) => vector.X + (vector.Y * length.X) + (vector.Z * length.X * length.Y);
