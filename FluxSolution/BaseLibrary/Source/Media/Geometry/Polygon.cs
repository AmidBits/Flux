...
namespace Flux
{
  public static partial class Geometry
  {
    public struct Polygon
    {
      ...
      //public System.Collections.Generic.List<System.Numerics.Vector3> Vectors { get; set; }

      //public Polygon(System.Collections.Generic.List<System.Numerics.Vector3> vectors) => Vectors = new System.Collections.Generic.List<System.Numerics.Vector3>(vectors);
      //public Polygon(params System.Numerics.Vector3[] vectors) => Vectors = new System.Collections.Generic.List<System.Numerics.Vector3>(vectors);
      ...
      public static bool IsEquiangular(System.Collections.Generic.IEnumerable<System.Numerics.Vector3> source)
      {
        ...
        foreach (var triplet in source.PartitionTuple(2, (leading, midling, trailing, index) => (leading, midling, trailing)))
        {
          if (angle == double.NaN) angle = triplet.midling.AngleBetween(triplet.leading, triplet.trailing);
      ...
      public static bool IsEquilateral(System.Collections.Generic.IEnumerable<System.Numerics.Vector3> source)
      {
        ...
        {
          if (length == double.NaN) length = (pair.trailing - pair.leading).Length();
      ...
      public static System.Numerics.Vector3 SurfaceNormal(System.Collections.Generic.IList<System.Numerics.Vector3> source) => System.Numerics.Vector3.Cross(source[1] - source[0], source[2] - source[0]);
