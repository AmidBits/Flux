...
namespace Flux.Media.Midi
{
  ...
  public class Note
  {
    ...
    public static double ToFrequency(int note)
      => note >= 0 && note <= 127 ? ReferenceFrequency * System.Math.Pow(2, (note - ReferenceNote) / 12.0) : throw new System.ArgumentOutOfRangeException(nameof(note));
