...
namespace Flux.Media.WaveFile
{
  ...
  public class FormatChunk : Chunk
  {
    ...
    [System.CLSCompliant(false)] public ushort Format { get => System.BitConverter.ToUInt16(Buffer, 8); set { System.BitConverter.GetBytes((ushort)value).CopyTo(Buffer, 8); } }
    [System.CLSCompliant(false)] public ushort SampleChannels { get => System.BitConverter.ToUInt16(Buffer, 10); set { System.BitConverter.GetBytes(value).CopyTo(Buffer, 10); UpdateBlockAlign(); } }
    [System.CLSCompliant(false)] public uint SampleRate { get => System.BitConverter.ToUInt32(Buffer, 12); set { System.BitConverter.GetBytes(value).CopyTo(Buffer, 12); UpdateAvgBytesPerSec(); } }
    [System.CLSCompliant(false)] public uint AvgBytesPerSec { get => System.BitConverter.ToUInt32(Buffer, 16); set { System.BitConverter.GetBytes(value).CopyTo(Buffer, 16); } }
    [System.CLSCompliant(false)] public ushort BlockAlign { get => System.BitConverter.ToUInt16(Buffer, 20); set { System.BitConverter.GetBytes(value).CopyTo(Buffer, 20); UpdateAvgBytesPerSec(); } }
    [System.CLSCompliant(false)] public ushort SampleBitDepth { get => System.BitConverter.ToUInt16(Buffer, 22); set { System.BitConverter.GetBytes(value).CopyTo(Buffer, 22); UpdateBlockAlign(); } }

    public bool IsExtendedFormat => (Buffer.Length > 24 && ExtensionSize == 22);
    [System.CLSCompliant(false)] public ushort ExtensionSize { get => System.BitConverter.ToUInt16(Buffer, 24); set { System.BitConverter.GetBytes(value).CopyTo(Buffer, 24); } }
    [System.CLSCompliant(false)] public ushort ValidBitsPerSample { get => System.BitConverter.ToUInt16(Buffer, 26); set { System.BitConverter.GetBytes(value).CopyTo(Buffer, 26); } }
    [System.CLSCompliant(false)] public uint ChannelMask { get => System.BitConverter.ToUInt32(Buffer, 28); set { System.BitConverter.GetBytes(value).CopyTo(Buffer, 28); } }
    ...
    public FormatChunk(byte[] bytes)
      : base(bytes)
    {
    }

    [System.CLSCompliant(false)] public ushort UpdateBlockAlign() => BlockAlign = (ushort)(SampleChannels * (SampleBitDepth / 8));
  ...
  public class DataChunk : Chunk
  {
    ...
    [System.CLSCompliant(false)]
    public DataChunk(uint sampleBufferSize = 0)
      : base(ID, sampleBufferSize + 8)
    {
    }
  ...
  public static class WavFile
  {
    ...
    public static void CreateFile16BitMono(string path, Flux.Dsp.Oscillator oscillator, int sampleCount)
    {
      ...
      var rtc = new RiffTypeChunk();
      var fc = new FormatChunk(1, (uint)oscillator.SampleRate, 16);
      var dc = new DataChunk { ChunkSize = fc.BytesPerSample * (uint)sampleCount };
    ...
    public static void CreateFile16BitStereo(string path, Flux.Dsp.Oscillator oscillatorL, Flux.Dsp.Oscillator oscillatorR, uint sampleCount)
    {
      ...
      var dc = new DataChunk { ChunkSize = fc.BytesPerSample * sampleCount };
