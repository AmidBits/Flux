namespace Flux
{
  public static partial class XtensionsReadOnlySpan
  {
    ...
    public static bool Contains<T>(this System.ReadOnlySpan<T> source, T target, [System.Diagnostics.CodeAnalysis.DisallowNull] System.Collections.Generic.IEqualityComparer<T> comparer)
    {
    ...
    /// <summary>Determines whether the this instance contains the specified target. Uses the default comparer.</summary>
    public static bool Contains<T>(this System.ReadOnlySpan<T> source, T target)
