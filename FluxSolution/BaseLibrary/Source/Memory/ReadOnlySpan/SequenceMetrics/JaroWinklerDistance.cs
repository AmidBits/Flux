...
namespace Flux.SequenceMetrics
{
    ...
    : INormalizedDistance<T>
  {
    ...
    /// <see cref="https://en.wikipedia.org/wiki/Jaro–Winkler_distance"/>
    /// <seealso cref="http://alias-i.com/lingpipe/docs/api/com/aliasi/spell/JaroWinklerDistance.html"/>
    public double GetNormalizedSimilarity(System.ReadOnlySpan<T> source, System.ReadOnlySpan<T> target, System.Collections.Generic.IEqualityComparer<T> comparer)
    {
