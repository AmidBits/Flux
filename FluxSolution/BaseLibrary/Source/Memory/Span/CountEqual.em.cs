namespace Flux
{
  public static partial class XtendSpan
  {
    ...
    public static int CountEqualOnBothSides<T>(this System.Span<T> source, System.ReadOnlySpan<T> target, [System.Diagnostics.CodeAnalysis.DisallowNull] System.Collections.Generic.IEqualityComparer<T> comparer)
    ...
    public static int CountEqualOnBothSides<T>(this System.Span<T> source, System.ReadOnlySpan<T> target)
    ...
    public static int CountEqualAtStart<T>(this System.Span<T> source, System.ReadOnlySpan<T> target, out int minLength)
    ...
    public static int CountEqualAtStart<T>(this System.Span<T> source, System.ReadOnlySpan<T> target, [System.Diagnostics.CodeAnalysis.DisallowNull] System.Collections.Generic.IEqualityComparer<T> comparer)
      => CountEqualAtStart(source, target, comparer, out var _);
    /// <summary>Reports the length (or count) of equality at the start of the sequence. Using the default comparer.</summary>
    public static int CountEqualAtStart<T>(this System.Span<T> source, System.ReadOnlySpan<T> target)
    ...
    public static int CountEqualAtEnd<T>(this System.Span<T> source, System.ReadOnlySpan<T> target, out int minLength)
    ...
    public static int CountEqualAtEnd<T>(this System.Span<T> source, System.ReadOnlySpan<T> target, [System.Diagnostics.CodeAnalysis.DisallowNull] System.Collections.Generic.IEqualityComparer<T> comparer)
    ...
    public static int CountEqualAtEnd<T>(this System.Span<T> source, System.ReadOnlySpan<T> target)
