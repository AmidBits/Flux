namespace Flux
{
  public static partial class XtendSpan
  {
    ...
    public static int CountEqualOnBothEnds<T>(this System.Span<T> source, System.ReadOnlySpan<T> target, [System.Diagnostics.CodeAnalysis.DisallowNull] System.Collections.Generic.IEqualityComparer<T> comparer)
    ...
    public static int CountEqualOnBothEnds<T>(this System.Span<T> source, System.ReadOnlySpan<T> target)
    ...
    public static int CountEqualOnLeft<T>(this System.Span<T> source, System.ReadOnlySpan<T> target, [System.Diagnostics.CodeAnalysis.DisallowNull] System.Collections.Generic.IEqualityComparer<T> comparer, out int minLength)
    {
    ...
    public static int CountEqualOnLeft<T>(this System.Span<T> source, System.ReadOnlySpan<T> target, out int minLength)
    ...
    public static int CountEqualOnLeft<T>(this System.Span<T> source, System.ReadOnlySpan<T> target, [System.Diagnostics.CodeAnalysis.DisallowNull] System.Collections.Generic.IEqualityComparer<T> comparer)
      => CountEqualOnLeft(source, target, comparer, out var _);
    /// <summary>Reports the length (or count) of equality at the start of the sequence. Using the default comparer.</summary>
    public static int CountEqualOnLeft<T>(this System.Span<T> source, System.ReadOnlySpan<T> target)
    ...
    public static int CountEqualOnRight<T>(this System.Span<T> source, System.ReadOnlySpan<T> target, [System.Diagnostics.CodeAnalysis.DisallowNull] System.Collections.Generic.IEqualityComparer<T> comparer, out int minLength)
    {
      comparer ??= System.Collections.Generic.EqualityComparer<T>.Default;
    ...
    public static int CountEqualOnRight<T>(this System.Span<T> source, System.ReadOnlySpan<T> target, out int minLength)
    ...
    public static int CountEqualOnRight<T>(this System.Span<T> source, System.ReadOnlySpan<T> target, [System.Diagnostics.CodeAnalysis.DisallowNull] System.Collections.Generic.IEqualityComparer<T> comparer)
    ...
    public static int CountEqualOnRight<T>(this System.Span<T> source, System.ReadOnlySpan<T> target)
