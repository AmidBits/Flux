...
//namespace Flux.Csp
//{
//  public class DomainBinaryInteger
//    : IDomain<int>
//  {
...
//    {
//      if (domainSize < 0)
//        throw new System.ArgumentException("Invalid Domain Size");
...
//      this.lowerBound = System.Math.Max(lowerBound, 0);
//      this.size = upperBound - lowerBound + 1;
//      var count = 0;
...
//        throw new System.ArgumentException("Invalid Domain Bounds");

//      var domainImpl = new DomainBinaryInteger(lowerBound, upperBound);
//      return domainImpl;
//    }

//    public static IDomain<int> CreateDomain(System.Collections.Generic.IList<int> elements)
//    {
...
//      System.Array.Copy(this.domain, clone.domain, this.domain.Length);
