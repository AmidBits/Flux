namespace Flux.Dsp.AudioProcessor
{
    ...
    : IAudioProcessorMono
  {
    ...
    public LaggerMono(double amount)
      => m_amount = amount;
    public LaggerMono()
      : this(0.75)
    {
    ...
    public MonoSample ProcessAudio(MonoSample sample) => new MonoSample(m_amount > Maths.EpsilonCpp32 ? m_previousSample = Maths.InterpolateCosine(sample.FrontCenter, m_previousSample, m_amount) : sample.FrontCenter);
  }
    ...
    : IAudioProcessorStereo
  {
    ...
    public LaggerStereo(double amount)
      : this(amount, amount)
    {
    }
    public LaggerStereo()
