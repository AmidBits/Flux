namespace Flux.Dsp.AudioProcessor
{
    ...
    : IAudioProcessorStereo
  {
    ...
    public StereoSample ProcessAudio(StereoSample sample)
      => new StereoSample(sample.FrontLeft * m_cosC - sample.FrontRight * m_sinC, sample.FrontLeft * m_sinC + sample.FrontRight * m_cosC);
    ...
    public static (double left, double right) ApplyStereoFieldRotation(double angle, double left, double right)
