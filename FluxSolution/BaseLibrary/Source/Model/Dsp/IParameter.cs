namespace Flux.Dsp
{
  ...
  public class ModulatedValue : IModulatedParameter
  {
    ...
    public double Modulation { get => _modulation; set => _modulation = Math.Clamp(value, 0.0, 1.0); }
    ...
    public double Value { get => _value; set => _value = Math.Clamp(value, -1.0, 1.0); }
    ...
    {
      if (Modulator != null && _modulation > Math.EpsilonCpp32)
      {
