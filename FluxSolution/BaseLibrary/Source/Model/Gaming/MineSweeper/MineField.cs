...
#pragma warning restore CA1710 // Identifiers should have correct suffix
  ...
  public static class Game
  {
    public static void RenderInConsole(Flux.Model.Gaming.MineSweeper.GameState gameState, Flux.Model.Gaming.MineSweeper.MineField mineField)
    {
      ...
      System.Console.WriteLine(Formatters.ArrayFormatter.Separated.TwoToConsoleString(charField, (e, i) => e.ToString()));
      for (var i = 0; i < mineField.Field.Size.Height; i++)
        for (var j = 0; j < mineField.Field.Size.Width; j++)
          if (charField[i, j] == 'M')
    ...
    {
      var mineField = new Flux.Model.Gaming.MineSweeper.MineField(new Flux.Geometry.Size2(10, 10), 10);
      var gameState = Flux.Model.Gaming.MineSweeper.Game.Start(mineField);
