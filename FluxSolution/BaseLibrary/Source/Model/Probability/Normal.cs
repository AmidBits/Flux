namespace Flux.Probability
{
  public sealed class Normal : IDistribution<double>
  {
    ...
    // Box-Muller method
    private double StandardSample() => System.Math.Sqrt(-2.0 * System.Math.Log(StandardContinuousUniform.Distribution.Sample())) * System.Math.Cos(2.0 * System.Math.PI * StandardContinuousUniform.Distribution.Sample());
