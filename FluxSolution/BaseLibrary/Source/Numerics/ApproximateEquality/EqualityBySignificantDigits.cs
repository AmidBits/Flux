namespace Flux
{
  ...
  namespace ApproximateEquality
  {
    ...
    /// <para>IsApproximatelyEqual(1334.261, 1235.272, -2); // -2 = 100 (two zeroes), so if the difference is less than 100, which is true in this case.</para>
    /// </remarks>
    public record class BySignificantDigitsI
      : IEqualityApproximatable<System.Numerics.BigInteger>
    {
      ...
      /// <summary>Create a comparison with a specified precision.</summary>
      /// <param name="significantDigits">A positive number will compare the number of digits on the right side of the decimal point. A negative number will compare the number of digits on the left side of the decimal point.</param>
      public BySignificantDigitsI(int significantDigits) => m_significantDigits = significantDigits;
      ...
      /// <summary>Perform a comparison of the difference against 10 raised to the power of the specified precision, where: negative numbers compare digits to the left of the decimal point, and positive numbers compare digits to the right of the decimal point.</summary>
      /// <param name="significantDigits">The tolerance, as a number of decimal digits, considered before finding inequality. Using a negative value allows for left side tolerance.</param>
      public static bool IsApproximatelyEqual(System.Numerics.BigInteger a, System.Numerics.BigInteger b, int significantDigits) => a == b || System.Numerics.BigInteger.Abs(a - b) <= System.Numerics.BigInteger.Pow(10, -significantDigits);

      public bool IsApproximatelyEqual(System.Numerics.BigInteger a, System.Numerics.BigInteger b) => IsApproximatelyEqual(a, b, m_significantDigits);
    }
    ...
    /// <para>IsApproximatelyEqual(1334.261, 1235.272, -2); // -2 = 100 (two zeroes), so if the difference is less than 100, which is true in this case.</para>
    /// </remarks>
    public record class BySignificantDigitsF
      : IEqualityApproximatable<double>
    {
      ...
      /// <summary>Create a comparison with a specified precision.</summary>
      /// <param name="significantDigits">A positive number will compare the number of digits on the right side of the decimal point. A negative number will compare the number of digits on the left side of the decimal point.</param>
      public BySignificantDigitsF(int significantDigits) => m_significantDigits = significantDigits;
      ...
      /// <summary>Perform a comparison of the difference against 10 raised to the power of the specified precision, where: negative numbers compare digits to the left of the decimal point, and positive numbers compare digits to the right of the decimal point.</summary>
      /// <param name="significantDigits">The tolerance, as a number of decimal digits, considered before finding inequality. Using a negative value allows for left side tolerance.</param>
      public static bool IsApproximatelyEqual(double a, double b, int significantDigits) => a == b || System.Math.Abs(a - b) <= System.Math.Pow(10, -significantDigits);

      public bool IsApproximatelyEqual(double a, double b) => IsApproximatelyEqual(a, b, m_significantDigits);
    }
  }
