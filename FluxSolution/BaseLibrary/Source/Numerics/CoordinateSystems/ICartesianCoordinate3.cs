namespace Flux
{
  public static partial class ExtensionMethods
  {
    ...
    /// </summary>
    public static TSelf AngleTo<TSelf>(ICartesianCoordinate3<TSelf> a, ICartesianCoordinate3<TSelf> b)
    ...
    public static TSelf SumOfAbsoluteCoordinates<TSelf>(this ICartesianCoordinate3<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>
      => TSelf.Abs(source.X) + TSelf.Abs(source.Y) + TSelf.Abs(source.Z);

    /// <summary>Converts the <see cref="ICartesianCoordinate3{TSelf}"/> to a <see cref="CartesianCoordinate3"/>.</summary>
