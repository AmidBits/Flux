namespace Flux
{
  ...
  public static partial class ExtensionMethods
  {
    ...
    public static CoordinateSystems.CartesianCoordinate3<TSelf> ToCartesianCoordinate3<TSelf>(this ICylindricalCoordinate<TSelf> source)
    ...
    public static CoordinateSystems.CylindricalCoordinate<TSelf> ToCylindricalCoordinate<TSelf>(this ICylindricalCoordinate<TSelf> source)
      where TSelf : System.Numerics.IFloatingPointIeee754<TSelf>
      => new(source.Radius, source.Azimuth, source.Height);

    /// <summary>Converts the cylindrical coordinates to polar coordinates.</summary>
    /// <remarks>All angles in radians.</remarks>
    public static CoordinateSystems.PolarCoordinate<TSelf> ToPolarCoordinate<TSelf>(this ICylindricalCoordinate<TSelf> source)
      where TSelf : System.Numerics.IFloatingPointIeee754<TSelf>
      => new(
        source.Radius,
        source.Azimuth
    ...
    /// <remarks>All angles in radians.</remarks>
    public static CoordinateSystems.SphericalCoordinate<TSelf> ToSphericalCoordinate<TSelf>(this ICylindricalCoordinate<TSelf> source)
      where TSelf : System.Numerics.IFloatingPointIeee754<TSelf>
      => new(
