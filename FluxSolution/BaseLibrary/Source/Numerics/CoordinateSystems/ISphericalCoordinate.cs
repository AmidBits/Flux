namespace Flux
{
  ...
  public static partial class CoordinateSystems
  {
    ...
    public static (Quantities.Length radius, Quantities.Angle inclination, Quantities.Angle azimuth) ToQuantities<TSelf>(this ISphericalCoordinate<TSelf> source)
