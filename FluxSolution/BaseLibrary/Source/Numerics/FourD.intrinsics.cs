...
namespace Flux
{
  ...
  {
    public static Flux.Numerics.Point3 ToPoint3(this System.Runtime.Intrinsics.Vector256<double> source)
      => new Flux.Numerics.Point3(source);
  }
}
...
namespace Flux.Numerics
{
  public struct Point3
  {
    ...
    { }
    public Point3(System.Runtime.Intrinsics.Vector256<double> v256)
      => m_v256 = v256;
    ...
    public double GetLength()
      => m_v256.Length3D().GetElement(0);

    public static Point3 operator +(Point3 a, Point3 b)
      => a.m_v256.Add(b.m_v256).ToPoint3();
    public static Point3 operator +(Point3 a, double b)
      => a.m_v256.Add(b).ToPoint3();
    public static Point3 operator /(Point3 a, Point3 b)
      => a.m_v256.Divide(b.m_v256).ToPoint3();
    public static Point3 operator /(Point3 a, double b)
      => a.m_v256.Divide(b).ToPoint3();
    public static Point3 operator *(Point3 a, Point3 b)
      => a.m_v256.Multiply(b.m_v256).ToPoint3();
    public static Point3 operator *(Point3 a, double b)
      => a.m_v256.Multiply(b).ToPoint3();
    public static Point3 operator -(Point3 a, Point3 b)
      => a.m_v256.Subtract(b.m_v256).ToPoint3();
    public static Point3 operator -(Point3 a, double b)
      => a.m_v256.Subtract(b).ToPoint3();
    public static Point3 operator %(Point3 a, Point3 b)
      => a.m_v256.Remainder(b.m_v256).ToPoint3();
    public static Point3 operator %(Point3 a, double b)
      => a.m_v256.Remainder(b).ToPoint3();
