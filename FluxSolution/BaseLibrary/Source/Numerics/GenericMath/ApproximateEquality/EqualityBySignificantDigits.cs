namespace Flux
{
  public static partial class GenericMath
  {
    ...
    /// <para>IsApproximatelyEqual(1334.261, 1235.272, -2);</para>
    /// </remarks>
    public static bool IsApproximatelyEqualPrecision(this decimal a, decimal b, int significantDigits, int radix = 10)
    ...
    /// <para>IsApproximatelyEqual(1334.261, 1235.272, -2);</para>
    /// </remarks>
    public static bool IsApproximatelyEqualPrecision(this double a, double b, int significantDigits, int radix = 10)
    ...
    /// <para>IsApproximatelyEqual(1334.261, 1235.272, -2);</para>
    /// </remarks>
    public static bool IsApproximatelyEqualPrecision(this System.Numerics.BigInteger a, System.Numerics.BigInteger b, int significantDigits, int radix = 10)
    ...
    /// <para>IsApproximatelyEqual(1334.261, 1235.272, -2);</para>
    /// </remarks>
    public static bool IsApproximatelyEqualPrecision(this int a, int b, int significantDigits, int radix = 10)
      => a == b || (System.Math.Abs(a - b) <= System.Math.Pow(AssertRadix(radix), -significantDigits));
    ...
    /// <para>IsApproximatelyEqual(1334.261, 1235.272, -2);</para>
    /// </remarks>
    public static bool IsApproximatelyEqualPrecision(this long a, long b, int significantDigits, int radix = 10)
      => a == b || (System.Math.Abs(a - b) <= System.Math.Pow(AssertRadix(radix), -significantDigits));
