namespace Flux
{
  ...
  {
    public static readonly double DoubleEpsilonNegative = ComputeNegativeEpsilon<double>();
    public static readonly double DoubleEpsilonPositive = ComputePositiveEpsilon<double>();

    public static readonly float SingleEpsilonNegative = ComputeNegativeEpsilon<float>();
    public static readonly float SingleEpsilonPositive = ComputePositiveEpsilon<float>();
