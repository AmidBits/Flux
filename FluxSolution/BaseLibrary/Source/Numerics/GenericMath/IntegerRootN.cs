namespace Flux
{
  public static partial class GenericMath
  {
    ...
    /// <summary>Returns the the largest integer less than or equal to the <paramref name="n"/>th root of <paramref name="y"/>.</summary>
    public static System.Numerics.BigInteger IntegerRootN(this System.Numerics.BigInteger y, System.Numerics.BigInteger n)
    {
      AssertNonNegative(y, nameof(y));
      AssertRoot(n);
    ...
    /// <param name="x"></param>
    /// <returns></returns>
    public static bool IsPerfectIntegerRootN(System.Numerics.BigInteger y, System.Numerics.BigInteger n, System.Numerics.BigInteger x)
      => y == IntegerPow(x, n);

    /// <summary>Attempts to compute the (floor) <paramref name="n"/>th root of <paramref name="y"/> into the out parameter <paramref name="x"/>.</summary>
    public static bool TryIntegerRootN(System.Numerics.BigInteger y, System.Numerics.BigInteger n, out System.Numerics.BigInteger x)
    {
      try
      {
        x = IntegerRootN(y, n);
