...
namespace Flux
{
  public static partial class GenericMath
  {
    ...
    /// <summary>PREVIEW! Find the nearest (to <paramref name="x"/>) of two power-of-radix, using the specified <see cref="IntegerRounding"/> <paramref name="mode"/>, and also return both power-of-radix as out parameters.</summary>
    ...
    /// <param name="nearestAwayFromZero">Outputs the power-of-radix that is farther from zero.</param>
    /// <returns>The nearest two power-of-radix to value.</returns>
    public static TResult RoundToPow<TSelf, TRadix, TResult>(this TSelf x, TRadix b, bool properNearest, IntegerRounding mode, out TResult nearestTowardsZero, out TResult nearestAwayFromZero)
      where TSelf : System.Numerics.IFloatingPoint<TSelf>, System.Numerics.ILogarithmicFunctions<TSelf>, System.Numerics.IPowerFunctions<TSelf>
      where TRadix : System.Numerics.IBinaryInteger<TRadix>
      where TResult : System.Numerics.INumber<TResult>
    {
