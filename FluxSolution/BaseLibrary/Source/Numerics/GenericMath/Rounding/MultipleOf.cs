...
namespace Flux
{
  public static partial class GenericMath
  {
    ...
    /// <param name="multiple">The multiple for which the results will align.</param>
    ...
    /// <param name="towardsZero">Outputs the multiple of that is towards zero.</param>
    /// <param name="awayFromZero">Outputs the multiple of that is away from zero.</param>
