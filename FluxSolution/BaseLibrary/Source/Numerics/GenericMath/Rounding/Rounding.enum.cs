...
namespace Flux
{
  ...
  public enum Rounding
  {
    ...
    HalfwayToEven = MidpointRounding.ToEven,
    ...
    HalfwayAwayFromZero = MidpointRounding.AwayFromZero,
    ...
    HalfwayTowardZero = MidpointRounding.ToZero,
    ...
    HalfwayToNegativeInfinity = MidpointRounding.ToNegativeInfinity,
    ...
    HalfwayToPositiveInfinity = MidpointRounding.ToPositiveInfinity,
