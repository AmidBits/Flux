...
namespace Flux.Quantilers
{
  ...
  public record class LinearInterpolationEmpiricalDistributionFunction
    : IQuantileEstimatable
  {
    public static IQuantileEstimatable Default => new LinearInterpolationEmpiricalDistributionFunction();
    ...
    public TSelf EstimateQuantile<TSelf>(System.Collections.Generic.IList<TSelf> sample, TSelf h)
      where TSelf : System.Numerics.IFloatingPoint<TSelf>
    {
      ...
      var sf = sample[System.Math.Clamp(System.Convert.ToInt32(hf), 0, sourceCountM1)]; // Floor of sample value at hf.
      var sc = sample[System.Math.Clamp(System.Convert.ToInt32(hc), 0, sourceCountM1)]; // Ceiling of sample value at hc.
