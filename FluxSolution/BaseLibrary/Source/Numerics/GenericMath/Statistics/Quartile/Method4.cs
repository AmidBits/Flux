namespace Flux.Quartiles
{
    ...
    : IQuartileComputable
  {
    ...
    public static void Compute<TSelf>(System.Collections.Generic.IList<TSelf> sample, out TSelf q1, out TSelf q2, out TSelf q3)
       where TSelf : System.Numerics.IFloatingPoint<TSelf>
    {
      q1 = Empirical.Estimate(sample, TSelf.CreateChecked(0.25));
      q2 = Empirical.Estimate(sample, TSelf.CreateChecked(0.50));
      q3 = Empirical.Estimate(sample, TSelf.CreateChecked(0.75));
    }
  }
}
