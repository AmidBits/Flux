...
namespace Flux
{
  public static partial class Vector
  {
    ...
    public static TSelf Cartesian2ToRotationAngle<TSelf>(TSelf x, TSelf y)
      ...
      => TSelf.Atan2(y, x) is var atan2 && atan2 < TSelf.Zero ? TSelf.Pi.Mul2() + atan2 : atan2;
    ...
    public static TSelf Cartesian2ToRotationAngleEx<TSelf>(TSelf x, TSelf y)
      where TSelf : System.Numerics.IFloatingPointIeee754<TSelf>
      => TSelf.Pi.Mul2() - Cartesian2ToRotationAngle(y, -x); // Pass the cartesian vector (x, y) rotated 90 degrees counter-clockwise.
  }
}
#endif
