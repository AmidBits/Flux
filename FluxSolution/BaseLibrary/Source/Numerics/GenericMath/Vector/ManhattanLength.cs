...
namespace Flux
{
  ...
  {
    /// <summary>PREVIEW! Returns the Manhattan length (magnitude) for the 2D vector.</summary>
    ...
    /// <summary>PREVIEW! Returns the Manhattan length (magnitude) for the 3D vector.</summary>
