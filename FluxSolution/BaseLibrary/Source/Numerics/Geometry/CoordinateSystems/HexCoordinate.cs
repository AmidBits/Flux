...
namespace Flux
{
  ...
  public static partial class Em
  {
    ...
    public static Geometry.Coordinates.HexCoordinate<TResult> Round<TSelf, TResult>(this Geometry.Coordinates.HexCoordinate<TSelf> source, RoundingMode mode)
      where TSelf : System.Numerics.IFloatingPoint<TSelf>
  ...
  namespace Geometry.Coordinates
  {
      ...
      where TSelf : System.Numerics.INumber<TSelf>
    {
      ...
      public static Geometry.Coordinates.HexCoordinate<TSelf> Lerp(Geometry.Coordinates.HexCoordinate<TSelf> source, Geometry.Coordinates.HexCoordinate<TSelf> target, TSelf mu)
        => new(
          source.Q * (TSelf.One - mu) + target.Q * mu,
          source.R * (TSelf.One - mu) + target.R * mu,
          source.S * (TSelf.One - mu) + target.S * mu
