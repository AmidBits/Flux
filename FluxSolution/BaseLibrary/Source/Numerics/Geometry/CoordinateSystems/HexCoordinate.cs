...
namespace Flux
{
  ...
  public static partial class Em
  {
    ...
    public static Geometry.HexCoordinate<TSelf> DiagonalNeighbor<TSelf>(this Geometry.HexCoordinate<TSelf> source, int direction)
      where TSelf : System.Numerics.INumber<TSelf>
      => Geometry.HexCoordinate<TSelf>.Diagonal(direction) + source;
    ...
    public static System.Collections.Generic.IEnumerable<Geometry.HexCoordinate<TSelf>> GetNeighbors<TSelf>(this Geometry.HexCoordinate<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>
      => Geometry.HexCoordinate<TSelf>.Directions.Select(d => d + source);
    ...
    public static System.Collections.Generic.IEnumerable<Geometry.HexCoordinate<TSelf>> GetRange<TSelf>(this Geometry.HexCoordinate<TSelf> source, TSelf radius)
    ...
    public static System.Collections.Generic.IEnumerable<Geometry.HexCoordinate<TSelf>> GetRing<TSelf>(this Geometry.HexCoordinate<TSelf> source, TSelf radius, int startDirection = 0, bool isCounterClockWise = false)
      where TSelf : System.Numerics.IBinaryInteger<TSelf>
    {
      ...
      else if (radius > TSelf.Zero)
      {
        ...
        var corner = Geometry.HexCoordinate<TSelf>.Direction(startDirection) * radius + source; // Find the first corner hex, relative center in direction of choice (plus the length of the radius).
        ...
        for (var index = 0; index < 6; index++)
        {
          ...
          for (var deltaIndex = TSelf.One; deltaIndex < radius; deltaIndex++) // Enumerate the 'side of the current corner hex'.
            yield return Geometry.HexCoordinate<TSelf>.Direction(deltaDirection) * deltaIndex + corner; // Compute the direction and offset of the side.
    ...
    public static Geometry.HexCoordinate<TSelf> Lerp<TSelf>(this Geometry.HexCoordinate<TSelf> source, Geometry.HexCoordinate<TSelf> target, TSelf mu)
    ...
    public static Geometry.HexCoordinate<TSelf> Neighbor<TSelf>(this Geometry.HexCoordinate<TSelf> source, int direction)
      where TSelf : System.Numerics.INumber<TSelf>
      => source + Geometry.HexCoordinate<TSelf>.Direction(direction);
    ...
    public static Geometry.HexCoordinate<TSelf> NextCornerCw<TSelf>(this Geometry.HexCoordinate<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>
    ...
    public static Geometry.HexCoordinate<TSelf> NextCornerCcw<TSelf>(this Geometry.HexCoordinate<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>
      => new(-source.R, -source.S, -source.Q);

    public static Geometry.HexCoordinate<TResult> Round<TSelf, TResult>(this Geometry.HexCoordinate<TSelf> source, RoundingMode mode)
      where TSelf : System.Numerics.IFloatingPoint<TSelf>
    ...
    public static (double x, double y, double z) ToCartesianCoordinate3<TSelf>(this Geometry.HexCoordinate<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>
      => new(double.CreateChecked(source.Q), double.CreateChecked(source.R), double.CreateChecked(source.S));

    public static Geometry.IHexCoordinate<TResult> ToHexCoordinate<TSelf, TResult>(this Geometry.HexCoordinate<TSelf> source, out Geometry.HexCoordinate<TResult> result)
      where TSelf : System.Numerics.IBinaryInteger<TSelf>
      where TResult : System.Numerics.INumber<TResult>
    ...
    public static Geometry.IHexCoordinate<TResult> ToHexCoordinate<TSelf, TResult>(this Geometry.HexCoordinate<TSelf> source, RoundingMode mode, out Geometry.HexCoordinate<TResult> result)
      where TSelf : System.Numerics.IFloatingPoint<TSelf>
      where TResult : System.Numerics.INumber<TResult>
      => result = Round<TSelf, TResult>(source, mode);

    public static System.Collections.Generic.IEnumerable<System.Collections.Generic.IEnumerable<Geometry.HexCoordinate<TSelf>>> TraverseSpiral<TSelf>(this Geometry.HexCoordinate<TSelf> source, TSelf radius)
      where TSelf : System.Numerics.IBinaryInteger<TSelf>
    {
  ...
  namespace Geometry
  {
      ...
      where TSelf : System.Numerics.INumber<TSelf>
    {
      ...
      public static Geometry.HexCoordinate<TSelf> Lerp(Geometry.HexCoordinate<TSelf> source, Geometry.HexCoordinate<TSelf> target, TSelf mu)
        => new(
          source.Q * (TSelf.One - mu) + target.Q * mu,
          source.R * (TSelf.One - mu) + target.R * mu,
          source.S * (TSelf.One - mu) + target.S * mu
