namespace Flux
{
  public static partial class Fx
  {
    ...
    /// <returns></returns>
    public static double GetRegularPolygonAreaByApothem(this PolygonType source, double apothem) => (int)source * (apothem * apothem) * System.Math.Tan(System.Math.PI / (int)source);

    /// <summary></summary>
    /// <param name="source"></param>
    /// <param name="sideLength"></param>
    /// <returns></returns>
    public static double GetRegularPolygonAreaBySideLength(this PolygonType source, double sideLength) => (int)source * (sideLength * sideLength) * Quantities.Angle.Cot(double.Pi / (int)source) / 4;
    ...
    /// <param name="apothem"></param>
    /// <returns></returns>
    public static double GetRegularPolygonCircumradiusByApothem(this PolygonType source, double apothem) => apothem / double.Cos(double.Pi / (int)source);

    /// <summary></summary>
    /// <param name="source"></param>
    /// <param name="sideLength"></param>
    /// <returns></returns>
    public static double GetRegularPolygonCircumradiusBySideLength(this PolygonType source, double sideLength) => sideLength / (2 * double.Sin(double.Pi / (int)source));

    /// <summary></summary>
    /// <see href="https://en.wikipedia.org/wiki/Regular_polygon#Angles"/>
    /// <returns></returns>
    public static Quantities.Angle GetRegularPolygonInteriorAngle(this PolygonType source) => new(((int)source - 2) * System.Math.PI / ((int)source));
    ...
    public static int GetSchläfliSymbol(this PolygonType source) => (int)source;
  ...
  {
    #region Enumeration of polytopes
    ...
    #endregion // Enumeration of polytopes
  }
