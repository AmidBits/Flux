namespace Flux
{
  public static partial class Maths
  {
    ...
    /// <summary>Rounds <paramref name="value"/> by truncating to the specified number of <paramref name="significantDigits"/> and then round using the <paramref name="mode"/>. The reason for doing this is because unless a value is EXACTLY between two numbers, to the decimal, it will be rounded based on the next least significant decimal digit and so on.</summary>
    ...
    public static TSelf RoundToTruncatedPrecision<TSelf>(this TSelf value, RoundingMode mode, int significantDigits, int radix = 10)
      where TSelf : System.Numerics.IFloatingPointIeee754<TSelf>
    {
      ...
      return RoundToPrecision(TSelf.Truncate(value * scalar) / scalar, mode, significantDigits, radix);
    }
