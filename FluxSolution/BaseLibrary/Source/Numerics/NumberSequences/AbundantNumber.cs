namespace Flux
{
  public static partial class NumberSequence
  {
    public static System.Collections.Generic.IEnumerable<(System.Numerics.BigInteger n, System.Numerics.BigInteger sum)> GetAbundantNumbers()
      => Flux.Iteration.Custom<System.Numerics.BigInteger>(() => (System.Numerics.BigInteger)3, (e, i) => true, (e, i) => e + 1).AsParallel().AsOrdered().Select(n => (n, sum: Flux.NumberSequence.GetSumOfDivisors(n) - n)).Where(x => x.sum > x.n);
