namespace Flux
{
  ...
  {
    public static Numerics.AxisAngle ToAxisAngle(this Numerics.EulerAngles source)
    {
    ...
    public static Numerics.Matrix4 ToMatrixTaitBryanXYZ(this Numerics.EulerAngles source)
    {
    ...
    public static Numerics.Matrix4 ToMatrixLhTaitBryanYXZ(this Numerics.EulerAngles source)
    {
      var (s1, c1) = System.Math.SinCos(source.Yaw);
      var (s2, c2) = System.Math.SinCos(source.Pitch);
      var (s3, c3) = System.Math.SinCos(source.Roll);
    ...
    public static Numerics.Matrix4 ToMatrixLhTaitBryanZYX(this Numerics.EulerAngles source)
    {
    ...
    public static Numerics.Matrix4 ToMatrixLhProperEulerZXZ(this Numerics.EulerAngles source)
    {
      var (s1, c1) = System.Math.SinCos(source.Yaw);
      var (s2, c2) = System.Math.SinCos(source.Pitch);
      var (s3, c3) = System.Math.SinCos(source.Roll);
    ...
    public static (Units.Angle yaw, Units.Angle pitch, Units.Angle roll) ToQuantities(this Numerics.EulerAngles source)
      => (
    ...
    public static Numerics.Quaternion ToQuaternion(this Numerics.EulerAngles source)
    {
