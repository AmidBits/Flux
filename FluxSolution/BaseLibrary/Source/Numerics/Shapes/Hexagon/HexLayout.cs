...
namespace Flux.Geometry
{
  ...
  public readonly record struct HexLayout
  {
    ...
    public void HexToPixel(Flux.Coordinates.HexCoordinate<int> h, out double x, out double y)
    {
    ...
    public Flux.Coordinates.HexCoordinate<double> PixelToHex(double x, double y)
    {
    ...
    public System.Collections.Generic.List<(double x, double y)> PolygonCorners(Flux.Coordinates.HexCoordinate<int> h)
    {
