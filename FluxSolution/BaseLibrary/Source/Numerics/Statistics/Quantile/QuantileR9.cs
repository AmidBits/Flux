namespace Flux.Statistics
{
    ...
    : IQuantileEstimatable
  {
    ...
    public TPercent EstimateQuantileRank<TCount, TPercent>(TCount count, TPercent p)
      ...
      => (TPercent.CreateChecked(count) + TPercent.CreateChecked(OneFourth)) * Quantities.UnitInterval.AssertMember(p, IntervalNotation.Closed, nameof(p)) + TPercent.CreateChecked(ThreeEights);
