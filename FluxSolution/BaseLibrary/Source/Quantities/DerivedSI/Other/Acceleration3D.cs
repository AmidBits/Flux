namespace Flux
{
  namespace Quantities
  {
    ...
    : IUnitQuantifiable<Numerics.CartesianCoordinate3<double>, AccelerationUnit>
    {
      ...
      // IUnitQuantifiable<>
      public string ToUnitString(AccelerationUnit unit = Acceleration.DefaultUnit, string? format = null, bool preferUnicode = false, bool useFullName = false) => $"{Value} {unit.GetUnitString(preferUnicode, useFullName)}";
