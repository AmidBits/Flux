namespace Flux
{
  ...
  {
    public static string GetUnitString(this DynamicViscosityUnit unit, bool preferUnicode, bool useFullName = false)
  ...
  public readonly struct DynamicViscosity
    : System.IComparable, System.IComparable<DynamicViscosity>, System.IConvertible, System.IEquatable<DynamicViscosity>, System.IFormattable, IUnitQuantifiable<double, DynamicViscosityUnit>
  {
    ...
    [System.Diagnostics.Contracts.Pure] public static explicit operator double(DynamicViscosity v) => v.m_value;
    [System.Diagnostics.Contracts.Pure] public static explicit operator DynamicViscosity(double v) => new(v);

    [System.Diagnostics.Contracts.Pure] public static bool operator <(DynamicViscosity a, DynamicViscosity b) => a.CompareTo(b) < 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator <=(DynamicViscosity a, DynamicViscosity b) => a.CompareTo(b) <= 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator >(DynamicViscosity a, DynamicViscosity b) => a.CompareTo(b) > 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator >=(DynamicViscosity a, DynamicViscosity b) => a.CompareTo(b) >= 0;

    [System.Diagnostics.Contracts.Pure] public static bool operator ==(DynamicViscosity a, DynamicViscosity b) => a.Equals(b);
    [System.Diagnostics.Contracts.Pure] public static bool operator !=(DynamicViscosity a, DynamicViscosity b) => !a.Equals(b);

    [System.Diagnostics.Contracts.Pure] public static DynamicViscosity operator -(DynamicViscosity v) => new(-v.m_value);
    [System.Diagnostics.Contracts.Pure] public static DynamicViscosity operator +(DynamicViscosity a, double b) => new(a.m_value + b);
    [System.Diagnostics.Contracts.Pure] public static DynamicViscosity operator +(DynamicViscosity a, DynamicViscosity b) => a + b.m_value;
    [System.Diagnostics.Contracts.Pure] public static DynamicViscosity operator /(DynamicViscosity a, double b) => new(a.m_value / b);
    [System.Diagnostics.Contracts.Pure] public static DynamicViscosity operator /(DynamicViscosity a, DynamicViscosity b) => a / b.m_value;
    [System.Diagnostics.Contracts.Pure] public static DynamicViscosity operator *(DynamicViscosity a, double b) => new(a.m_value * b);
    [System.Diagnostics.Contracts.Pure] public static DynamicViscosity operator *(DynamicViscosity a, DynamicViscosity b) => a * b.m_value;
    ...
    // IComparable<>
    [System.Diagnostics.Contracts.Pure] public int CompareTo(DynamicViscosity other) => m_value.CompareTo(other.m_value);
    // IComparable
    [System.Diagnostics.Contracts.Pure] public int CompareTo(object? other) => other is not null && other is DynamicViscosity o ? CompareTo(o) : -1;
    ...
    // IEquatable<>
    [System.Diagnostics.Contracts.Pure] public bool Equals(DynamicViscosity other) => m_value == other.m_value;
    ...
    // IUnitQuantifiable<>
    [System.Diagnostics.Contracts.Pure]
    public string ToUnitString(DynamicViscosityUnit unit = DefaultUnit, string? format = null, bool preferUnicode = false, bool useFullName = false)
    ...
    [System.Diagnostics.Contracts.Pure] public override bool Equals(object? obj) => obj is DynamicViscosity o && Equals(o);
