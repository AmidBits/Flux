namespace Flux
{
  namespace Quantities
  {
    ...
    : IUnitQuantifiable<CoordinateSystems.CartesianCoordinate2<double>, MagneticFluxDensityUnit>
    {
      private readonly CoordinateSystems.CartesianCoordinate2<double> m_value;

      public MagneticFluxDensity2D(CoordinateSystems.CartesianCoordinate2<double> value, MagneticFluxDensityUnit unit = MagneticFluxDensity.DefaultUnit)
        => m_value = unit switch
        {
      ...
      // IQuantifiable<>
       public CoordinateSystems.CartesianCoordinate2<double> Value { get => m_value; init => m_value = value; }
      // IUnitQuantifiable<>
      ...
      public CoordinateSystems.CartesianCoordinate2<double> ToUnitValue(MagneticFluxDensityUnit unit = MagneticFluxDensity.DefaultUnit)
        => unit switch
        {
