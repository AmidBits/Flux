namespace Flux
{
  public static partial class Fx
  {
    ...
    public static Quantities.Azimuth GetAzimuth(this Quantities.CompassInterCardinalDirection source) => new(45 + 90 * (int)source);

    public static System.Collections.Generic.List<string> ToWords(this Quantities.CompassInterCardinalDirection source) => ((Quantities.CompassRose32Wind)source).ToWords();
  }
