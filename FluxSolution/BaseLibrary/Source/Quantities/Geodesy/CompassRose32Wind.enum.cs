namespace Flux
{
  public static partial class Fx
  {
    ...
    public static Quantities.Azimuth GetAzimuth(this Quantities.CompassRose32Wind source) => new(11.25 * (int)source);

    public static System.Collections.Generic.List<string> ToWords(this Quantities.CompassRose32Wind source, UnicodeSpacing spacing = UnicodeSpacing.Space)
    {
      var list = new System.Collections.Generic.List<string>();

      var s = source.ToString();

      var words = System.Enum.GetNames<Quantities.WordsOfTheCompass>();
