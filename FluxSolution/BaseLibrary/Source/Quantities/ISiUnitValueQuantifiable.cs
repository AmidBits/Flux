namespace Flux
{
  ...
  public static partial class Em
  {
    ...
    public static System.Collections.Generic.Dictionary<(MetricPrefix, TUnit), string> ToStringsOfSiPrefixes<TValue, TUnit>(this ISiUnitValueQuantifiable<TValue, TUnit> source, bool preferUnicode = false, UnicodeSpacing unitSpacing = UnicodeSpacing.Space, bool useFullName = false)
    ...
    where TUnit : System.Enum
  {
    ...
    /// <returns></returns>
    abstract static string GetSiUnitName(MetricPrefix prefix, bool preferPlural);
    ...
    /// <returns></returns>
    abstract static string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode);
