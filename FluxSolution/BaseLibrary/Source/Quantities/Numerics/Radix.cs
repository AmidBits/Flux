namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Radix>, System.IFormattable, IValueQuantifiable<int>
  {
    ...
    {
      var gray = new TSelf[int.CreateChecked(value.DigitCount(radix))];
    ...
    //  where TSelf : System.Numerics.IBinaryInteger<TSelf>
    //  => number / AssertMember(radix).IntegerPow(count);
    ...
    //  where TSelf : System.Numerics.IBinaryInteger<TSelf>
    //  => value % AssertMember(radix).IntegerPow(count);
    ...
    //  var logRadix = TSelf.CreateChecked(value.IntegerLogTowardZero(radix));
    //  var maxDistinct = (TSelf.CreateChecked(9) * logRadix) + (value / radix.IntegerPow(logRadix));
