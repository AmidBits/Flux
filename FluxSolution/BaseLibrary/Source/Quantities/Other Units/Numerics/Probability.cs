namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Probability>, System.IFormattable, IValueQuantifiable<double>
  {
    ...
    /// </summary>
    /// <exception cref="System.ArgumentOutOfRangeException"></exception>
    public static bool IsMember<TSelf>(TSelf probability)
      where TSelf : System.Numerics.IFloatingPoint<TSelf>
      => IntervalNotation.Closed.IsMember(probability, TSelf.CreateChecked(MinValue), TSelf.CreateChecked(MaxValue));
