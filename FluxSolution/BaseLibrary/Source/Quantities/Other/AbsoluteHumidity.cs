namespace Flux
{
  ...
  {
    public static string GetUnitString(this AbsoluteHumidityUnit unit, bool preferUnicode, bool useFullName = false)
      => unit switch
      {
    ...
    : System.IComparable, System.IComparable<AbsoluteHumidity>, System.IConvertible, System.IEquatable<AbsoluteHumidity>, System.IFormattable, IUnitQuantifiable<double, AbsoluteHumidityUnit>
  {
    ...
    [System.Diagnostics.Contracts.Pure] public static explicit operator double(AbsoluteHumidity v) => v.m_value;
    [System.Diagnostics.Contracts.Pure] public static explicit operator AbsoluteHumidity(double v) => new(v);

    [System.Diagnostics.Contracts.Pure] public static bool operator <(AbsoluteHumidity a, AbsoluteHumidity b) => a.CompareTo(b) < 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator <=(AbsoluteHumidity a, AbsoluteHumidity b) => a.CompareTo(b) <= 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator >(AbsoluteHumidity a, AbsoluteHumidity b) => a.CompareTo(b) > 0;
    [System.Diagnostics.Contracts.Pure] public static bool operator >=(AbsoluteHumidity a, AbsoluteHumidity b) => a.CompareTo(b) >= 0;

    [System.Diagnostics.Contracts.Pure] public static bool operator ==(AbsoluteHumidity a, AbsoluteHumidity b) => a.Equals(b);
    [System.Diagnostics.Contracts.Pure] public static bool operator !=(AbsoluteHumidity a, AbsoluteHumidity b) => !a.Equals(b);

    [System.Diagnostics.Contracts.Pure] public static AbsoluteHumidity operator -(AbsoluteHumidity v) => new(-v.m_value);
    [System.Diagnostics.Contracts.Pure] public static AbsoluteHumidity operator +(AbsoluteHumidity a, double b) => new(a.m_value + b);
    [System.Diagnostics.Contracts.Pure] public static AbsoluteHumidity operator +(AbsoluteHumidity a, AbsoluteHumidity b) => a + b.m_value;
    [System.Diagnostics.Contracts.Pure] public static AbsoluteHumidity operator /(AbsoluteHumidity a, double b) => new(a.m_value / b);
    [System.Diagnostics.Contracts.Pure] public static AbsoluteHumidity operator /(AbsoluteHumidity a, AbsoluteHumidity b) => a / b.m_value;
    [System.Diagnostics.Contracts.Pure] public static AbsoluteHumidity operator *(AbsoluteHumidity a, double b) => new(a.m_value * b);
    [System.Diagnostics.Contracts.Pure] public static AbsoluteHumidity operator *(AbsoluteHumidity a, AbsoluteHumidity b) => a * b.m_value;
    ...
    public string ToUnitString(AbsoluteHumidityUnit unit = DefaultUnit, string? format = null, bool preferUnicode = false, bool useFullName = false)
    ...
    [System.Diagnostics.Contracts.Pure] public override bool Equals(object? obj) => obj is AbsoluteHumidity o && Equals(o);
