namespace Flux
{
  ...
  {
    public static string GetUnitString(this PowerRatioUnit unit, bool preferUnicode, bool useFullName = false)
      => unit switch
      {
    ...
    : System.IComparable, System.IComparable<PowerRatio>, System.IConvertible, System.IEquatable<PowerRatio>, System.IFormattable, IUnitQuantifiable<double, PowerRatioUnit>
  {
    ...
    // IUnitQuantifiable<>
    [System.Diagnostics.Contracts.Pure]
    public string ToUnitString(PowerRatioUnit unit = DefaultUnit, string? format = null, bool preferUnicode = false, bool useFullName = false)
