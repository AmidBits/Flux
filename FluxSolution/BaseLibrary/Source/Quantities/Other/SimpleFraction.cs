...
//     public static explicit operator double(SimpleFraction v) => v.Value;
...
//    // IComparable
//     public int CompareTo(object? other) => other is SimpleFraction o ? CompareTo(o) : -1;
...
//    // IEquatable<>
//     public bool Equals(SimpleFraction other) => m_numerator == other.m_numerator && m_denominator == other.m_denominator;
