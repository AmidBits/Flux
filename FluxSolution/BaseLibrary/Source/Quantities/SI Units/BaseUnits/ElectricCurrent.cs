namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<ElectricCurrent>, System.IFormattable, ISiUnitValueQuantifiable<double, ElectricCurrentUnit>
  {
    ...
    public static string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(ElectricCurrentUnit.Ampere, preferPlural);

    public static string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(ElectricCurrentUnit.Ampere, preferUnicode);
    ...
    private static double ConvertToUnit(ElectricCurrentUnit unit, double value)
      => unit switch
      {
        ElectricCurrentUnit.Ampere => value,
    ...
    public static string GetUnitName(ElectricCurrentUnit unit, bool preferPlural) => unit.ToString().ConvertUnitNameToPlural(preferPlural);
