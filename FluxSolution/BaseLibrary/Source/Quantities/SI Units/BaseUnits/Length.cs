namespace Flux
{
  ...
  {
    public static string GetUnitString(this Quantities.LengthUnit unit, bool preferUnicode = false, bool useFullName = false)
  ...
  namespace Quantities
  {
      ...
      : System.IComparable, System.IComparable<Length>, System.IFormattable, ISiPrefixValueQuantifiable<double, LengthUnit>
    {
      ...
      // IUnitQuantifiable<>
      public string GetUnitSymbol(LengthUnit unit, bool preferUnicode, bool useFullName) => unit.GetUnitString(preferUnicode, useFullName);
      ...
      public string ToUnitValueString(LengthUnit unit = LengthUnit.Metre, string? format = null, System.IFormatProvider? formatProvider = null, UnicodeSpacing unitSpacing = UnicodeSpacing.Space, bool preferUnicode = false, bool useFullName = false)
      {
        var sb = new System.Text.StringBuilder();
