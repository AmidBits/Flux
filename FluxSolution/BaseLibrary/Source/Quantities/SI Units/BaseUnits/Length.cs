namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Length>, System.IFormattable, ISiUnitValueQuantifiable<double, LengthUnit>
  {
    ...
    public string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(LengthUnit.Meter, preferPlural);

    public string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(LengthUnit.Meter, preferUnicode);
