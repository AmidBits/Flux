namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Length>, System.IFormattable, ISiUnitValueQuantifiable<double, LengthUnit>
  {
    ...
    public static string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(LengthUnit.Meter, preferPlural);

    public static string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(LengthUnit.Meter, preferUnicode);
    ...
    public static string GetUnitName(LengthUnit unit, bool preferPlural) => unit.ToString().ConvertUnitNameToPlural(preferPlural);
