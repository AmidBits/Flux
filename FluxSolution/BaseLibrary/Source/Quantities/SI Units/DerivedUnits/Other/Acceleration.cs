namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Acceleration>, System.IFormattable, ISiUnitValueQuantifiable<double, AccelerationUnit>
  {
    ...
    public static string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(AccelerationUnit.MeterPerSecondSquared, preferPlural);

    public static string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(AccelerationUnit.MeterPerSecondSquared, preferUnicode);
