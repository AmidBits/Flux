namespace Flux
{
  ...
  {
    public static string GetUnitString(this Quantities.AngularFrequencyUnit unit, bool preferUnicode = false, bool useFullName = false)
  ...
  namespace Quantities
  {
      ...
      : System.IComparable, System.IComparable<AngularFrequency>, System.IFormattable, IUnitValueQuantifiable<double, AngularFrequencyUnit>
    {
      ...
      public string ToString(string? format, System.IFormatProvider? formatProvider)
        => ToUnitValueString(AngularFrequencyUnit.RadianPerSecond, format, formatProvider);
      ...
      // IUnitQuantifiable<>
      public string GetUnitSymbol(AngularFrequencyUnit unit, bool preferUnicode, bool useFullName) => unit.GetUnitString(preferUnicode, useFullName);
      ...
      public string ToUnitValueString(AngularFrequencyUnit unit = AngularFrequencyUnit.RadianPerSecond, string? format = null, System.IFormatProvider? formatProvider = null, UnicodeSpacing unitSpacing = UnicodeSpacing.Space, bool preferUnicode = false, bool useFullName = false)
      {
