namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<CurrentDensity>, System.IFormattable, ISiUnitValueQuantifiable<double, CurrentDensityUnit>
  {
    ...
    public static string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(CurrentDensityUnit.AmperePerSquareMeter, preferPlural);

    public static string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(CurrentDensityUnit.AmperePerSquareMeter, preferUnicode);
    ...
    public static string GetUnitName(CurrentDensityUnit unit, bool preferPlural)
