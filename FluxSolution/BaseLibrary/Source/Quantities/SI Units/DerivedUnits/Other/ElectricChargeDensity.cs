namespace Flux.Quantities
{
  ...
  {
    /// <summary>This is the default unit for <see cref="ElectricChargeDensity"/>.</summary>
    ...
    : System.IComparable, System.IComparable<ElectricChargeDensity>, System.IFormattable, ISiUnitValueQuantifiable<double, ElectricChargeDensityUnit>
  {
    ...
    public string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(ElectricChargeDensityUnit.CoulombPerCubicMeter, preferPlural);

    public string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(ElectricChargeDensityUnit.CoulombPerCubicMeter, preferUnicode);
    ...
    private static double ConvertFromUnit(ElectricChargeDensityUnit unit, double value)
      => unit switch
      {
    ...
    private static double ConvertToUnit(ElectricChargeDensityUnit unit, double value)
      => unit switch
      {
        ElectricChargeDensityUnit.CoulombPerCubicMeter => value,
    ...
    public string GetUnitName(ElectricChargeDensityUnit unit, bool preferPlural)
      => unit.ToString().ConvertUnitNameToPlural(preferPlural && GetUnitValue(unit).IsConsideredPlural());

    public string GetUnitSymbol(ElectricChargeDensityUnit unit, bool preferUnicode)
      => unit switch
      {
