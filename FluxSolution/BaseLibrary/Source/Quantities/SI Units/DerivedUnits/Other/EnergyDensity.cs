namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<EnergyDensity>, System.IFormattable, ISiUnitValueQuantifiable<double, EnergyDensityUnit>
  {
    ...
    public static EnergyDensity operator +(EnergyDensity a, EnergyDensity b) => a + b.m_value;
    public static EnergyDensity operator /(EnergyDensity a, double b) => new(a.m_value / b);
    public static EnergyDensity operator /(EnergyDensity a, EnergyDensity b) => a / b.m_value;
    public static EnergyDensity operator *(EnergyDensity a, double b) => new(a.m_value * b);
    public static EnergyDensity operator *(EnergyDensity a, EnergyDensity b) => a * b.m_value;
    ...
    public string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(EnergyDensityUnit.JoulePerCubicMeter, preferPlural);

    public string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(EnergyDensityUnit.JoulePerCubicMeter, preferUnicode);
    ...
    private static double ConvertFromUnit(EnergyDensityUnit unit, double value)
      => unit switch
      {
    ...
    private static double ConvertToUnit(EnergyDensityUnit unit, double value)
      => unit switch
      {
        EnergyDensityUnit.JoulePerCubicMeter => value,
    ...
    public string GetUnitName(EnergyDensityUnit unit, bool preferPlural)
      => unit.ToString().ConvertUnitNameToPlural(preferPlural && GetUnitValue(unit).IsConsideredPlural());

    public string GetUnitSymbol(EnergyDensityUnit unit, bool preferUnicode)
      => unit switch
      {
