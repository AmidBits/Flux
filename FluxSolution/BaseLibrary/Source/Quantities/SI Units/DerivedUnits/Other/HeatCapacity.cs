namespace Flux
{
  ...
  {
    public static string GetUnitString(this Quantities.HeatCapacityUnit unit, bool useFullName = false)
  ...
  namespace Quantities
  {
      ...
      : System.IComparable, System.IComparable<HeatCapacity>, System.IFormattable, IUnitValueQuantifiable<double, HeatCapacityUnit>
    {
      ...
      // IUnitQuantifiable<>
      public string GetUnitSymbol(HeatCapacityUnit unit, bool preferUnicode, bool useFullName) => unit.GetUnitString(useFullName);
      ...
      public string ToUnitValueString(HeatCapacityUnit unit = HeatCapacityUnit.JoulePerKelvin, string? format = null, System.IFormatProvider? formatProvider = null, UnicodeSpacing unitSpacing = UnicodeSpacing.Space, bool preferUnicode = false, bool useFullName = false)
      {
