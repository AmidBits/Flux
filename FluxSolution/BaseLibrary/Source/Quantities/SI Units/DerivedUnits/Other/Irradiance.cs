namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Irradiance>, System.IFormattable, ISiUnitValueQuantifiable<double, IrradianceUnit>
  {
    ...
    public static string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(IrradianceUnit.WattPerSquareMeter, preferPlural);

    public static string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(IrradianceUnit.WattPerSquareMeter, preferUnicode);
    ...
    public static string GetUnitName(IrradianceUnit unit, bool preferPlural) => unit.ToString().ConvertUnitNameToPlural(preferPlural);
