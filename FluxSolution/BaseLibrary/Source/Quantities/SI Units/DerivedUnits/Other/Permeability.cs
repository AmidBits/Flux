namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Permeability>, System.IFormattable, ISiUnitValueQuantifiable<double, PermeabilityUnit>
  {
    ...
    public static string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(PermeabilityUnit.HenryPerMeter, preferPlural);

    public static string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(PermeabilityUnit.HenryPerMeter, preferUnicode);
    ...
    public static string GetUnitName(PermeabilityUnit unit, bool preferPlural) => unit.ToString().ConvertUnitNameToPlural(preferPlural);
