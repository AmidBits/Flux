namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Speed>, System.IFormattable, ISiUnitValueQuantifiable<double, SpeedUnit>
  {
    ...
    public static string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(SpeedUnit.MeterPerSecond, preferPlural);

    public static string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(SpeedUnit.MeterPerSecond, preferUnicode);
    ...
    public static double GetUnitFactor(SpeedUnit unit)
      => unit switch
      {
        ...
        SpeedUnit.Mach => SpeedOfSound,
        SpeedUnit.MilePerHour => (1397.0 / 3125.0),

        _ => throw new System.NotImplementedException()
      };

    public static string GetUnitName(SpeedUnit unit, bool preferPlural) => unit.ToString().ConvertUnitNameToPlural(preferPlural);

    public static string GetUnitSymbol(SpeedUnit unit, bool preferUnicode)
      => unit switch
      {
    ...
    public string ToUnitString(SpeedUnit unit = SpeedUnit.MeterPerSecond, string? format = null, System.IFormatProvider? formatProvider = null, bool fullName = false)
    {
      ...
      {
        sb.Append(fullName ? GetUnitName(unit, GetUnitValue(unit).IsConsideredPlural()) : GetUnitSymbol(unit, false));
