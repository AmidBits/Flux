namespace Flux.Quantities
{
  ...
  public readonly record struct Activity
    : System.IComparable, System.IComparable<Activity>, System.IFormattable, ISiUnitValueQuantifiable<double, ActivityUnit>
  {
    ...
    public string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(ActivityUnit.Becquerel, preferPlural);

    public string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(ActivityUnit.Becquerel, preferUnicode);
