namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Capacitance>, System.IFormattable, ISiUnitValueQuantifiable<double, CapacitanceUnit>
  {
    ...
    public static string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(CapacitanceUnit.Farad, preferPlural);

    public static string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(CapacitanceUnit.Farad, preferUnicode);
    ...
    public static string GetUnitName(CapacitanceUnit unit, bool preferPlural) => unit.ToString().ConvertUnitNameToPlural(preferPlural);
