namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Capacitance>, System.IFormattable, ISiPrefixValueQuantifiable<double, CapacitanceUnit>
  {
    ...
    // IFormattable
    public string ToString(string? format, System.IFormatProvider? formatProvider) => ToUnitValueSymbolString(CapacitanceUnit.Farad, format, formatProvider);

    // ISiUnitValueQuantifiable<>
    public string GetSiPrefixName(MetricPrefix prefix, bool preferPlural) => prefix.GetUnitName() + GetUnitName(CapacitanceUnit.Farad, preferPlural);

    public string GetSiPrefixSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetUnitSymbol(preferUnicode) + GetUnitSymbol(CapacitanceUnit.Farad, preferUnicode);
    ...
    // IUnitQuantifiable<>
    public string GetUnitName(CapacitanceUnit unit, bool preferPlural) => unit.ToString() is var us && preferPlural ? us + GetUnitValue(unit).PluralStringSuffix() : us;
