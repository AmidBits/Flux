namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<CatalyticActivity>, System.IFormattable, ISiPrefixValueQuantifiable<double, CatalyticActivityUnit>
  {
    ...
    // IFormattable
    public string ToString(string? format, System.IFormatProvider? formatProvider) => ToUnitValueSymbolString(CatalyticActivityUnit.Katal, format, formatProvider);

    // ISiUnitValueQuantifiable<>
    public string GetSiPrefixName(MetricPrefix prefix, bool preferPlural) => prefix.GetUnitName() + GetUnitName(CatalyticActivityUnit.Katal, preferPlural);

    public string GetSiPrefixSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetUnitSymbol(preferUnicode) + GetUnitSymbol(CatalyticActivityUnit.Katal, preferUnicode);
    ...
    // IUnitQuantifiable<>
    public string GetUnitName(CatalyticActivityUnit unit, bool preferPlural) => unit.ToString() is var us && preferPlural ? us + GetUnitValue(unit).PluralStringSuffix() : us;
