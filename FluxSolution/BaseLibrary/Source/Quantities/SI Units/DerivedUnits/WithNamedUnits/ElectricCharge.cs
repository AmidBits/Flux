namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<ElectricCharge>, System.IFormattable, ISiPrefixValueQuantifiable<double, ElectricChargeUnit>
  {
    ...
    public string GetSiPrefixName(MetricPrefix prefix, bool preferPlural) => prefix.GetUnitName() + GetUnitName(ElectricChargeUnit.Coulomb, preferPlural);

    public string GetSiPrefixSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetUnitSymbol(preferUnicode) + GetUnitSymbol(ElectricChargeUnit.Coulomb, preferUnicode);
