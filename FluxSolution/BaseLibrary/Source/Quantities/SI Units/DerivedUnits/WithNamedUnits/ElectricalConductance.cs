namespace Flux
{
  ...
  namespace Quantities
  {
      ...
      : System.IComparable, System.IComparable<ElectricalConductance>, System.IFormattable, IUnitValueQuantifiable<double, ElectricalConductanceUnit>
    {
      ...
      // IUnitQuantifiable<>
      public string GetUnitSymbol(ElectricalConductanceUnit unit, bool preferUnicode, bool useFullName) => unit.GetUnitString(preferUnicode, useFullName);
      ...
      public string ToUnitValueString(ElectricalConductanceUnit unit = ElectricalConductanceUnit.Siemens, string? format = null, System.IFormatProvider? formatProvider = null, UnicodeSpacing unitSpacing = UnicodeSpacing.Space, bool preferUnicode = false, bool useFullName = false)
      {
