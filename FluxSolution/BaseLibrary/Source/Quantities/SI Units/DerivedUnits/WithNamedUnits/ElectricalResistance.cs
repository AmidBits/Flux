namespace Flux
{
  ...
  {
    public static string GetUnitString(this Quantities.ElectricalResistanceUnit unit, bool preferUnicode, bool useFullName = false)
  ...
  namespace Quantities
  {
      ...
      : System.IComparable, System.IComparable<ElectricalResistance>, System.IFormattable, ISiPrefixValueQuantifiable<double, ElectricalResistanceUnit>
    {
      ...
      // IUnitQuantifiable<>
      public string GetUnitSymbol(ElectricalResistanceUnit unit, bool preferUnicode, bool useFullName) => unit.GetUnitString(preferUnicode, useFullName);
      ...
      public string ToUnitValueString(ElectricalResistanceUnit unit = ElectricalResistanceUnit.Ohm, string? format = null, System.IFormatProvider? formatProvider = null, UnicodeSpacing unitSpacing = UnicodeSpacing.Space, bool preferUnicode = false, bool useFullName = false)
      {
        var sb = new System.Text.StringBuilder();
