namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Energy>, System.IFormattable, ISiUnitValueQuantifiable<double, EnergyUnit>
  {
    ...
    public static string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(EnergyUnit.Joule, preferPlural);

    public static string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(EnergyUnit.Joule, preferUnicode);
    ...
    public static string GetUnitName(EnergyUnit unit, bool preferPlural) => unit.ToString().ConvertUnitNameToPlural(preferPlural);
