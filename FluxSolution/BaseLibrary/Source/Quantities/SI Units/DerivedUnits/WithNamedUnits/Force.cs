namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Force>, System.IFormattable, ISiPrefixValueQuantifiable<double, ForceUnit>
  {
    ...
    // IFormattable
    public string ToString(string? format, System.IFormatProvider? formatProvider) => ToUnitValueSymbolString(ForceUnit.Newton, format, formatProvider);

    // ISiUnitValueQuantifiable<>
    public string GetSiPrefixName(MetricPrefix prefix, bool preferPlural) => prefix.GetUnitName() + GetUnitName(ForceUnit.Newton, preferPlural);

    public string GetSiPrefixSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetUnitSymbol(preferUnicode) + GetUnitSymbol(ForceUnit.Newton, preferUnicode);
