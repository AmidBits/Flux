namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Illuminance>, System.IFormattable, ISiUnitValueQuantifiable<double, IlluminanceUnit>
  {
    ...
    public static string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(IlluminanceUnit.Lux, preferPlural);

    public static string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(IlluminanceUnit.Lux, preferUnicode);
    ...
    public static string GetUnitName(IlluminanceUnit unit, bool preferPlural) => unit.ToString().ConvertUnitNameToPlural(preferPlural);
