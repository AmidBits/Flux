namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Inductance>, System.IFormattable, ISiUnitValueQuantifiable<double, InductanceUnit>
  {
    ...
    public string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(InductanceUnit.Henry, preferPlural);

    public string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(InductanceUnit.Henry, preferUnicode);
