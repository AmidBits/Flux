namespace Flux
{
  ...
  {
    public static string GetUnitString(this Quantities.InductanceUnit unit, bool useFullName = false)
  ...
  namespace Quantities
  {
      ...
      : System.IComparable, System.IComparable<Inductance>, System.IFormattable, IUnitValueQuantifiable<double, InductanceUnit>
    {
      ...
      // IUnitQuantifiable<>
      public string GetUnitSymbol(InductanceUnit unit, bool preferUnicode, bool useFullName) => unit.GetUnitString(useFullName);
