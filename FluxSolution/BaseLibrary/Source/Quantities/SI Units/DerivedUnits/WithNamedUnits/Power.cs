namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Power>, System.IFormattable, ISiPrefixValueQuantifiable<double, PowerUnit>
  {
    ...
    // IFormattable
    public string ToString(string? format, System.IFormatProvider? formatProvider) => ToUnitValueSymbolString(PowerUnit.Watt, format, formatProvider);

    // ISiUnitValueQuantifiable<>
    public string GetSiPrefixName(MetricPrefix prefix, bool preferPlural) => prefix.GetUnitName() + GetUnitName(PowerUnit.Watt, preferPlural);

    public string GetSiPrefixSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetUnitSymbol(preferUnicode) + GetUnitSymbol(PowerUnit.Watt, preferUnicode);
