namespace Flux
{
  ...
  {
    public static string GetUnitString(this Quantities.RadiationExposureUnit unit, bool useFullName = false)
  ...
  namespace Quantities
  {
      ...
      : System.IComparable, System.IComparable<RadiationExposure>, System.IFormattable, IUnitValueQuantifiable<double, RadiationExposureUnit>
    {
      ...
      // IUnitQuantifiable<>
      public string GetUnitSymbol(RadiationExposureUnit unit, bool preferUnicode, bool useFullName) => unit.GetUnitString(useFullName);
