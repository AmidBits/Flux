namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Radioactivity>, System.IFormattable, ISiUnitValueQuantifiable<double, RadioactivityUnit>
  {
    ...
    public static string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(RadioactivityUnit.Becquerel, preferPlural);

    public static string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(RadioactivityUnit.Becquerel, preferUnicode);
    ...
    public static string GetUnitName(RadioactivityUnit unit, bool preferPlural) => unit.ToString().ConvertUnitNameToPlural(preferPlural);
