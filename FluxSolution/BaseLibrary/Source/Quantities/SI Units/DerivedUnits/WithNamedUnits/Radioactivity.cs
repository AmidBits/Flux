namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<Radioactivity>, System.IFormattable, ISiUnitValueQuantifiable<double, RadioactivityUnit>
  {
    ...
    public static Radioactivity operator +(Radioactivity a, Radioactivity b) => a + b.m_value;
    public static Radioactivity operator /(Radioactivity a, double b) => new(a.m_value / b);
    public static Radioactivity operator /(Radioactivity a, Radioactivity b) => a / b.m_value;
    public static Radioactivity operator *(Radioactivity a, double b) => new(a.m_value * b);
    public static Radioactivity operator *(Radioactivity a, Radioactivity b) => a * b.m_value;
    ...
    public string GetSiUnitName(MetricPrefix prefix, bool preferPlural) => prefix.GetPrefixName() + GetUnitName(RadioactivityUnit.Becquerel, preferPlural);

    public string GetSiUnitSymbol(MetricPrefix prefix, bool preferUnicode) => prefix.GetPrefixSymbol(preferUnicode) + GetUnitSymbol(RadioactivityUnit.Becquerel, preferUnicode);
    ...
    private static double ConvertFromUnit(RadioactivityUnit unit, double value)
      => unit switch
      {
    ...
    private static double ConvertToUnit(RadioactivityUnit unit, double value)
      => unit switch
      {
        RadioactivityUnit.Becquerel => value,
    ...
    public string GetUnitName(RadioactivityUnit unit, bool preferPlural) => unit.ToString().ConvertUnitNameToPlural(preferPlural && GetUnitValue(unit).IsConsideredPlural());
