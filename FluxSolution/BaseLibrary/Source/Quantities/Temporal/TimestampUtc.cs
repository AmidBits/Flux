...
//    public static Quantities.TimestampUtc ToTimestampUtc(this Quantities.MomentUtc source)
...
//        m_nanosecond = nanosecond >= 0 && nanosecond <= 999999999 ? nanosecond : throw new System.ArgumentOutOfRangeException(nameof(nanosecond));
//      }
//      public TimestampUtc(int year, int month, int day, int hour, int minute, int second) : this(year, month, day, hour, minute, second, 0) { }
//      public TimestampUtc(int year, int month, int day, int hour, int minute) : this(year, month, day, hour, minute, 0, 0) { }
...
//      {
//        var ssu = ConvertNanosecondToSubSecondUnits(m_nanosecond);

//        return new System.DateTime(m_year, m_month, m_day, m_hour, m_minute, m_second, ssu.milliSecond, ssu.microSecond);
//      }

//      /// <summary>Creates a new <see cref="JulianDate"/> from this instance. Uses the specified conversion calendar.</summary>
//      public JulianDate ToJulianDate(TemporalCalendar calendar)
//      {
//        var ssu = ConvertNanosecondToSubSecondUnits(m_nanosecond);

//        return new JulianDate(m_year, m_month, m_day, m_hour, m_minute, m_second, ssu.milliSecond, ssu.microSecond, ssu.nanoSecond, calendar);
//      }
...
//      /// <summary>Creates a new <see cref="JulianDate"/> from this instance. Uses the specified conversion calendar.</summary>
//      public MomentUtc ToMomentUtc()
//      {
//        var ssu = ConvertNanosecondToSubSecondUnits(m_nanosecond);

//        return new MomentUtc(m_year, m_month, m_day, m_hour, m_minute, m_second, ssu.milliSecond);
//      }
...
//        return new System.TimeOnly(m_hour, m_minute, m_second, ssu.milliSecond, ssu.microSecond);
//      }
...
//        return new System.TimeSpan(m_day, m_hour, m_minute, m_second, ssu.milliSecond, ssu.microSecond);
//      }

//      #region Static methods

//      /// <summary>
//      /// <para>Converts a nano-second value into sub-second integer components, plus early terminations for milli-seconds and micro-seconds for functionality with less resolution.</para>
//      /// </summary>
//      /// <param name="nanoSecond"></param>
//      /// <returns></returns>
//      public static (int milliSecond, double milliSeconds, int microSecond, double microSeconds, int nanoSecond) ConvertNanosecondToSubSecondUnits(int nanoSecond)
//      {
//        var milliSeconds = nanoSecond / 1000000.0;

//        var milliSecond = (int)double.Truncate(milliSeconds);

//        nanoSecond = nanoSecond - (milliSecond * 1000000);

//        var microSeconds = nanoSecond / 1000.0;

//        var microSecond = (int)double.Truncate(microSeconds);

//        nanoSecond = nanoSecond - (microSecond * 1000);

//        return (milliSecond, milliSeconds, microSecond, microSeconds, nanoSecond);
//      }
