namespace Flux.Random
{
    ...
    : System.Random
  {
    ...
    public override int Next()
      => (int)(SampleUInt32() & 0x7FFFFFFF);
    /// <summary>Returns a non-negative random integer that is less than the specified maximum.</summary>
    /// <returns>A non-negative random integer that is less than the specified maximum.</returns>
    public override int Next(int maxValue)
      => maxValue > 0 ? (int)(maxValue * Sample()) : throw new System.ArgumentOutOfRangeException(nameof(maxValue), @"Must be greater than zero.");
    ...
    public override int Next(int minValue, int maxValue)
      => maxValue > minValue ? (int)(minValue + (maxValue - minValue) * Sample()) : throw new System.ArgumentOutOfRangeException(nameof(maxValue), @"Must be greater than minValue.");
