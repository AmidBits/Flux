namespace Flux.Random
{
    ...
    : System.Random
  {
    ...
    public override int Next() => (int)(SampleUInt64() & 0x7FFFFFFF);
    ...
    public override double NextDouble() => (SampleUInt64() >> 11) / (1L << 53);
    /// <summary>Needs to return a value that is greater than or equal to 0.0, and less than 1.0</summary>
    /// <returns>A double-precision floating point number that is greater than or equal to 0.0, and less than 1.0.</returns>
    protected override double Sample() => (SampleUInt64() >> 11) / (1L << 53);
