namespace Flux.Random
{
  ...
  public class Xoshiro256SS : RandomUInt64
  {
    ...
    public Xoshiro256SS(long seed) : this(unchecked((ulong)seed)) { }
    public Xoshiro256SS() : this(System.Diagnostics.Stopwatch.GetTimestamp()) { }
