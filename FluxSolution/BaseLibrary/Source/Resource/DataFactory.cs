...
namespace Flux.Resources
{
	public static class Presets
	{
		...
		{
			yield return new string[] { "RecordNumber", "ZipCode", "ZipCodeType", "City", "State", "LocationType", "Lat", "Long", "Xaxis", "Yaxis", "Zaxis", "WorldRegion", "Country", "LocationText", "Location", "Decomissioned", "TaxReturnsFiled", "EstimatedPopulation", "TotalWages", "Notes" };
