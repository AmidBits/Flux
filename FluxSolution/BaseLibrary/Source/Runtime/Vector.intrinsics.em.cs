...
namespace Flux
{
  public static partial class Vectors
  {
    ...
    internal static Vector128<double> OneOverPI2_128
      => Vector128.Create(1 / GenericMath.PiOver2);
    internal static Vector256<double> OneOverPI2
      => Vector256.Create(1 / GenericMath.PiOver2);

    internal static Vector128<double> PI2_128
      => Vector128.Create(GenericMath.PiOver2);
    internal static Vector256<double> PI2
      => Vector256.Create(GenericMath.PiOver2);
    ...
    /// <summary>Returns a new vector with the Euclidean distance between the vectors.</summary>
    public static Vector128<double> EuclideanDistance(this Vector128<double> source, Vector128<double> target)
      => EuclideanLength(target.Subtract(source));
    /// <summary>Returns a new vector with the Euclidean distance between the vectors.</summary>
    public static Vector256<double> EuclideanDistance(this Vector256<double> source, Vector256<double> target)
      => EuclideanLength(target.Subtract(source));
