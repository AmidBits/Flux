namespace Flux.Services.GitHub
{
	...
	public static class GitHubApi
	{
		...
		public static System.Collections.Generic.IEnumerable<GitHubEntry> GetEntries(System.Uri uri)
		{
			...
			foreach (var content in System.Text.Json.JsonSerializer.Deserialize<System.Collections.Generic.Dictionary<string, object>[]>(hc.GetStringAsync(uri).Result, null) ?? throw new System.NullReferenceException())
			{
