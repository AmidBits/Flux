namespace Flux
{
  public static partial class XtendString
  {
    ...
    public static string PadEven(this string source, int totalWidth, char paddingLeft, char paddingRight)
      => totalWidth > source.Length && totalWidth - source.Length is int overflow && overflow / 2 is var overflowDiv2 ? new string(paddingLeft, overflowDiv2) + source + new string(paddingRight, overflow - overflowDiv2) : source;
