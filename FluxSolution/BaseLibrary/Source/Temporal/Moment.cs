namespace Flux
{
  public static partial class Em
  {
    ...
    public static long GetTotalApproximateMilliseconds(this Quantities.Moment source)
    ...
    /// <summary>Returns the approximate number of computed seconds for the instance pro-rata rate. This is by not an exact measurement and used only to compare two instances.</summary>
    public static double GetTotalApproximateSeconds(this Quantities.Moment source)
    ...
    public static Quantities.Moment ToMomentUtc(this System.DateTime source)
