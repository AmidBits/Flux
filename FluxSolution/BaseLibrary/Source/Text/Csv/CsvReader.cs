...
namespace Flux.Text.Csv
{
	...
	//: Flux.Disposable, System.Collections.Generic.IEnumerable<string[]>
	{
		...
		//		private readonly System.Collections.Generic.IList<string> m_csvValues = new System.Collections.Generic.List<string>();
		/// <summary>Returns all accumulated field values for the current line.</summary>
		//public System.Collections.Generic.IReadOnlyList<string> CsvValues
		//	=> (System.Collections.Generic.IReadOnlyList<string>)FieldValues;

		/// <summary>Returns the current field value, or null of there are no field values available yet.</summary>
		//public string? CsvValue
		//	=> CsvValues.Count - 1 is var maxIndex && maxIndex > -1 ? CsvValues[maxIndex] : null;
