namespace Flux.Text
{
	// Taken from https://stackoverflow.com/questions/54983533/parsing-a-json-file-with-net-core-3-0-system-text-json and fixed a few bugs with that.
	public ref struct Utf8JsonStreamReader
	{
		...
		public System.Buffers.ReadOnlySequence<byte> ValueSequence => m_jsonReader.ValueSequence;
		public System.ReadOnlySpan<byte> ValueSpan => m_jsonReader.ValueSpan;
		...
		[System.CLSCompliant(false)]
		public uint GetUInt32() => m_jsonReader.GetUInt32();
		[System.CLSCompliant(false)]
		...
		[System.CLSCompliant(false)]
		public bool TryGetSByte(out sbyte value) => m_jsonReader.TryGetSByte(out value);
		public bool TryGetSingle(out float value) => m_jsonReader.TryGetSingle(out value);
		[System.CLSCompliant(false)]
		public bool TryGetUInt16(out ushort value) => m_jsonReader.TryGetUInt16(out value);
		[System.CLSCompliant(false)]
		public bool TryGetUInt32(out uint value) => m_jsonReader.TryGetUInt32(out value);
		[System.CLSCompliant(false)]
		public bool TryGetUInt64(out ulong value) => m_jsonReader.TryGetUInt64(out value);
