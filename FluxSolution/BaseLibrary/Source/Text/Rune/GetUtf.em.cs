namespace Flux
{
	public static partial class SystemTextRegularExpressionsEm
	{
		...
		public static int[] GetUtf16(this System.Text.Rune source)
		{
			...
			static ushort BitsHs(int value) => (ushort)((value & 0x03FF) + 0xD800);
		...
		public static byte[] GetUtf8(this System.Text.Rune source)
		{
			...
			static byte Bits3(int value) => (byte)(0b11110000 | (value & 0b00000111));
			static byte Bits4(int value) => (byte)(0b11100000 | (value & 0b00001111));
			static byte Bits5(int value) => (byte)(0b11000000 | (value & 0b00011111));
			static byte Bits6(int value) => (byte)(0b10000000 | (value & 0b00111111));
			static byte Bits7(int value) => (byte)(value & 0b01111111);
		}
	}
}
