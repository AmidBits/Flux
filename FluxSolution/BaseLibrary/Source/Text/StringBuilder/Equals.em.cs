namespace Flux
{
	public static partial class SystemTextEm
	{
		...
		public static bool Equals(this System.Text.StringBuilder source, int sourceIndex, System.ReadOnlySpan<char> target, int targetIndex, int length, System.Collections.Generic.IEqualityComparer<char> comparer)
		{
		...
		public static bool Equals(this System.Text.StringBuilder source, int sourceIndex, System.ReadOnlySpan<char> target, int targetIndex, int length)
		...
		public static bool Equals(this System.Text.StringBuilder source, int sourceIndex, System.ReadOnlySpan<char> target, System.Collections.Generic.IEqualityComparer<char> comparer)
		...
		public static bool Equals(this System.Text.StringBuilder source, int sourceIndex, System.ReadOnlySpan<char> target)
