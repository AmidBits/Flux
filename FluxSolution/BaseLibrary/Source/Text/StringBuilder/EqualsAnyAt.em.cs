...
namespace Flux
{
  public static partial class XtensionsStringBuilder
  {
    ...
    public static bool EqualsAnyAt(this System.Text.StringBuilder source, int startAt, params string[] values)
      => EqualsAnyAt(source, startAt, -1, Flux.StringComparer.Ordinal, values.AsEnumerable());
    ...
    public static bool EqualsAnyAt(this System.Text.StringBuilder source, int startAt, Flux.StringComparer comparer, params string[] values)
    ...
    public static bool EqualsAnyAt(this System.Text.StringBuilder source, int startAt, int count, params string[] values)
      => EqualsAnyAt(source, startAt, count, Flux.StringComparer.Ordinal, values.AsEnumerable());
    ...
    public static bool EqualsAnyAt(this System.Text.StringBuilder source, int startAt, int count, Flux.StringComparer comparer, params string[] values)
    ...
    public static bool EqualsAnyAt(this System.Text.StringBuilder source, int startAt, int count, Flux.StringComparer comparer, System.Collections.Generic.IEnumerable<string> values)
    {
