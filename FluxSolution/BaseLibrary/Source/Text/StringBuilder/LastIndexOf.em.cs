namespace Flux
{
  public static partial class XtensionsStringBuilder
  {
    ...
    public static int LastIndexOf(this System.Text.StringBuilder source, string value, Flux.StringComparerEx comparer)
    {
      if (source is null) throw new System.ArgumentNullException(nameof(source));
    ...
    public static int LastIndexOfAny(this System.Text.StringBuilder source, Flux.StringComparerEx comparer, params string[] values)
    {
      foreach (var value in values)
