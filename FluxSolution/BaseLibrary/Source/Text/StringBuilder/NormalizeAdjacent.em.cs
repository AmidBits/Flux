namespace Flux
{
	public static partial class SystemTextStringBuilderEm
	{
		...
		public static System.Text.StringBuilder NormalizeAdjacent(this System.Text.StringBuilder source, System.Collections.Generic.IEqualityComparer<char> comparer, System.ReadOnlySpan<char> characters)
		{
			...
			for (var indexOfSource = 0; indexOfSource < source.Length; indexOfSource++)
			{
				...
				if (!comparer.Equals(current, previous) || (characters.Length > 0 && characters.IndexOf(current, comparer) == -1))
				{
