namespace Flux
{
  public static partial class Xtensions
  {
    ...
    public static string RightMost(this System.Text.StringBuilder source, int maxCount)
      => (source ?? throw new System.ArgumentNullException(nameof(source))).Length - System.Math.Max(0, maxCount) is var startIndex ? source.ToString(startIndex, source.Length - startIndex) : string.Empty;
  }
}
