namespace Flux
{
  ...
  public static partial class Unicode
  {
    ...
    public static string ToUnicodeCsEscapeSequenceString(this char character, CsEscapeSequenceFormat format)
    ...
    public static string ToUnicodeCsEscapeSequenceString(this System.Text.Rune rune, CsEscapeSequenceFormat format)
      => format switch
      {
        CsEscapeSequenceFormat.UTF16 => $@"\u{rune.Value:X4}",
        CsEscapeSequenceFormat.UTF32 => $@"\U{rune.Value:X8}",
