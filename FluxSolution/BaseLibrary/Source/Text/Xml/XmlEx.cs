...
namespace Flux.Text
{
  public static partial class XmlEx
  {
    ...
    public static string UnescapeInvalidCharacters(string source)
      => System.Text.RegularExpressions.Regex.Replace(source, @"#0x\d{4}#", (m) => $"{(char)int.Parse(m.Value.Substring(3, 4), System.Globalization.NumberStyles.Integer, System.Globalization.CultureInfo.CurrentCulture)}");
  }
}
