namespace Flux
{
  ...
  public static partial class ArrayRank2
  {
    ...
    /// <param name="targetLength0">The length of dimension 0 in the new array.</param>
    /// <param name="targetLength1">The length of dimension 1 in the new array.</param>
    ...
    /// <returns></returns>
    public static T[,] Duplicate<T>(this T[,] source, int targetLength0, int targetLength1, int copyCount0, int copyCount1, int sourceIndex0, int sourceIndex1, int targetIndex0, int targetIndex1)
    {
      ...
      var target = new T[targetLength0, targetLength1];

      var maxCount0 = System.Math.Min(System.Math.Min(copyCount0, source.GetLength(0) - sourceIndex0), targetLength0 - targetIndex0);
      var maxCount1 = System.Math.Min(System.Math.Min(copyCount1, source.GetLength(1) - sourceIndex1), targetLength1 - targetIndex1);
