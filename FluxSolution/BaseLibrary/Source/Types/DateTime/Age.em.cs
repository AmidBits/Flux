namespace Flux
{
	public static partial class SystemDateTimeEm
	{
		...
		/// <summary>Determines the life time in integer years (age) between the source (e.g. a birth) and the specified target (e.g. a birthday). I.e. the common western way of calculating age. There are a multitude of scenarios where this way of calulcating would not be applicable. Work in either direction.</summary>
