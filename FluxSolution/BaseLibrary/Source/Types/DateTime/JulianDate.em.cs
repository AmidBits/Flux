namespace Flux
{
		...
		: System.IComparable<JulianDate>, System.IEquatable<JulianDate>
	{
		...
		public int GetAstronomicalYearNumber()
			=> IsProlepticJulianCalendar(m_value) ? ToProlepticJulianCalendarDate(JulianDayNumber).year : ToProlepticGregorianCalendarDate(JulianDayNumber).year;
		...
		public static JulianDate Add(JulianDate jd, double b)
			=> new JulianDate(jd.m_value + b);
		public static JulianDate Add(JulianDate jd, System.TimeSpan b)
			=> AddTimeSpan(jd, b.Days, b.Hours, b.Minutes, b.Seconds);
		public static JulianDate AddTimeSpan(JulianDate jd, int days, int hours, int minutes, int seconds)
			=> new JulianDate(jd.m_value + days + ((hours - 12) / HoursPerDay) + (minutes / MinutesPerDay) + (seconds / SecondsPerDay));
		...
		public static JulianDate Subtract(JulianDate a, double b)
		...
		public override string? ToString()
			=> $"<{nameof(JulianDate)} {m_value} ({ToDateString()} {ToTimeString()})>";
	}
}
