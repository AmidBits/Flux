...
namespace Flux
{
  ...
  {
    /// <summary>Finds the bit index of a power-of-2 value (i.e. only a single bit can be set to 1).</summary>
    ...
    /// <summary>Computes the smallest power of 2 storage size, that is greater or equal to <paramref name="startingStorageSizeInPowerOf2"/>, that would fit the value.</summary>
    ...
    /// <summary>Computes the floor or ceiling (depending on the <paramref name="ceiling"/> argument) of the base 2 log of the value.</summary>
    /// <typeparam name="TSelf"></typeparam>
    /// <param name="value"></param>
