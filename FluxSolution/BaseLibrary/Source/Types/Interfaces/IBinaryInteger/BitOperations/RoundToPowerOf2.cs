...
namespace Flux
{
  ...
  public static partial class ExtensionMethods
  {
    ...
    /// <summary>PREVIEW! Computes the smallest and largest power of 2 that is greater than or equal to and less than or equal to, respectively, and also returns the nearest (to <paramref name="value"/>) of the two.</summary>
    /// <param name="value"></param>
    /// <param name="greaterThanOrEqual">Outputs the power of 2 that is greater than or equal to <paramref name="value"/>.</param>
    /// <param name="lessThanOrEqual">Outputs the power of 2 that is less than or equal to <paramref name="value"/>.</param>
    ...
    /// <summary>PREVIEW! Computes the smallest and largest power of 2 that is greater than and larger than, respectively, and also returns the nearest (to <paramref name="value"/>) of the two.</summary>
    /// <param name="value"></param>
    /// <param name="greaterThan">Outputs the power of 2 proper (i.e. always) that is greater than <paramref name="value"/>.</param>
    /// <param name="lessThan">Outputs the power of 2 proper (i.e. always) that is less than <paramref name="value"/>.</param>
    /// <returns>The nearest power of 2.</returns>
    ...
    /// <summary>PREVIEW! Find the next smallest power of 2 that is greater than or equal to <paramref name="value"/>.</summary>
    public static TSelf RoundUpToPow2<TSelf>(this TSelf value)
      where TSelf : System.Numerics.IBinaryInteger<TSelf>
      => TSelf.IsPow2(value) ? value : BitFoldRight(value - TSelf.One) + TSelf.One;
    /// <summary>PREVIEW! Find the next smallest power of 2 proper (i.e. always) that is greater than <paramref name="value"/>.</summary>
