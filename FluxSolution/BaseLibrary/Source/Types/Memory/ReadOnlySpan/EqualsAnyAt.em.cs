...
namespace Flux
{
  public static partial class ExtensionMethods
  {
    ...
    public static bool EqualsAnyAt(this System.ReadOnlySpan<char> source, int startAt, params string[] values)
    ...
    public static bool EqualsAnyAt(this System.ReadOnlySpan<char> source, int startAt, System.StringComparison comparisonType, params string[] values)
    ...
    public static bool EqualsAnyAt(this System.ReadOnlySpan<char> source, int startAt, int count, params string[] values)
    ...
    public static bool EqualsAnyAt(this System.ReadOnlySpan<char> source, int startAt, int count, System.StringComparison comparisonType, params string[] values)
    ...
    public static bool EqualsAnyAt(this System.ReadOnlySpan<char> source, int startAt, int count, System.StringComparison comparisonType, System.Collections.Generic.IEnumerable<string> values)
    {
