namespace Flux
{
  public static partial class ExtensionMethods
  {
    ...
    public static (int indexMinimum, int indexMaximum) GetExtremum<TSource, TValue>(this System.ReadOnlySpan<TSource> source, System.Func<TSource, TValue> valueSelector, System.Collections.Generic.IComparer<TValue> comparer)
    {
    ...
    public static (int indexMinimum, int indexMaximum) GetExtremum<TSource, TValue>(this System.ReadOnlySpan<TSource> source, System.Func<TSource, TValue> valueSelector)
      => GetExtremum(source, valueSelector, System.Collections.Generic.Comparer<TValue>.Default);
  }
}
