...
//		{
//			private ReadOnlySpan<char> m_characterString;

//			public LineSplitEnumerator(ReadOnlySpan<char> characterString)
//			{
//				m_characterString = characterString;
...
//				{
//					m_characterString = ReadOnlySpan<char>.Empty; // The remaining string is an empty string
...
//						m_characterString = span.Slice(index + 2);
//						return true;
//					}
//				}

//				Current = new LineSplitEntry(span.Slice(0, index), span.Slice(index, 1));
//				m_characterString = span.Slice(index + 1);
//				return true;
//			}
...
//		private readonly ref struct LineSplitEntry
//		{
