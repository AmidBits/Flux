namespace Flux
{
  public static partial class ExtensionMethods
  {
    ...
    public static int[] ZFunction<T>(this System.ReadOnlySpan<T> source, System.Collections.Generic.IEqualityComparer<T> equalityComparer)
    {
      ...
      for (int i = 1, l = 0, r = 0; i < sourceLength; i++)
      {
        ...
        while (i + z[i] < sourceLength && equalityComparer.Equals(source[z[i]], source[i + z[i]]))
          z[i]++;
