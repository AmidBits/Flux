namespace Flux
{
  public static partial class ExtensionMethods
  {
    ...
    public static int[] IndicesOfAny<T>(this System.Span<T> source, System.Collections.Generic.IEqualityComparer<T> comparer, params T[] values)
    {
    ...
    /// <summary>Reports all first indices of the specified targets within the source (-1 if not found). Uses the specified comparer.</summary>
    public static int[] IndicesOfAny<T>(this System.Span<T> source, params T[] values)
