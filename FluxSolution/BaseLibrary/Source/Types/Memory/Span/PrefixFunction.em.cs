namespace Flux
{
  public static partial class ExtensionMethods
  {
    ...
    public static int[] PrefixFunction<T>(this System.Span<T> source, System.Collections.Generic.IEqualityComparer<T> comparer)
    {
      ...
      for (int i = 1; i < sourceLength; i++)
      {
        ...
        while (j > 0 && !comparer.Equals(source[i], source[j]))
          j = p[j - 1];
    ...
    public static int[] PrefixFunction<T>(this System.Span<T> source)
