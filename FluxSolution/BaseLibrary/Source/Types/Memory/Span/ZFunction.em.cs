namespace Flux
{
  public static partial class ExtensionMethods
  {
    ...
    public static int[] ZFunction<T>(this System.Span<T> source, System.Collections.Generic.IEqualityComparer<T> comparer)
    {
      ...
      for (int i = 1, l = 0, r = 0; i < sourceLength; i++)
      {
        ...
        while (i + z[i] < sourceLength && comparer.Equals(source[z[i]], source[i + z[i]]))
          z[i]++;
    ...
    public static int[] ZFunction<T>(this System.Span<T> source)
