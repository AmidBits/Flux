namespace Flux
{
  public static partial class Unicode
  {
    ...
    public static UnicodeBlock GetUnicodeBlock(this System.Text.Rune source)
      => System.Enum.GetValues<UnicodeBlock>().Single(ub => source.Value >= ub.GetMinUtf32() && source.Value <= ub.GetMaxUtf32());
    //{
    //  foreach (var block in System.Enum.GetValues<UnicodeBlock>())
    //    if (source.Value >= block.GetMinUtf32() && source.Value <= block.GetMaxUtf32())
    //      return block;
