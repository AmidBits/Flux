namespace Flux
{
  public static partial class Xtensions
  {
    ...
    public static int CountEqualOnBothSides(this string source, System.ReadOnlySpan<char> target, [System.Diagnostics.CodeAnalysis.DisallowNull] System.Collections.Generic.IEqualityComparer<char> comparer)
    ...
    public static int CountEqualOnBothSides(this string source, System.ReadOnlySpan<char> target)
      => CountEqualOnBothSides(source, target, System.Collections.Generic.EqualityComparer<char>.Default);

    public static int CountEqualAtEnd(this string source, System.ReadOnlySpan<char> target, [System.Diagnostics.CodeAnalysis.DisallowNull] System.Collections.Generic.IEqualityComparer<char> comparer, out int minLength)
    {
    ...
    public static int CountEqualAtEnd(this string source, System.ReadOnlySpan<char> target, out int minLength)
    ...
    public static int CountEqualAtEnd(this string source, System.ReadOnlySpan<char> target, [System.Diagnostics.CodeAnalysis.DisallowNull] System.Collections.Generic.IEqualityComparer<char> comparer)
      => CountEqualAtEnd(source, target, comparer, out var _);
    /// <summary>Reports the count of elements equal at the end of the sequences. Using the default comparer.</summary>
    public static int CountEqualAtEnd(this string source, System.ReadOnlySpan<char> target)
    ...
    public static int CountEqualAtStart(this string source, System.ReadOnlySpan<char> target, [System.Diagnostics.CodeAnalysis.DisallowNull] System.Collections.Generic.IEqualityComparer<char> comparer, out int minLength)
    {
      if (source is null) throw new System.ArgumentNullException(nameof(source));
    ...
    public static int CountEqualAtStart(this string source, System.ReadOnlySpan<char> target, out int minLength)
    ...
    public static int CountEqualAtStart(this string source, System.ReadOnlySpan<char> target, [System.Diagnostics.CodeAnalysis.DisallowNull] System.Collections.Generic.IEqualityComparer<char> comparer)
      => CountEqualAtStart(source, target, comparer, out var _);
    /// <summary>Reports the length (or count) of equality at the start of the sequences. Using the default comparer.</summary>
    public static int CountEqualAtStart(this string source, System.ReadOnlySpan<char> target)
