namespace Flux
{
  public static partial class StringEm
  {
    ...
    //  {
    //    yield return (char)((System.Text.Rune)source[index]).ReplaceUnicodeDiacriticalLatinStroke().Value;
    //  }
    //}
    ...
    public static System.Collections.Generic.IEnumerable<char> RemoveDiacriticalMarks(this string source, System.Func<char, char> additionalCharacterReplacements)
    {
      ...
      foreach (var character in source.Normalize(System.Text.NormalizationForm.FormKD))
      {
    ...
    //  => RemoveDiacriticalMarks(source, c => (char)((System.Text.Rune)c).ReplaceUnicodeLatinStroke().Value);
  }
}
