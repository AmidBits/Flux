namespace Flux
{
  public static partial class ExtensionMethods
  {
    ...
    public static bool IsWrapped(this string source, char left, char right)
      => (source ?? throw new System.ArgumentNullException(nameof(source))).Length >= 2 && source[0] == left && source[^1] == right;
    ...
    public static string Unwrap(this string source, char left, char right)
      => source.IsWrapped(left, right) ? source[1..^1] : source;
    ...
    public static string Wrap(this string source, char left, char right, bool force = false)
      => force || !source.IsWrapped(left, right) ? left.ToString() + source + right.ToString() : source;
