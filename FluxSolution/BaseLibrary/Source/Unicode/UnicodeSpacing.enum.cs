namespace Flux
{
  public static partial class Unicode
  {
    ...
    /// <returns></returns>
    public static string AppendUnicodeSpacing(this string source, UnicodeSpacing spacing = UnicodeSpacing.Space)
    ...
    /// <param name="spacing"></param>
    /// <returns></returns>
    public static string PrependUnicodeSpacing(this string source, UnicodeSpacing spacing = UnicodeSpacing.Space)
