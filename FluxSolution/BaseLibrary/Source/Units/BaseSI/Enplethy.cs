namespace Flux
{
  ...
  namespace Units
  {
      ...
      : System.IComparable, System.IComparable<Enplethy>, System.IFormattable, IMetricMultiplicable<double>, IUnitValueQuantifiable<double, EnplethyUnit>
    {
      ...
      public string ToUnitValueString(EnplethyUnit unit = EnplethyUnit.Mole, string? format = null, System.IFormatProvider? formatProvider = null, bool preferUnicode = false, UnicodeSpacing unicodeSpacing = UnicodeSpacing.None, bool useFullName = false)
      {
        var sb = new System.Text.StringBuilder();
