namespace Flux
{
  ...
  namespace Units
  {
      ...
      : System.IComparable, System.IComparable<LuminousIntensity>, System.IFormattable, IMetricMultiplicable<double, LuminousIntensityUnit>, IUnitValueQuantifiable<double, LuminousIntensityUnit>
    {
      ...
      public string ToUnitValueString(LuminousIntensityUnit unit = LuminousIntensityUnit.Candela, string? format = null, System.IFormatProvider? formatProvider = null, bool preferUnicode = false, UnicodeSpacing unitSpacing = UnicodeSpacing.Space, bool useFullName = false)
      {
        var sb = new System.Text.StringBuilder();
