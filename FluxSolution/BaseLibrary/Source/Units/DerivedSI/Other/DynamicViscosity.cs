namespace Flux
{
  ...
  {
    public static string GetUnitString(this Units.DynamicViscosityUnit unit, bool preferUnicode = false, bool useFullName = false)
  ...
  namespace Units
  {
      ...
      : System.IComparable, System.IComparable<DynamicViscosity>, System.IFormattable, IUnitValueQuantifiable<double, DynamicViscosityUnit>
    {
      ...
      public string ToString(string? format, System.IFormatProvider? formatProvider)
        => ToUnitValueString(DynamicViscosityUnit.PascalSecond, UnitValueStringOptions.Default with { Format = format, FormatProvider = formatProvider });
      ...
      public string ToUnitValueString(DynamicViscosityUnit unit, string? format, System.IFormatProvider? formatProvider, bool preferUnicode, UnicodeSpacing unicodeSpacing, bool useFullName)
      {
      ...
      public string ToUnitValueString(DynamicViscosityUnit unit, UnitValueStringOptions options = default)
      {
        var sb = new System.Text.StringBuilder();
