namespace Flux
{
  ...
  {
    public static string GetUnitString(this Units.FlowUnit unit, Units.TextOptions options = default)
  ...
  namespace Units
  {
      ...
      : System.IComparable, System.IComparable<Flow>, System.IFormattable, IUnitValueQuantifiable<double, FlowUnit>
    {
      ...
      // IQuantifiable<>
      public string ToValueString(TextOptions options = default) => ToUnitValueString(FlowUnit.CubicMeterPerSecond, options);
      ...
      public string ToUnitValueString(FlowUnit unit, TextOptions options = default)
