namespace Flux
{
  ...
  {
    public static string GetUnitString(this Units.HeatCapacityUnit unit, QuantifiableValueStringOptions options = default)
  ...
  namespace Units
  {
      ...
      : System.IComparable, System.IComparable<HeatCapacity>, System.IFormattable, IUnitValueQuantifiable<double, HeatCapacityUnit>
    {
      ...
      public string ToUnitValueString(HeatCapacityUnit unit, QuantifiableValueStringOptions options = default)
