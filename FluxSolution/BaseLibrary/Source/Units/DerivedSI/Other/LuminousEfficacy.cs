namespace Flux
{
  ...
  {
    public static string GetUnitString(this Units.LuminousEfficacyUnit unit, Units.TextOptions options = default)
  ...
  namespace Units
  {
      ...
      : System.IComparable, System.IComparable<LuminousEfficacy>, System.IFormattable, IUnitValueQuantifiable<double, LuminousEfficacyUnit>
    {
      ...
      // IQuantifiable<>
      public string ToValueString(TextOptions options = default) => ToUnitValueString(LuminousEfficacyUnit.LumensPerWatt, options);
      ...
      public string ToUnitValueString(LuminousEfficacyUnit unit, TextOptions options = default)
