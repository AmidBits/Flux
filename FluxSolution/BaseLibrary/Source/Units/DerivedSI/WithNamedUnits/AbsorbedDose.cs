namespace Flux
{
  ...
  {
    public static string GetUnitString(this Units.AbsorbedDoseUnit unit, Units.TextOptions options = default)
  ...
  namespace Units
  {
      ...
      : System.IComparable, System.IComparable<AbsorbedDose>, System.IFormattable, IUnitValueQuantifiable<double, AbsorbedDoseUnit>
    {
      ...
      // IQuantifiable<>
      public string ToValueString(TextOptions options = default) => ToUnitValueString(AbsorbedDoseUnit.Gray, options);
      ...
      public string ToUnitValueString(AbsorbedDoseUnit unit, TextOptions options = default)
