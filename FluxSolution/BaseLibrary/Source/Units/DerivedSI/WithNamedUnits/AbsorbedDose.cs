namespace Flux
{
  ...
  {
    public static string GetUnitString(this Units.AbsorbedDoseUnit unit, QuantifiableValueStringOptions options)
  ...
  namespace Units
  {
      ...
      : System.IComparable, System.IComparable<AbsorbedDose>, IUnitValueQuantifiable<double, AbsorbedDoseUnit>
    {
      ...
      // IQuantifiable<>
      public string ToValueString(QuantifiableValueStringOptions options) => ToUnitValueString(AbsorbedDoseUnit.Gray, options);
      ...
      public string ToUnitValueString(AbsorbedDoseUnit unit, QuantifiableValueStringOptions options)
