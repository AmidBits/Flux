namespace Flux
{
  ...
  namespace Units
  {
      ...
      : System.IComparable, System.IComparable<ElectricCharge>, System.IFormattable, IUnitValueQuantifiable<double, ElectricChargeUnit>
    {
      ...
      public string ToUnitValueString(ElectricChargeUnit unit = ElectricChargeUnit.Coulomb, string? format = null, System.IFormatProvider? formatProvider = null, bool preferUnicode = false, UnicodeSpacing unicodeSpacing = UnicodeSpacing.None, bool useFullName = false)
      {
