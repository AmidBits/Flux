namespace Flux
{
  ...
  {
    public static string GetUnitString(this Units.ForceUnit unit, QuantifiableValueStringOptions options = default)
  ...
  namespace Units
  {
      ...
      : System.IComparable, System.IComparable<Force>, IUnitValueQuantifiable<double, ForceUnit>
    {
      ...
      public string ToUnitValueString(ForceUnit unit, QuantifiableValueStringOptions options = default)
