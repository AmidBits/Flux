namespace Flux
{
  ...
  namespace Units
  {
      ...
      : System.IComparable, System.IComparable<LuminousFlux>, System.IFormattable, IUnitValueQuantifiable<double, LuminousFluxUnit>
    {
      ...
      public string ToUnitValueString(LuminousFluxUnit unit = LuminousFluxUnit.Lumen, string? format = null, System.IFormatProvider? formatProvider = null, bool preferUnicode = false, UnicodeSpacing unitSpacing = UnicodeSpacing.Space, bool useFullName = false)
      {
