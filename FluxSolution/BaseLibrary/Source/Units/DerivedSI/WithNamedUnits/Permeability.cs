namespace Flux
{
  ...
  {
    public static string GetUnitString(this Units.PermeabilityUnit unit, QuantifiableValueStringOptions options = default)
  ...
  namespace Units
  {
      ...
      : System.IComparable, System.IComparable<Permeability>, IUnitValueQuantifiable<double, PermeabilityUnit>
    {
      ...
      public string ToUnitValueString(PermeabilityUnit unit, QuantifiableValueStringOptions options = default)
