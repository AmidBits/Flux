  ...
  namespace Units
  {
      ...
      : System.IComparable, System.IComparable<RadiationExposure>, System.IFormattable, IUnitValueQuantifiable<double, RadiationExposureUnit>
    {
      ...
      public string ToString(string? format, System.IFormatProvider? formatProvider)
        => ToUnitValueString(RadiationExposureUnit.CoulombPerKilogram, UnitValueStringOptions.Default with { Format = format, FormatProvider = formatProvider });
      ...
      public string ToUnitValueString(RadiationExposureUnit unit, string? format, System.IFormatProvider? formatProvider, bool preferUnicode, UnicodeSpacing unicodeSpacing, bool useFullName)
      {
      ...
      public string ToUnitValueString(RadiationExposureUnit unit, UnitValueStringOptions options = default)
      {
        var sb = new System.Text.StringBuilder();
