namespace Flux
{
  ...
  namespace Units
  {
      ...
      : System.IComparable, System.IComparable<Voltage>, System.IFormattable, IUnitValueQuantifiable<double, VoltageUnit>
    {
      ...
      public string ToUnitValueString(VoltageUnit unit = VoltageUnit.Volt, string? format = null, System.IFormatProvider? formatProvider = null, bool preferUnicode = false, UnicodeSpacing unicodeSpacing = UnicodeSpacing.None, bool useFullName = false)
      {
