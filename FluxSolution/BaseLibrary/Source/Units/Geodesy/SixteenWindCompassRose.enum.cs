namespace Flux
{
  public static partial class Em
  {
    ...
    public static Units.Azimuth GetAzimuth(this Units.SixteenWindCompassRose source)
      => ((Units.ThirtytwoWindCompassRose)source).GetAzimuth();
    public static string ToStringOfWords(this Units.SixteenWindCompassRose source)
