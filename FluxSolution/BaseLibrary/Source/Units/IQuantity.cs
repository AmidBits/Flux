...
//    public static Cartesian3<TSelf> Parse(ReadOnlySpan<char> s, System.Globalization.NumberStyles style, System.IFormatProvider? provider) => throw new NotImplementedException();
//    public static Cartesian3<TSelf> Parse(string s, System.Globalization.NumberStyles style, System.IFormatProvider? provider) => throw new NotImplementedException();
//    public static Cartesian3<TSelf> Parse(ReadOnlySpan<char> s, System.IFormatProvider? provider) => throw new NotImplementedException();
//    public static Cartesian3<TSelf> Parse(string s, System.IFormatProvider? provider) => throw new NotImplementedException();
//    public static bool TryParse(ReadOnlySpan<char> s, System.Globalization.NumberStyles style, System.IFormatProvider? provider, [System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Cartesian3<TSelf> result) => throw new NotImplementedException();
//    public static bool TryParse([System.Diagnostics.CodeAnalysis.NotNullWhen(true)] string? s, System.Globalization.NumberStyles style, System.IFormatProvider? provider, [System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Cartesian3<TSelf> result) => throw new NotImplementedException();
//    public static bool TryParse(ReadOnlySpan<char> s, System.IFormatProvider? provider, [System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Cartesian3<TSelf> result) => throw new NotImplementedException();
//    public static bool TryParse([System.Diagnostics.CodeAnalysis.NotNullWhen(true)] string? s, System.IFormatProvider? provider, [System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Cartesian3<TSelf> result) => throw new NotImplementedException();
...
//    public string ToString(string? format, System.IFormatProvider? formatProvider) => throw new NotImplementedException();
//    public bool TryFormat(Span<char> destination, out int charsWritten, ReadOnlySpan<char> format, System.IFormatProvider? provider) => throw new NotImplementedException();
