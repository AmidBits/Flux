namespace Flux
{
  ...
  namespace Units
  {
    ...
    : System.IComparable, System.IComparable<DigitalInformation>, System.IFormattable, IValueQuantifiable<System.Numerics.BigInteger>
    {
      ...
      public string ToUnitValueString(DigitalInformationUnit unit, string? format, System.IFormatProvider? formatProvider, bool preferUnicode, UnicodeSpacing unicodeSpacing, bool useFullName)
      {
