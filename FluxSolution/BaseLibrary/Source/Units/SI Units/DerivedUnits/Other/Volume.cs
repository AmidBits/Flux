namespace Flux
{
  ...
  {
    public static string GetUnitString(this Quantities.VolumeUnit unit, bool preferUnicode = false, bool useFullName = false)
  ...
  namespace Quantities
  {
      ...
      : System.IComparable, System.IComparable<Volume>, System.IFormattable, IUnitValueQuantifiable<double, VolumeUnit>
    {
      ...
      public string ToString(string? format, System.IFormatProvider? formatProvider)
        => ToUnitValueString(VolumeUnit.CubicMeter, format, formatProvider);
      ...
      public string ToMetricValueString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null, bool preferUnicode = false, UnicodeSpacing unitSpacing = UnicodeSpacing.Space, bool useFullName = false)
      {
        ...
        sb.Append(VolumeUnit.Litre.GetUnitString(preferUnicode, useFullName));
        return sb.ToString();
      }
      ...
      // IUnitQuantifiable<>
      public string GetUnitSymbol(VolumeUnit unit, bool preferUnicode, bool useFullName) => unit.GetUnitString(preferUnicode, useFullName);
      ...
      public string ToUnitValueString(VolumeUnit unit = VolumeUnit.CubicMeter, string? format = null, System.IFormatProvider? formatProvider = null, UnicodeSpacing unitSpacing = UnicodeSpacing.Space, bool preferUnicode = false, bool useFullName = false)
      {
        var sb = new System.Text.StringBuilder();
