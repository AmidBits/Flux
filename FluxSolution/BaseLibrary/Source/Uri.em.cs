namespace Flux
{
  public static partial class XtensionsUri
  {
    ...
    public static System.IO.Stream GetStream(this System.Uri uri)
      => (uri ?? throw new System.ArgumentNullException(nameof(uri))).IsFile ? new System.IO.FileStream(uri.LocalPath.StartsWith(@"/", System.StringComparison.Ordinal) ? uri.LocalPath.Substring(1) : uri.LocalPath, System.IO.FileMode.Open) : System.Net.WebRequest.Create(uri).GetResponse().GetResponseStream();
