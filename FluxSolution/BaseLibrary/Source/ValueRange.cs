namespace Flux
{
    ...
    where T : System.IComparable<T>
  {
    ...
    public T AssertMember(T value, IntervalNotation notation, string? paramName = null) => notation.AssertMember(value, m_min, m_max, paramName);

    /// <summary>Returns whether the value is a member of the interval set.</summary>
    /// <exception cref="System.NotImplementedException"></exception>
    public bool VerifyMember(T value, IntervalNotation notation) => notation.VerifyMember(value, m_min, m_max);
