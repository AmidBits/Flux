namespace Flux
{
  public static partial class Fx
  {
    ...
    public static System.Collections.Generic.IEnumerable<string> ToConsoleStrings(this System.Data.DataView source, ConsoleStringOptions? options = null)
    {
      System.ArgumentNullException.ThrowIfNull(source);
      ...
      if (options.IncludeColumnNames)
      {
        yield return string.Format(horizontalLineFormat, source!.Table!.Columns.Cast<System.Data.DataColumn>().Select((e, i) => options.CenterContent ? new System.Text.StringBuilder(e.ColumnName).PadEven(maxColumnWidths[i], ' ', ' ').ToString() : e.ColumnName).ToArray());
    ...
    public static string ToConsoleString(this System.Data.DataView source, ConsoleStringOptions? options = null)
      => string.Join(System.Environment.NewLine, ToConsoleStrings(source, options));
  }
}
