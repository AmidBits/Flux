namespace Flux
{
  public static partial class Fx
  {
    ...
    public static (LunarPhase LunarPhase, Quantities.JulianDate JulianDate, System.DateTime DateTime) GetLunarPhaseAndDate(this System.DateTime source)
      ...
      && source.AddHours(-43).LunarTruePhase(LunarPhase.WaningCrescent, out var jdPreviousWaningCrescent) is var dtPreviousWaningCrescent && source.CompareTo(dtPreviousWaningCrescent) >= 0)
      ? (LunarPhase.WaningCrescent, jdPreviousWaningCrescent, dtPreviousWaningCrescent)
      : (source.LunarTruePhase(LunarPhase.WaxingCrescent, out var jdWaxingCrescent) is var dtWaxingCrescent && source.CompareTo(dtNewMoon) >= 0 && source.CompareTo(dtWaxingCrescent) < 0)
      ? (LunarPhase.NewMoon, jdNewMoon, dtNewMoon)
      : (source.LunarTruePhase(LunarPhase.FirstQuarter, out var jdFirstQuarter) is var dtFirstQuarter && source.CompareTo(dtWaxingCrescent) >= 0 && source.CompareTo(dtFirstQuarter) < 0)
      ? (LunarPhase.WaxingCrescent, jdWaxingCrescent, dtWaxingCrescent)
      : (source.LunarTruePhase(LunarPhase.WaxingGibbous, out var jdWaxingGibbous) is var dtWaxingGibbous && source.CompareTo(dtFirstQuarter) >= 0 && source.CompareTo(dtWaxingGibbous) < 0)
      ? (LunarPhase.FirstQuarter, jdFirstQuarter, dtFirstQuarter)
      : (source.LunarTruePhase(LunarPhase.FullMoon, out var jdFullMoon) is var dtFullMoon && source.CompareTo(dtWaxingGibbous) >= 0 && source.CompareTo(dtFullMoon) < 0)
      ? (LunarPhase.WaxingGibbous, jdWaxingGibbous, dtWaxingGibbous)
      : (source.LunarTruePhase(LunarPhase.WaningGibbous, out var jdWaningGibbous) is var dtWaningGibbous && source.CompareTo(dtFullMoon) >= 0 && source.CompareTo(dtWaningGibbous) < 0)
      ? (LunarPhase.FullMoon, jdFullMoon, dtFullMoon)
      : (source.LunarTruePhase(LunarPhase.LastQuarter, out var jdLastQuarter) is var dtLastQuarter && source.CompareTo(dtWaningGibbous) >= 0 && source.CompareTo(dtLastQuarter) < 0)
      ? (LunarPhase.WaningGibbous, jdWaningGibbous, dtWaningGibbous)
      : (source.LunarTruePhase(LunarPhase.WaningCrescent, out var jdWaningCrescent) is var dtWaningCrescent && source.CompareTo(dtLastQuarter) >= 0 && source.CompareTo(dtWaningCrescent) < 0)
      ? (LunarPhase.LastQuarter, jdLastQuarter, dtLastQuarter)
      : (LunarPhase.WaningCrescent, jdWaningCrescent, dtWaningCrescent);
  }
