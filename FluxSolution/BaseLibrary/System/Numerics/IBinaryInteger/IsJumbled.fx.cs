namespace Flux
{
  public static partial class Fx
  {
    ...
    public static bool IsJumbled<TValue>(this TValue value, TValue radix)
      where TValue : System.Numerics.IBinaryInteger<TValue>
    {
      ...
      while (!TValue.IsZero(value))
      {
        ...
        if (TValue.IsZero(value))
          break;
        else if (TValue.Abs((value % radix) - remainder) > TValue.One) // If the difference to the digit is greater than 1, then the number cannot jumbled.
          return false;
      }
