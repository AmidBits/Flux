namespace Flux
{
  public static partial class Fx
  {
    ...
    public static TValue DropLeastSignificantDigits<TValue, TRadix>(this TValue value, TRadix radix, TValue count)
      where TValue : System.Numerics.IBinaryInteger<TValue>
      where TRadix : System.Numerics.IBinaryInteger<TRadix>
      => value / TValue.CreateChecked(Quantities.Radix.AssertMember(radix).FastIntegerPow(count, UniversalRounding.WholeTowardZero, out var _));
    ...
    public static TValue DropMostSignificantDigits<TValue, TRadix>(this TValue value, TRadix radix, TValue count)
      where TValue : System.Numerics.IBinaryInteger<TValue>
      where TRadix : System.Numerics.IBinaryInteger<TRadix>
      => value % TValue.CreateChecked(radix.FastIntegerPow(DigitCount(value, radix) - count, UniversalRounding.WholeTowardZero, out var _));
    ...
    public static TValue KeepMostSignificantDigits<TValue, TRadix>(this TValue value, TRadix radix, TValue count)
      where TValue : System.Numerics.IBinaryInteger<TValue>
      where TRadix : System.Numerics.IBinaryInteger<TRadix>
      => value / TValue.CreateChecked(radix.FastIntegerPow(value.DigitCount(radix) - count, UniversalRounding.WholeTowardZero, out var _));
  }
}
