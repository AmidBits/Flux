namespace Flux
{
  public static partial class Fx
  {
    ...
    public static TSelf Atan2<TSelf>(TSelf y, TSelf x)
      where TSelf : System.Numerics.IFloatingPoint<TSelf>, System.Numerics.IFloatingPointConstants<TSelf>, System.Numerics.ITrigonometricFunctions<TSelf>
    ...
    public static TSelf Atan2Ccw<TSelf>(TSelf y, TSelf x)
      where TSelf : System.Numerics.IFloatingPoint<TSelf>, System.Numerics.IFloatingPointConstants<TSelf>, System.Numerics.ITrigonometricFunctions<TSelf>
      => Atan2(y, x) is var atan2 && atan2 < TSelf.Zero // Call Atan2 as usual, which means 0 is at 3 o'clock and rotating counter-clockwise.
      ? (atan2 + TSelf.Tau) % TSelf.Tau // Adjust the negative portion of atan2, from -Pi..0 into +Pi..+Tau, which is just a matter of adding a full turn (Tau).
    ...
    public static TSelf Atan2Cw<TSelf>(TSelf y, TSelf x)
      where TSelf : System.Numerics.IFloatingPoint<TSelf>, System.Numerics.IFloatingPointConstants<TSelf>, System.Numerics.ITrigonometricFunctions<TSelf>
      => Atan2(x, y) is var atan2s && atan2s < TSelf.Zero // Call Atan2 with the arguments switched, which results in a transposition, where 0 is at noon and rotation is clockwise.
      ? (atan2s + TSelf.Tau) % TSelf.Tau // Adjust the negative portion of atan2, from -Pi..0 into +Pi..+Tau, which is just a matter of adding a full turn (Tau).
    ...
    public static TSelf Gd<TSelf>(this TSelf value)
      where TSelf : System.Numerics.IFloatingPoint<TSelf>, System.Numerics.IHyperbolicFunctions<TSelf>, System.Numerics.ITrigonometricFunctions<TSelf>
    ...
    public static TSelf Coth<TSelf>(this TSelf v)
      where TSelf : System.Numerics.IFloatingPoint<TSelf>, System.Numerics.IHyperbolicFunctions<TSelf>
