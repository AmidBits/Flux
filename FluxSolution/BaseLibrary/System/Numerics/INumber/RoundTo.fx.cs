namespace Flux
{
  ...
  public static partial class Fx
  {
    ...
    public static TNumber RoundToLogOfAwayFromZero<TNumber, TRadix>(this TNumber number, TRadix radix)
      ...
      ? number
      : TNumber.CopySign(TNumber.CreateChecked(double.Log(double.CreateChecked(TNumber.Abs(number)), double.CreateChecked(Quantities.Radix.AssertMember(radix))).RoundFullAwayFromZero()), number);
    ...
    public static TNumber RoundToLogOfTowardZero<TNumber, TRadix>(this TNumber number, TRadix radix)
      ...
      => TNumber.IsZero(number)
      ? number
      : TNumber.CopySign(TNumber.CreateChecked(double.Log(double.CreateChecked(TNumber.Abs(number)), double.CreateChecked(Quantities.Radix.AssertMember(radix))).RoundFullTowardZero()), number);
    ...
    public static TNumber RoundToPowOfAwayFromZero<TNumber, TRadix>(this TNumber number, TRadix radix, bool unequal = false)
      ...
      ? number
      : TNumber.CopySign(TNumber.Abs(number) is var v && r.FastIntegerPow(v.FastIntegerLog(r, UniversalRounding.FullTowardZero, out var _), UniversalRounding.FullTowardZero, out var _) is var p && (p == v ? p : p * r) is var afz && (unequal || !TNumber.IsInteger(number)) && afz == v ? afz * r : afz, number);
    ...
    public static TNumber RoundToPowOfTowardZero<TNumber, TRadix>(this TNumber number, TRadix radix, bool unequal = false)
      ...
      => TNumber.CreateChecked(Quantities.Radix.AssertMember(radix)) is var r && TNumber.IsZero(number)
      ? number
      : TNumber.CopySign(TNumber.Abs(number) is var v && r.FastIntegerPow(v.FastIntegerLog(r, UniversalRounding.FullTowardZero, out var _), UniversalRounding.FullTowardZero, out var _) is var p && (unequal && TNumber.IsInteger(number)) && p == v ? p / r : p, number);
  }
}
