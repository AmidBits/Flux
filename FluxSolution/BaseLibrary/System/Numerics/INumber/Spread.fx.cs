namespace Flux
{
  public static partial class Fx
  {
    ...
    /// <para>This is the opposite of a Clamp( [<paramref name="minValue"/>, <paramref name="maxValue"/>] ) which is inclusive, making the Spread( [<paramref name="lowValue"/>, <paramref name="highValue"/>] ).</para>
    /// </summary>
