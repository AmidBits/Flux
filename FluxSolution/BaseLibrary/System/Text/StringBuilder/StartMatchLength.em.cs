namespace Flux
{
  public static partial class Fx
  {
    ...
    /// </summary>
    public static int StartMatchLength(this System.Text.StringBuilder source, System.Func<char, bool> predicate)
    {
    ...
    /// </summary>
    public static int StartMatchLength(this System.Text.StringBuilder source, char target, System.Collections.Generic.IEqualityComparer<char>? equalityComparer = null)
    {
      System.ArgumentNullException.ThrowIfNull(source);
    ...
    /// <para>Yields the number of characters that the source and the target have in common from the start.</para>
    /// </summary>
    public static int StartMatchLength(this System.Text.StringBuilder source, System.ReadOnlySpan<char> target, System.Collections.Generic.IEqualityComparer<char>? equalityComparer = null)
    {
      System.ArgumentNullException.ThrowIfNull(source);
