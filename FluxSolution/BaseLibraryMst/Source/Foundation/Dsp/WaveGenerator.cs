...
namespace Foundation.Dsp
{
    ...
    public class WaveGenerator
    {
        ...
        {
            Assert.AreEqual(1, m_sineWave.GenerateMonoWaveUi(0.25), Flux.Constants.EpsilonCpp32);
            Assert.AreEqual(-1, m_sineWave.GenerateMonoWaveUi(0.75), Flux.Constants.EpsilonCpp32);
        }
