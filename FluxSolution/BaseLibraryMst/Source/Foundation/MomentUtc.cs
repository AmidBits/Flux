...
namespace Foundation
{
  ...
  public class MomentUtc
  {
    ...
    public void ComputeJulianDateGC()
    {
      ...
      Assert.AreEqual(expected, actual.GeneralUnitValue);
    }
    [TestMethod]
    ...
    public void ToJulianDateGC()
    {
      ...
      Assert.AreEqual(2400000, jd1.GeneralUnitValue);
    }
    [TestMethod]
