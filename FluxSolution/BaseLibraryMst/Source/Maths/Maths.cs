...
namespace Maths
{
  ...
  public class General
  {
    ...
    {
      Assert.AreEqual(1.8, Flux.Maths.ToInterval(1.75, 0.45, Flux.Maths.RoundingBehavior.RoundAwayFromZero), $"{nameof(Flux.Maths.ToInterval)} {Flux.Maths.RoundingBehavior.HalfAwayFromZero}");
    }
