...
namespace Numerics
{
  ...
  {
    readonly System.Numerics.BigInteger bi4 = new(4);
    readonly System.Numerics.BigInteger bi6 = new(6);

    readonly System.Numerics.BigInteger bi24 = new(24);
    readonly System.Numerics.BigInteger bi54 = new(54);
    ...
    {
      Assert.AreEqual("110110", bi54.ToRadixString(2).ToString());
      Assert.AreEqual("36", bi54.ToRadixString(16).ToString());
    }
