...
namespace Units
{
  ...
  public class MomentUtc
  {
    ...
    public void ComputeJulianDateGC()
    {
      ...
      var actual = new Flux.Temporal.JulianDate(m.Year, m.Month, m.Day, m.Hour, m.Minute, m.Second, m.Millisecond, 0, 0, Flux.TemporalCalendar.GregorianCalendar);
    ...
    public void ComputeJulianDateJC()
    {
      ...
      var actual = new Flux.Temporal.JulianDate(m.Year, m.Month, m.Day, m.Hour, m.Minute, m.Second, m.Millisecond, 0, 0, Flux.TemporalCalendar.JulianCalendar);
    ...
    public void ComputeJulianDayNumberGC()
    {
      ...
      Assert.AreEqual(2455877, Flux.Temporal.JulianDayNumber.ConvertDatePartsToJulianDayNumber(m.Year, m.Month, m.Day, Flux.TemporalCalendar.GregorianCalendar));
    }
    [TestMethod]
    public void ComputeJulianDayNumberJC()
    {
      ...
      Assert.AreEqual(12, Flux.Temporal.JulianDayNumber.ConvertDatePartsToJulianDayNumber(m.Year, m.Month, m.Day, Flux.TemporalCalendar.JulianCalendar));
    }
    ...
    {
      var jd1 = new Flux.Temporal.Moment(1858, 11, 16, 12, 0, 0).ToJulianDate(Flux.TemporalCalendar.GregorianCalendar);
      Assert.AreEqual(2400000, jd1.Value);
    }
    [TestMethod]
    public void ToJulianDateProlepticGC()
    {
      var jd1 = new Flux.Temporal.Moment(-423, 10, 4, 12, 0, 0).ToJulianDate(Flux.TemporalCalendar.GregorianCalendar);
      Assert.AreEqual(1566839, jd1.Value);
    }
    [TestMethod]
    public void ToJulianDateJC()
    {
      var jd1 = new Flux.Temporal.Moment(-763, 3, 23, 12, 0, 0).ToJulianDate(Flux.TemporalCalendar.JulianCalendar);
