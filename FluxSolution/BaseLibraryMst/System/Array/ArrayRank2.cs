...
namespace SystemFx
{
  ...
  public class ArrayRank2
  {
    ...
    public void Fill()
    {
      ...
      System.Console.WriteLine(inplaceMatrix.Rank2ToConsole(cso).ToString());
    ...
    public void FlipToCopy()
    {
      ...
      System.Console.WriteLine(matrix.Rank2ToConsole(cso).ToString());
      System.Console.WriteLine();

      var actual0 = matrix.FlipToCopy(0);
      System.Console.WriteLine(nameof(Fx.FlipToCopy));
      System.Console.WriteLine(actual0.Rank2ToConsole(cso).ToString());
      System.Console.WriteLine();
      ...
      System.Console.WriteLine(nameof(Fx.FlipToCopy));
      System.Console.WriteLine(actual1.Rank2ToConsole(cso).ToString());
      System.Console.WriteLine();
    ...
    public void InsertToCopy()
    {
      ...
      System.Console.WriteLine(actual.Rank2ToConsole(cso).ToString());
      System.Console.WriteLine();
