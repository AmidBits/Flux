...
namespace ConsoleApp
{
  class Program
  {
    ...
    {
      var a = "Rob".ToCharArray();
      var l = a.ToList();

      var aros = Flux.Convert.ToReadOnlySpan(a);
      var lros = Flux.Convert.ToReadOnlySpan(l);

      System.Console.WriteLine(string.Join('|', aros.ToString()));
      System.Console.WriteLine(string.Join('|', lros.ToString()));
