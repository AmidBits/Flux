...
namespace ConsoleApp
{
  class Program
  {
    ...
    private static void TimedMain(string[] args)
    {
      ...
      System.Console.WriteLine($"{System.Environment.NewLine}{nameof(os1)}");
      foreach (var item in os1) System.Console.WriteLine(item);

      System.Console.WriteLine($"{System.Environment.NewLine}{nameof(os2)}");
      foreach (var item in os2) System.Console.WriteLine(item);

      System.Console.WriteLine($"{System.Environment.NewLine}{nameof(Flux.SetOps.SetSourceDifference)}");
      foreach (var item in Flux.SetOps.SetSourceDifference(os1, os2)) System.Console.WriteLine(item);

      System.Console.WriteLine($"{System.Environment.NewLine}{nameof(Flux.SetOps.SetSymmetricDifference)}");
      foreach (var item in Flux.SetOps.SetSymmetricDifference(os1, os2)) System.Console.WriteLine(item);

      System.Console.WriteLine($"{System.Environment.NewLine}{nameof(Flux.SetOps.SetTargetDifference)}");
      foreach (var item in Flux.SetOps.SetTargetDifference(os1, os2)) System.Console.WriteLine(item);

      System.Console.WriteLine($"{System.Environment.NewLine}{nameof(Flux.SetOps.SetIntersection)}");
      foreach (var item in Flux.SetOps.SetIntersection(os1, os2)) System.Console.WriteLine(item);

      System.Console.WriteLine($"{System.Environment.NewLine}{nameof(Flux.SetOps.SetUnion)}");
      foreach (var item in Flux.SetOps.SetUnion(os1, os2)) System.Console.WriteLine(item);

      System.Console.WriteLine($"{System.Environment.NewLine}{nameof(Flux.SetOps.SetUnionAll)}");
      foreach (var item in Flux.SetOps.SetUnionAll(os1, os2)) System.Console.WriteLine(item);

      System.Console.WriteLine($"{System.Environment.NewLine}{nameof(Flux.SetOps.SetEquality)}");
      System.Console.WriteLine(Flux.SetOps.SetEquality(os1, os2));

      System.Console.WriteLine($"{System.Environment.NewLine}{nameof(Flux.SetOps.IsSetOverlapping)}");
      System.Console.WriteLine(Flux.SetOps.IsSetOverlapping(os1, os2));

      System.Console.WriteLine($"{System.Environment.NewLine}{nameof(Flux.SetOps.IsSetSubsetOf)}");
      System.Console.WriteLine(Flux.SetOps.IsSetSubsetOf(os1, os2));

      System.Console.WriteLine($"{System.Environment.NewLine}{nameof(Flux.SetOps.IsSetProperSubsetOf)}");
      System.Console.WriteLine(Flux.SetOps.IsSetProperSubsetOf(os1, os2));

      System.Console.WriteLine($"{System.Environment.NewLine}{nameof(Flux.SetOps.IsSetSupersetOf)}");
      System.Console.WriteLine(Flux.SetOps.IsSetSupersetOf(os1, os2));

      System.Console.WriteLine($"{System.Environment.NewLine}{nameof(Flux.SetOps.IsSetProperSupersetOf)}");
