...
namespace ConsoleApp
{
  public static partial class Zamplez
  {
    ...
    public static void RunTemporal()
    {
      ...
      var jdgc = dt.ToJulianDate(Flux.ConversionCalendar.GregorianCalendar);
      System.Console.WriteLine($"{jdgc.ToTimeString()}");
      var jdngc = jdgc.ToJulianDayNumber();
      System.Console.WriteLine($"{jdngc.ToDateString(Flux.ConversionCalendar.GregorianCalendar)}");
      var mugc = jdgc.ToMomentUtc(Flux.ConversionCalendar.GregorianCalendar);
      ...
      var jdjc = dt.ToJulianDate(Flux.ConversionCalendar.JulianCalendar);
      System.Console.WriteLine($"{jdjc.ToTimeString()}");
      var jdnjc = jdjc.ToJulianDayNumber();
      System.Console.WriteLine($"{jdnjc.ToDateString(Flux.ConversionCalendar.JulianCalendar)}");
      var mujc = jdjc.ToMomentUtc(Flux.ConversionCalendar.JulianCalendar);
