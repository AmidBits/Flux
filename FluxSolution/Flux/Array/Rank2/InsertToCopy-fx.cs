namespace Flux
{
  public static partial class Arrays
  {
    ...
    public static T[,] InsertToCopy0<T>(this T[,] source, int index, int count, params T[] pattern)
    {
    ...
    public static T[,] InsertToCopy1<T>(this T[,] source, int index, int count, params T[] pattern)
    {
