namespace Flux.IO.BitStream
{
    ...
    : System.IO.Stream
  {
    ...
    public long BitField => unchecked((long)(m_bitField & BinaryInteger.CreateBitMaskRight((ulong)m_bitCount)));
    ...
    public System.Numerics.BigInteger ReadBits(int bitCount, out int actualBitCount)
    {
      ...
      while (actualBitCount < bitCount)
      {
        ...
        var mask = BinaryInteger.CreateBitMaskRight((ulong)movingBitCount);
    ...
    private long GetBits(int bitCount, out int actualBitCount)
    {
      ...
      var bitField = unchecked((long)((m_bitField >> m_bitCount) & BinaryInteger.CreateBitMaskRight((ulong)actualBitCount)));
