namespace Flux
{
  ...
  {
    public static System.Collections.Generic.IEnumerable<(TSource, TTarget)> CartesianProductPairWith<TSource, TTarget>(this System.Collections.Generic.IEnumerable<TSource> source, System.Collections.Generic.IEnumerable<TTarget> target)
