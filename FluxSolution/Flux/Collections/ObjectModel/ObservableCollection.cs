namespace Flux.Collections.ObjectModel
{
    ...
    where T : System.ComponentModel.INotifyPropertyChanged
  {
    ...
    private void OnItemPropertyChanged(object? sender, System.ComponentModel.PropertyChangedEventArgs e) => OnPropertyChanged(new ComponentModel.PropertyChangedEventArgsEx(e.PropertyName, sender));
  }
}
