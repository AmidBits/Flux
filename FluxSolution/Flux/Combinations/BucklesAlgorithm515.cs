namespace Flux.Combinations
{
  ...
  public static partial class BucklesAlgorithm515
  {
       ...
       where TInteger : System.Numerics.IBinaryInteger<TInteger>
    {
      ...
      var x = TInteger.One;
      var r = CountCombinations(alphabetLength - x, combinationLength - TInteger.One);
      var k = r;

      while (k <= lexiographicIndex)
      {
        x++;
        r = CountCombinations(alphabetLength - x, combinationLength - TInteger.One);
        k += r;
      }
      ...
      {
        x++;
        r = CountCombinations(alphabetLength - x, combinationLength - i);
        k += r;
