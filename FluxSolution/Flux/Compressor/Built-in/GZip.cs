namespace Flux.Compressor
{
  public sealed class GZip
    : ICompressor
  {
    public static ICompressor Default { get; } = new GZip();
    public static ICompressor Max { get; } = new GZip() { ZLibCompressionOptions = new System.IO.Compression.ZLibCompressionOptions() { CompressionLevel = 9 } };
