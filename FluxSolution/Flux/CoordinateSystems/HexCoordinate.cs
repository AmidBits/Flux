namespace Flux.CoordinateSystems
{
  public static class HexCoordinate
  {
    ...
    public static HexCoordinate<TSelf> DiagonalNeighbor<TSelf>(this HexCoordinate<TSelf> source, int direction)
      where TSelf : System.Numerics.INumber<TSelf>
      => HexCoordinate<TSelf>.Diagonal(direction) + source;
    ...
    public static System.Collections.Generic.IEnumerable<CoordinateSystems.HexCoordinate<TSelf>> GetNeighbors<TSelf>(this HexCoordinate<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>
      => HexCoordinate<TSelf>.Directions.Select(d => d + source);
    ...
    public static System.Collections.Generic.IEnumerable<CoordinateSystems.HexCoordinate<TSelf>> GetRange<TSelf>(this HexCoordinate<TSelf> source, TSelf radius)
    ...
    public static System.Collections.Generic.IEnumerable<CoordinateSystems.HexCoordinate<TSelf>> GetRing<TSelf>(this HexCoordinate<TSelf> source, TSelf radius, int startDirection = 0, bool isCounterClockWise = false)
      where TSelf : System.Numerics.IBinaryInteger<TSelf>
    {
      ...
      else if (radius > TSelf.Zero)
      {
        ...
        var corner = HexCoordinate<TSelf>.Direction(startDirection) * radius + source; // Find the first corner hex, relative center in direction of choice (plus the length of the radius).
        ...
        for (var index = 0; index < 6; index++)
        {
          ...
          for (var deltaIndex = TSelf.One; deltaIndex < radius; deltaIndex++) // Enumerate the 'side of the current corner hex'.
            yield return HexCoordinate<TSelf>.Direction(deltaDirection) * deltaIndex + corner; // Compute the direction and offset of the side.
    ...
    public static HexCoordinate<TSelf> Lerp<TSelf>(this HexCoordinate<TSelf> source, HexCoordinate<TSelf> target, TSelf mu)
    ...
    public static HexCoordinate<TSelf> Neighbor<TSelf>(this HexCoordinate<TSelf> source, int direction)
      where TSelf : System.Numerics.INumber<TSelf>
      => source + HexCoordinate<TSelf>.Direction(direction);
    ...
    public static HexCoordinate<TSelf> NextCornerCw<TSelf>(this HexCoordinate<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>
    ...
    public static HexCoordinate<TSelf> NextCornerCcw<TSelf>(this HexCoordinate<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>
    ...
    public static HexCoordinate<TTarget> Round<TSource, TTarget>(TSource sq, TSource sr, TSource ss, HalfRounding mode, out TTarget tq, out TTarget tr, out TTarget ts)
      ...
      where TTarget : System.Numerics.INumber<TTarget>
    {
      var rQ = FloatingPoints.RoundHalf(sq, mode);
      var rR = FloatingPoints.RoundHalf(sr, mode);
      var rS = FloatingPoints.RoundHalf(ss, mode);
    ...
    public static (double x, double y, double z) ToCartesianCoordinate3<TSelf>(this HexCoordinate<TSelf> source)
      where TSelf : System.Numerics.INumber<TSelf>
      => new(double.CreateChecked(source.Q), double.CreateChecked(source.R), double.CreateChecked(source.S));

    public static void ToHexCoordinate<TSelf, TResult>(this HexCoordinate<TSelf> source, out HexCoordinate<TResult> result)
      where TSelf : System.Numerics.IBinaryInteger<TSelf>
      where TResult : System.Numerics.INumber<TResult>
      => result = new(
    ...
    public static HexCoordinate<TResult> ToHexCoordinate<TSelf, TResult>(this HexCoordinate<TSelf> source, out TResult q, out TResult r, out TResult s)
      where TSelf : System.Numerics.IBinaryInteger<TSelf>
      where TResult : System.Numerics.INumber<TResult>
    {
      var (sq, sr, ss) = source;

      HexCoordinate.Convert(sq, sr, ss, out q, out r, out s);
    ...
    public static System.Collections.Generic.IEnumerable<System.Collections.Generic.IEnumerable<HexCoordinate<TSelf>>> TraverseSpiral<TSelf>(this HexCoordinate<TSelf> source, TSelf radius)
      where TSelf : System.Numerics.IBinaryInteger<TSelf>
    {
    ...
    public static HexCoordinate<int> ToHexCoordinate(this System.Drawing.Point source)
      => new(
        source.X,
        source.Y
      );
    ...
    public static HexCoordinate<float> ToHexCoordinate(this System.Numerics.Vector2 source)
      => new(
        source.X,
        source.Y
      );
    ...
    public static HexCoordinate<float> ToHexCoordinate(this System.Numerics.Vector3 source)
      => new(
        source.X,
        source.Y,
        source.Z
    ...
    where TSelf : System.Numerics.INumber<TSelf>
  {
    ...
    public static int ComputeRangeCount(int radius)
      => Numbers.LoopRange(0, 6, radius + 1).AsParallel().Sum() + 1;
    ...
    public readonly string ToString(string? format, System.IFormatProvider? formatProvider)
    {
      ...
      return $"<{m_q.ToString(format, formatProvider)}, {m_r.ToString(format, formatProvider)}, {m_s.ToString(format, formatProvider)}>";
    }
