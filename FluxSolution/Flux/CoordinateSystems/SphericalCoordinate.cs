namespace Flux.CoordinateSystems
{
    ...
    : System.IFormattable
  {
    ...
    public string ToString(string? format, System.IFormatProvider? formatProvider)
      => $"<{Radius.ToString(format ?? BinaryInteger.CreateFormatStringWithCountDecimals(3), formatProvider)}, {Inclination.ToUnitString(Units.AngleUnit.Degree, format ?? BinaryInteger.CreateFormatStringWithCountDecimals(6), formatProvider)} / {Elevation.ToUnitString(Units.AngleUnit.Degree, format ?? BinaryInteger.CreateFormatStringWithCountDecimals(6), formatProvider)}, {Azimuth.ToUnitString(Units.AngleUnit.Degree, format ?? BinaryInteger.CreateFormatStringWithCountDecimals(6), formatProvider)}>";
