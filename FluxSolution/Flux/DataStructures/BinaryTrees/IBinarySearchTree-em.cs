namespace Flux
{
  public static partial class Em
  {
    ...
    /// </summary>
    public static int GetLevelOf<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source, TKey key)
      where TKey : System.IComparable<TKey>
    {
      return GetLevelOfKey(source, key, 1);

      int GetLevelOfKey(DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source, TKey key, int level = 1)
      {
    ...
    public static DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> GetMaximum<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source)
      where TKey : System.IComparable<TKey>
    {
    ...
    public static DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> GetMinimum<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source)
      where TKey : System.IComparable<TKey>
    {
      System.ArgumentNullException.ThrowIfNull(source);
    ...
    public static DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> GetPredecessor<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source)
      where TKey : System.IComparable<TKey>
    {
      System.ArgumentNullException.ThrowIfNull(source);
    ...
    public static DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> GetSuccessor<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source)
      where TKey : System.IComparable<TKey>
    {
      System.ArgumentNullException.ThrowIfNull(source);
    ...
    /// </summary>
    public static TSummable GetTreeSum<TKey, TValue, TSummable>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source, System.Func<TKey, TValue, TSummable> summableSelector)
      where TKey : System.IComparable<TKey>
    ...
    /// <returns></returns>
    public static bool IsBst<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source)
      where TKey : System.IComparable<TKey>
    {
      System.ArgumentNullException.ThrowIfNull(source);
    ...
    public static bool IsBstByKey<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source, TKey minKey, TKey maxKey, System.Func<TKey, TKey> keyDecrementor, System.Func<TKey, TKey> keyIncrementor)
      where TKey : System.IComparable<TKey>
    {
      System.ArgumentNullException.ThrowIfNull(source);
    ...
    public static bool IsSumTree<TKey, TValue, TSummable>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source, System.Func<TKey, TValue, TSummable> summableSelector)
      where TKey : System.IComparable<TKey>
      where TSummable : System.Numerics.INumber<TSummable>
    {
      if (source.IsLeaf())
    ...
    public static int Minimax<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source, int depth, bool isMax, int maxHeight, System.Func<TKey, TValue, int> valueSelector)
      where TKey : System.IComparable<TKey>
    {
      System.ArgumentNullException.ThrowIfNull(source);
    ...
    /// <returns></returns>
    public static System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<TKey, TValue>> TraverseBfsLevelOrder<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source, int maxDepth)
      where TKey : System.IComparable<TKey>
    {
      System.ArgumentNullException.ThrowIfNull(source);
      ...
      var level = new System.Collections.Generic.Queue<DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue>>();
      level.Enqueue(source);

      for (var depth = 0; level.Count > 0 && depth < maxDepth; depth++)
      {
        var nextLevel = new System.Collections.Generic.Queue<DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue>>();
    ...
    /// <param name="source"></param>
    /// <returns></returns>
    public static System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<TKey, TValue>[]> TraverseBfsLevelOrderChunked<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source)
      where TKey : System.IComparable<TKey>
    {
      System.ArgumentNullException.ThrowIfNull(source);
    ...
    /// <param name="source"></param>
    /// <returns></returns>
    public static System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<TKey, TValue>> TraverseDfsInOrder<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source)
      where TKey : System.IComparable<TKey>
    {
      System.ArgumentNullException.ThrowIfNull(source);
      ...
      var stack = new System.Collections.Generic.Stack<DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue>>();
    ...
    /// <param name="source"></param>
    /// <returns></returns>
    public static System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<TKey, TValue>> TraverseDfsInReverseOrder<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source)
      where TKey : System.IComparable<TKey>
    {
      System.ArgumentNullException.ThrowIfNull(source);
    ...
    /// <param name="source"></param>
    /// <returns></returns>
    public static System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<TKey, TValue>> TraverseDfsPostOrder<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source)
      where TKey : System.IComparable<TKey>
    {
      System.ArgumentNullException.ThrowIfNull(source);
      ...
      var lastNodeVisited = default(DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue>);
    ...
    /// <param name="source"></param>
    /// <returns></returns>
    public static System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<TKey, TValue>> TraverseDfsPreOrder<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source)
      where TKey : System.IComparable<TKey>
    {
      System.ArgumentNullException.ThrowIfNull(source);
    ...
    /// <param name="source"></param>
    /// <returns></returns>
    public static System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<TKey, TValue>> TraverseDiagonal<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source)
      where TKey : System.IComparable<TKey>
    {
      System.ArgumentNullException.ThrowIfNull(source);

      var queue = new System.Collections.Generic.Queue<DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue>>(); // The leftQueue will be a queue which will store all left pointers while traversing the tree, and will be utilized when at any point right pointer is empty.
    ...
    /// <param name="source"></param>
    /// <returns></returns>
    public static System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<TKey, TValue>> TraversePerimeter<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source)
      where TKey : System.IComparable<TKey>
    {
      System.ArgumentNullException.ThrowIfNull(source);
      ...
      static System.Collections.Generic.IEnumerable<DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue>> AddLeftBound(DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> root)
      {
        root = root.Left;
      ...
      static System.Collections.Generic.IEnumerable<DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue>> AddRightBound(DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> root)
      {
        root = root.Right;

        var stack = new Stack<DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue>>(); // As we need the reverse of this for counter-clockwise.
      ...
      static System.Collections.Generic.IEnumerable<DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue>> AddLeaves(DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> root)
      {
        if (root.IsEmpty)
          yield break;
    ...
    /// <param name="source"></param>
    /// <returns></returns>
    public static System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<TKey, TValue>> TraverseZigZag<TKey, TValue>(this DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue> source)
      where TKey : System.IComparable<TKey>
    {
      System.ArgumentNullException.ThrowIfNull(source);
      ...
      var currentLevel = new Stack<DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue>>();
      var nextLevel = new Stack<DataStructures.BinaryTrees.IBinarySearchTree<TKey, TValue>>();
