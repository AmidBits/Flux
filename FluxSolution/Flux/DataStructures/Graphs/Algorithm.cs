namespace Flux.DataStructures.Graphs
{
  public static class Algorithm
  {
    ...
    public static (double[] Distance, int[] Predecessor) BellmanFordShortestPaths(System.ReadOnlySpan<int> vertices, System.ReadOnlySpan<(int x, int y, double w)> edges, int origin)
    {
      ...
      distance[origin] = 0; // The distance from the source to itself is zero.
    ...
    /// <param name="origin"></param>
    /// <returns></returns>
    public static (double[] Distance, int[] Predecessor) DijkstraShortestPaths(System.ReadOnlySpan<int> vertices, System.ReadOnlySpan<(int x, int y, double w)> edges, int origin)
    {
      ...
      dist[origin] = 0; // The distance from the source to itself is zero.
