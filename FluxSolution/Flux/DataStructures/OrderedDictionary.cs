namespace Flux
{
  public static partial class Fx
  {
    ...
    /// <summary>
    /// <para>Creates a new <see cref="DataStructures.OrderedDictionary{TKey, TValue}"/> with all key-value-pairs from <paramref name="source"/>.</para>
    /// </summary>
    /// <typeparam name="TKey"></typeparam>
    /// <typeparam name="TValue"></typeparam>
    /// <param name="source"></param>
    /// <param name="equalityComparer"></param>
    /// <returns></returns>
    public static DataStructures.OrderedDictionary<TKey, TValue> ToOrderedDictionary<TKey, TValue>(this System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<TKey, TValue>> source, System.Collections.Generic.IEqualityComparer<TKey>? equalityComparer = null)
      where TKey : notnull
