namespace Flux
{
  public static partial class DateTimes
  {
    ...
    public static long ToUnixTimestamp(this System.DateTime source) => (long)(source - UnixEpoch).TotalSeconds;
    ...
    public static long ToUnixUltraTimestamp(this System.DateTime source) => (long)(source - UnixEpoch).TotalMilliseconds;
  }
}
