namespace Flux
{
  public static partial class Decimals
  {
    ...
    public static (decimal IntegerPart, decimal FractionalPart, decimal FractionalPartAsWholeNumber) GetParts(this decimal number)
    {
      var integralPart = decimal.Truncate(number);
      var fractionalPart = number - integralPart;

      return (integralPart, fractionalPart, fractionalPart * (decimal)System.Numerics.BigInteger.Pow(10, System.BitConverter.GetBytes(decimal.GetBits(number)[3])[2]));
    }
  }
}
