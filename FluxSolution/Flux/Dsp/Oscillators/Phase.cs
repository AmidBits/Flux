namespace Flux.Dsp.Oscillators
{
  public record class Phase
  {
    ...
    public double Offset { get => m_offset; set => m_offset = value.Wrap(m_minimumPhase, m_maximumPhase, IntervalNotation.Closed); }
    ...
    public double Position { get => m_position; set => m_position = value.Wrap(m_minimumPhase, m_maximumPhase, IntervalNotation.Closed); }
    ...
    public void Update(double? normalizedFrequency)
    {
      ...
      m_position = (m_position + shift).Wrap(m_minimumPhase, m_maximumPhase, IntervalNotation.Closed);
    }
  }
}
