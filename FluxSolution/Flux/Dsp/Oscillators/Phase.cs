namespace Flux.Dsp.Oscillators
{
  public record class Phase
  {
    ...
    public double Offset { get => m_offset; set => m_offset = Number.WrapAround(value, m_minimumPhase, m_maximumPhase); }
    ...
    public double Position { get => m_position; set => m_position = Number.WrapAround(value, m_minimumPhase, m_maximumPhase); }
    ...
    public void Update(double? normalizedFrequency)
    {
      ...
      m_position = Number.WrapAround(m_position + shift, m_minimumPhase, m_maximumPhase);
    }
  }
}
