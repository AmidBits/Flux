namespace Flux.Dsp.Oscillators
{
  public record class Phase
  {
    ...
    public double Offset { get => m_offset; set => m_offset = value.WrapAround(m_minimumPhase, m_maximumPhase); }
    ...
    public double Position { get => m_position; set => m_position = value.WrapAround(m_minimumPhase, m_maximumPhase); }
    ...
    public void Update(double? normalizedFrequency)
    {
      ...
      m_position = (m_position + shift).WrapAround(m_minimumPhase, m_maximumPhase);
    }
  }
}
