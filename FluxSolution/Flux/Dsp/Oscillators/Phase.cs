namespace Flux.Dsp.Oscillators
{
  public record class Phase
  {
    ...
    public double Offset { get => m_offset; set => m_offset = INumber.WrapAround(value, m_minimumPhase, m_maximumPhase); }
    ...
    public double Position { get => m_position; set => m_position = INumber.WrapAround(value, m_minimumPhase, m_maximumPhase); }
    ...
    public void Update(double? normalizedFrequency)
    {
      ...
      m_position = INumber.WrapAround(m_position + shift, m_minimumPhase, m_maximumPhase);
    }
  }
}
