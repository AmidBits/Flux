namespace Flux.Dsp.Oscillators
{
  public record class Phase
  {
    ...
    public double Offset { get => m_offset; set => m_offset = IntervalNotation.Closed.Wrap(value, m_minimumPhase, m_maximumPhase); }
    ...
    public double Position { get => m_position; set => m_position = IntervalNotation.Closed.Wrap(value, m_minimumPhase, m_maximumPhase); }
    ...
    public void Update(double? normalizedFrequency)
    {
      ...
      m_position = IntervalNotation.Closed.Wrap(m_position + shift, m_minimumPhase, m_maximumPhase);
    }
  }
}
