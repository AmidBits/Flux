    ...
    : IMonoWaveProcessable
  {
    ...
    public double Contour
    {
      ...
      set
      {
        ...
        m_contourScaled = m_contour > Numerics.Constants.EpsilonCpp32 || m_contour < -Numerics.Constants.EpsilonCpp32 ? m_contour * 0.1 + 1 : 0;
      }
    }
    ...
    public static double ApplyCurvature(double sample, double contour)
      => (contour > Numerics.Constants.EpsilonCpp32 || contour < -Numerics.Constants.EpsilonCpp32) && contour * 0.1 + 1.0 is var contourScaled
