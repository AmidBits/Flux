namespace Flux
{
  public static partial class ArrayExtensions
  {
    extension(System.Array)
    {
      ...
      public static T[,] ConcatToCopy<T>(ArrayAxis dimension, T[,] source, T[,] other)
      {
      ...
      /// <param name="length"></param>
      /// <remarks>Since an two-dimensional array is arbitrary in terms of its dimensions (e.g. rows and columns) and .NET is row-major order, the concept of [row, column] is adopted, i.e. dimension-0 = row, and dimension-1 = column.</remarks>
      public static void Copy<T>(ArrayAxis dimension, T[,] source, int sourceIndex, T[,] target, int targetIndex, int length)
      {
        switch (dimension)
        {
          case ArrayAxis.Row:
      ...
      public static void Fill<T>(ArrayAxis dimension, T[,] source, int index, int length, System.Func<T, bool> predicate, params System.ReadOnlySpan<T> pattern)
      {
        switch (dimension)
        {
          case ArrayAxis.Row:
      ...
      /// <exception cref="System.ArgumentException"></exception>
      /// <remarks>Since an two-dimensional array is arbitrary in terms of its dimensions (e.g. rows and columns) and .NET is row-major order, the concept of [row, column] is adopted, i.e. dimension-0 = row, and dimension-1 = column.</remarks>
      public static void Flip<T>(ArrayAxis dimension, T[,] source, T[,]? target = null)
      {
        System.Array.AssertRank(source, 2);
      ...
      public static T[,] InsertBySkipping<T>(ArrayAxis dimension, System.Func<int, bool> predicate, T[,] source, T[,]? target = null)
      {
        System.ArgumentNullException.ThrowIfNull(predicate);
      ...
      /// <returns></returns>
      /// <exception cref="System.NotImplementedException"></exception>
      public static T[,] RemoveBySkipping<T>(ArrayAxis dimension, System.Func<int, bool> predicate, T[,] source, T[,]? target = null)
      {
        System.ArgumentNullException.ThrowIfNull(predicate);
      ...
      public static string Rank2ToConsoleString<T>(T[,] source, ConsoleFormatOptions? options = null)
      {
        ...
        for (var r = 0; r < rows; r++) // Consider row as dimension 0.
        {
          ...
          var horizontalString = options.CreateHorizontalString(Rank2StrandToRank1(ArrayAxis.Row, source, r), maxWidths, horizontalFormat);
      ...
      /// <returns></returns>
      /// <exception cref="System.NotImplementedException"></exception>
      public static T[] Rank2StrandToRank1<T>(ArrayAxis dimension, T[,] source, int index)
      {
        System.Array.AssertRank(source, 2);
      ...
      /// <returns></returns>
      /// <exception cref="System.NotImplementedException"></exception>
      public static T[] Rank2ToRank1<T>(ArrayAxis dimension, T[,] source)
      {
        System.Array.AssertRank(source, 2);
        ...
        if (dimension is ArrayAxis.Column) // If not row first..
    ...
    #region 2-Dimensional array specific functionality
    ...
    #region Jagged array specific functionality
