namespace Flux
{
  ...
  {
    extension(System.Numerics.Matrix4x4 source)
    {
      ...
      public System.Numerics.Matrix4x4 GetInverseGeneral()
      {
        var det = float.CreateChecked(1.0 / GetDeterminantGeneral(source));
      ...
      public Numerics.EuclideanRotations.EulerAngles ToEulerAnglesTaitBryanZYX()
        => new(
      ...
      public Numerics.EuclideanRotations.EulerAngles ToEulerAnglesProperEulerZXZ()
        => new(
      ...
      /// <param name="result">If successful, contains the inverted matrix.</param>
      /// <returns>True if the source matrix could be inverted; False otherwise.</returns>
      public bool TryGetInverseOptimized(out System.Numerics.Matrix4x4 result)
      {
        //                                       -1
        // If you have matrix M, inverse Matrix M   can compute
        //
