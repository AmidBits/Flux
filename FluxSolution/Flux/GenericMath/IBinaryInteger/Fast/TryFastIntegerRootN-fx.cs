namespace Flux
{
  public static partial class GenericMathFast
  {
    ...
    public static bool TryFastIntegerRootN<TINumber, TINth, TIRoot>(this TINumber value, TINth nth, UniversalRounding mode, out TIRoot integerRoot, out double rootn)
