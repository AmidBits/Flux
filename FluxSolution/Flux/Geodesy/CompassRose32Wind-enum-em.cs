namespace Flux
{
  public static partial class Em
  {
    ...
    public static Geodesy.Azimuth GetAzimuth(this Geodesy.CompassRose32Wind source) => new(11.25 * (int)source);

    public static System.Collections.Generic.List<string> ToWords(this Geodesy.CompassRose32Wind source)
    {
      var list = new System.Collections.Generic.List<string>();

      var s = source.ToString();

      var words = System.Enum.GetNames<Geodesy.WordsOfTheCompass>();
