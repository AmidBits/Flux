namespace Flux
{
  public static partial class Em
  {
    ...
    /// <returns></returns>
    public static System.DateTime LunarTruePhase(this System.DateTime source, Geodesy.LunarPhase lunarPhase, out Temporal.JulianDate julianDate)
    ...
    /// <returns></returns>
    public static (Geodesy.LunarPhase LunarPhase, Temporal.JulianDate JulianDate, System.DateTime DateTime) GetLunarPhaseAndDate(this System.DateTime source)
      => (source.LunarTruePhase(Geodesy.LunarPhase.NewMoon, out var jdNewMoon) is var dtNewMoon && source.CompareTo(dtNewMoon) < 0
      ...
      && source.AddHours(-43).LunarTruePhase(Geodesy.LunarPhase.WaningCrescent, out var jdPreviousWaningCrescent) is var dtPreviousWaningCrescent && source.CompareTo(dtPreviousWaningCrescent) >= 0)
      ? (Geodesy.LunarPhase.WaningCrescent, jdPreviousWaningCrescent, dtPreviousWaningCrescent)
      : (source.LunarTruePhase(Geodesy.LunarPhase.WaxingCrescent, out var jdWaxingCrescent) is var dtWaxingCrescent && source.CompareTo(dtNewMoon) >= 0 && source.CompareTo(dtWaxingCrescent) < 0)
      ? (Geodesy.LunarPhase.NewMoon, jdNewMoon, dtNewMoon)
      : (source.LunarTruePhase(Geodesy.LunarPhase.FirstQuarter, out var jdFirstQuarter) is var dtFirstQuarter && source.CompareTo(dtWaxingCrescent) >= 0 && source.CompareTo(dtFirstQuarter) < 0)
      ? (Geodesy.LunarPhase.WaxingCrescent, jdWaxingCrescent, dtWaxingCrescent)
      : (source.LunarTruePhase(Geodesy.LunarPhase.WaxingGibbous, out var jdWaxingGibbous) is var dtWaxingGibbous && source.CompareTo(dtFirstQuarter) >= 0 && source.CompareTo(dtWaxingGibbous) < 0)
      ? (Geodesy.LunarPhase.FirstQuarter, jdFirstQuarter, dtFirstQuarter)
      : (source.LunarTruePhase(Geodesy.LunarPhase.FullMoon, out var jdFullMoon) is var dtFullMoon && source.CompareTo(dtWaxingGibbous) >= 0 && source.CompareTo(dtFullMoon) < 0)
      ? (Geodesy.LunarPhase.WaxingGibbous, jdWaxingGibbous, dtWaxingGibbous)
      : (source.LunarTruePhase(Geodesy.LunarPhase.WaningGibbous, out var jdWaningGibbous) is var dtWaningGibbous && source.CompareTo(dtFullMoon) >= 0 && source.CompareTo(dtWaningGibbous) < 0)
      ? (Geodesy.LunarPhase.FullMoon, jdFullMoon, dtFullMoon)
      : (source.LunarTruePhase(Geodesy.LunarPhase.LastQuarter, out var jdLastQuarter) is var dtLastQuarter && source.CompareTo(dtWaningGibbous) >= 0 && source.CompareTo(dtLastQuarter) < 0)
      ? (Geodesy.LunarPhase.WaningGibbous, jdWaningGibbous, dtWaningGibbous)
      : (source.LunarTruePhase(Geodesy.LunarPhase.WaningCrescent, out var jdWaningCrescent) is var dtWaningCrescent && source.CompareTo(dtLastQuarter) >= 0 && source.CompareTo(dtWaningCrescent) < 0)
      ? (Geodesy.LunarPhase.LastQuarter, jdLastQuarter, dtLastQuarter)
      : (Geodesy.LunarPhase.WaningCrescent, jdWaningCrescent, dtWaningCrescent);
  }
