namespace Flux
{
  ...
  public static partial class Fx
  {
    ...
    public static Geometry.Coordinates.CartesianCoordinate ToCartesianCoordinate(this System.Runtime.Intrinsics.Vector256<double> source) => new(source[0], source[1], source[2], source[3]);
    ...
    public static Geometry.Coordinates.CartesianCoordinate ToCartesianCoordinate1(this System.Runtime.Intrinsics.Vector256<double> source, double y = 0, double z = 0, double w = 0) => new(source[0], y, z, w);
    ...
    public static Geometry.Coordinates.CartesianCoordinate ToCartesianCoordinate2(this System.Runtime.Intrinsics.Vector256<double> source, double z = 0, double w = 0) => new(source[0], source[1], z, w);
    ...
    public static Geometry.Coordinates.CartesianCoordinate ToCartesianCoordinate3(this System.Runtime.Intrinsics.Vector256<double> source, double w = 0) => new(source[0], source[1], source[2], w);
  }
