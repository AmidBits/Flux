namespace Flux
{
  public static partial class Em
  {
    ...
    public static (Geometry.CoordinateSystems.CartesianCoordinate axis, Units.Angle angle) ToQuantities(this Geometry.Rotations.AxisAngle source)
      => (
    ...
    {
      var (s, w) = double.SinCos(source.Angle.Value / 2);
