namespace Flux.Geometry.Shapes.Line
{
  /// <summary>
    ...
    : System.IFormattable
  {
    ...
    public LineGeometry(System.Runtime.Intrinsics.Vector128<double> v0, System.Runtime.Intrinsics.Vector128<double> v1)
    {
      m_v0 = v0;
      m_v1 = v1;
    }
    public LineGeometry(double x0, double y0, double x1, double y1)
    {
    ...
    public LineSegmentGeometry ToLineSegmentGeometry() => new(m_v0, m_v1);
    ...
    /// </summary>
    public static Numerics.Slope TwoPointSlope(double x0, double y0, double x1, double y1) => new((x0 - x1) / (y0 - y1));
