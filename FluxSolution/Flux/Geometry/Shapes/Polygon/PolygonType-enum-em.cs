namespace Flux
{
  public static partial class Fx
  {
    ...
    /// <returns></returns>
    public static double GetRegularPolygonAreaByApothem(this Geometry.Shapes.Polygon.PolygonType source, double apothem) => (int)source * (apothem * apothem) * double.Tan(double.Pi / (int)source);
    ...
    /// <param name="apothem"></param>
    /// <returns></returns>
    public static double GetRegularPolygonCircumradiusByApothem(this Geometry.Shapes.Polygon.PolygonType source, double apothem) => apothem / double.Cos(double.Pi / (int)source);

    /// <summary></summary>
    /// <param name="source"></param>
    /// <param name="sideLength"></param>
    /// <returns></returns>
    public static double GetRegularPolygonCircumradiusBySideLength(this Geometry.Shapes.Polygon.PolygonType source, double sideLength) => sideLength / (2 * double.Sin(double.Pi / (int)source));

    /// <summary></summary>
    /// <see href="https://en.wikipedia.org/wiki/Regular_polygon#Angles"/>
    /// <returns></returns>
    public static Units.Angle GetRegularPolygonInteriorAngle(this Geometry.Shapes.Polygon.PolygonType source) => new(((int)source - 2) * double.Pi / ((int)source));
    ...
    public static int GetSchläfliSymbol(this Geometry.Shapes.Polygon.PolygonType source) => (int)source;
