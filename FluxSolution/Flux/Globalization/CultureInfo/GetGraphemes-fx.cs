...
//    private static readonly string[][][] m_graphemes_en = new string[][][]
//    {
...
//    public static System.Collections.Generic.IList<string> GetGraphemes(this System.Globalization.CultureInfo source)
//    {
//      source ??= System.Globalization.CultureInfo.CurrentCulture;

//      return source.TwoLetterISOLanguageName switch
//      {
//        "en" => m_graphemes_en.SelectMany(aa => aa.SelectMany(a => a)).ToList(),
