namespace Flux
{
    ...
    where T : System.IComparable<T>
  {
    ...
    public T AssertWithin(T radix, IntervalNotation notation = IntervalNotation.Closed, string? paramName = null) => notation.AssertWithinInterval(radix, m_minValue, m_maxValue, paramName);

    public bool IsWithin(T radix, IntervalNotation notation = IntervalNotation.Closed) => notation.IsWithinInterval(radix, m_minValue, m_maxValue);
