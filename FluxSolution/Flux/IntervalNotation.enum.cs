namespace Flux
{
  ...
  public static partial class Em
  {
    ...
    public static T AssertMember<T>(this IntervalNotation source, T value, T minValue, T maxValue, string? paramName = null)
      where T : System.IComparable<T>
      => source.IsMember(value, minValue, maxValue) ? value : throw new System.ArgumentOutOfRangeException(paramName ?? nameof(value), $"The value ({value}) is not a member of the interval: {source.ToNotationString(minValue, maxValue)}.");
    ...
    public static bool IsMember<T>(this IntervalNotation source, T value, T minValue, T maxValue)
      where T : System.IComparable<T>
    {
      try
      {
