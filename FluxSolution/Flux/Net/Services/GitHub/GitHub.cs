namespace Flux.Net.Services.GitHub
{
  ...
  public sealed class GitHubEntry
  {
    ...
    public override string ToString()
      => Type switch
      {
        ...
        GitHubType.Directory => $"{Type} ({Size}) \"{System.IO.Directory.GetParent(Url.LocalPath)?.Name ?? @"[NoName]"}\" <{Url}>",
  ...
  public static class GitHubApi
  {
    ...
    public static System.Collections.Generic.IEnumerable<GitHubEntry> GetEntries(System.Uri uri)
    {
      ...
      hc.DefaultRequestHeaders.UserAgent.Add(new System.Net.Http.Headers.ProductInfoHeaderValue(System.AppDomain.CurrentDomain.FriendlyName, System.Environment.Version.ToString()));
