...
#if DEBUG // Console chat sample.

    /// <summary>
    /// <para>If <paramref name="multicastAddress"/> is null, use test endpoint address: <c>224.5.6.7:4567</c></para>
    /// </summary>
    /// <param name="multicastAddress"></param>
    public static void ConsoleChat(System.Net.IPEndPoint? multicastAddress = null)
    {
      multicastAddress ??= new System.Net.IPEndPoint(System.Net.IPAddress.Parse(@"224.5.6.7"), 4567);
      ...
      IPAddressExtensions.TryGetMyLocalAddress(out var myLocalAddress);
