namespace Flux
{
  ...
  {
    extension<TInteger>(TInteger) // Static type members.
      where TInteger : System.Numerics.IBinaryInteger<TInteger>
    {
      ...
      public static System.Collections.Generic.IEnumerable<(TInteger Number, TInteger Sum)> GetAbundantNumbers()
        => Numbers.LoopVerge(TInteger.CreateChecked(3), TInteger.One).AsParallel().AsOrdered().Select(n => (n, sum: SumDivisors(n).AliquotSum)).Where(x => x.sum > x.n);
      ...
      public static System.Collections.Generic.IEnumerable<TInteger> GetCatalanSequence()
        => Numbers.LoopVerge(TInteger.Zero, TInteger.One).AsParallel().AsOrdered().Select(GetCatalanNumber);
      ...
      public static System.Collections.Generic.IEnumerable<TInteger> GetCenteredPolygonalNumberSequence(TInteger k)
        => Numbers.LoopVerge(TInteger.Zero, TInteger.One).Select(n => GetCenteredPolygonalNumber(k, n));
      ...
      public static System.Collections.Generic.IEnumerable<TInteger> GetCompositeNumbers()
        => Numbers.LoopVerge(TInteger.One, TInteger.One).AsParallel().AsOrdered().Where(IsComposite);
      ...
      public static System.Collections.Generic.IEnumerable<(TInteger Number, TInteger Count)> GetHighlyCompositeNumbers()
      {
        ...
        foreach (var tuple in Numbers.LoopVerge(TInteger.One, TInteger.One).AsParallel().AsOrdered().Select(n => (Number: n, Count: CountDivisors(n))))
      ...
      /// <param name="number"></param>
      /// <returns></returns>
      public static bool IsComposite(TInteger n)
      {
      ...
      /// <returns></returns>
      public static double ConvertToFraction<TRadix>(TInteger value, TRadix radix)
        where TRadix : System.Numerics.IBinaryInteger<TRadix>
      {
        var fdc = Units.Radix.DigitCount(value, radix);

        var fip = Pow(radix, fdc);
      ...
      public static TInteger CountCombinationsWithRepetition(TInteger n, TInteger k)
        => BinaryIntegers.BinomialCoefficient((n + k - TInteger.One), k);
      ...
      public static TInteger CountCombinationsWithoutRepetition(TInteger n, TInteger k)
        => BinaryIntegers.BinomialCoefficient(n, k);
      ...
      public static TInteger CountPermutationsWithoutRepetition(TInteger n, TInteger k)
        => BinaryIntegers.FallingFactorial(n, k);

      #endregion

      // Function to count multiples of 'baseNum' below 'limit'
      public static TInteger CountMultiplesIn(TInteger multiple, TInteger maxLimit)
      {
        System.ArgumentOutOfRangeException.ThrowIfZero(multiple);
        System.ArgumentOutOfRangeException.ThrowIfZero(maxLimit);

        //if (maxLimit <= TInteger.Zero)
        //  return TInteger.Zero; // No multiples below a non-positive limit

        // Use absolute value to handle negative base numbers
        return (TInteger.Abs(maxLimit) - TInteger.One) / TInteger.Abs(multiple);
      }
      ...
      public static (TInteger Quotient, TInteger Remainder) EuclideanDivRem(TInteger a, TInteger n)
      {
        ...
        var q = TInteger.CreateChecked(Numbers.Sign(n)) * ((TInteger.IsNegative(a) == TInteger.IsNegative(n) ? a : (a - (n - TInteger.CopySign(TInteger.One, n)))) / n);
      ...
      /// <returns></returns>
      public static void GetDivisors(TInteger n, System.Collections.Generic.ICollection<TInteger> divisors)
      {
        if (n > TInteger.Zero)
      ...
      #region FactorialPower (remarked out)
      ...
      ///// <param name="h"></param>
      ///// <returns></returns>
      //public static TInteger FactorialPower(TInteger x, TInteger n, TInteger h)
      //{
      //  System.ArgumentOutOfRangeException.ThrowIfNegative(n);
      ...
      public static string GetFormatStringWithCountDecimals(TInteger value)
      {
      ...
      public static (TInteger IntegralTowardZero, TInteger IntegralAwayFromZero, TInteger NearestIntegral, double Log) IntegerLog<TRadix>(TInteger value, TRadix radix)
        where TRadix : System.Numerics.IBinaryInteger<TRadix>
      {
        ...
        var ni = Numbers.RoundToNearest(log, HalfRounding.ToEven, false, [tz, afz]);

        return (TInteger.CreateChecked(tz), TInteger.CreateChecked(afz), TInteger.CreateChecked(ni), log);
      }
      ...
      public static bool IsIntegerPowOf<TRadix>(TInteger n, TRadix radix)
        where TRadix : System.Numerics.IBinaryInteger<TRadix>
      {
        var q = System.Numerics.BigInteger.Log(System.Numerics.BigInteger.CreateChecked(n)) / System.Numerics.BigInteger.Log(System.Numerics.BigInteger.CreateChecked(radix));

        var iq = System.Convert.ToInt64(q);

        var eqwt = Numbers.EqualsWithinAbsoluteTolerance(q, iq, 1e-10) || Numbers.EqualsWithinRelativeTolerance(q, iq, 1e-10);
      ...
      /// <returns></returns>
      public static TInteger IntegerRootN<TNth>(TInteger value, TNth exponent)
        where TNth : System.Numerics.IBinaryInteger<TNth>
        => TInteger.CreateChecked(System.Numerics.BigInteger.RootN(System.Numerics.BigInteger.CreateChecked(value), int.CreateChecked(exponent)));
      ...
      public static TInteger IntegerSqrt(TInteger value)
        => TInteger.CreateChecked(System.Numerics.BigInteger.Sqrt(System.Numerics.BigInteger.CreateChecked(value)));
      ...
      public static bool IsSqrt(TInteger value, TInteger root)
      ...
      public static bool IsPerfectSqrt(TInteger value, TInteger root)
        => value == (root * root);
      ...
      public static System.Collections.Generic.IEnumerable<TInteger> GetMersenneNumberSequence()
        => Numbers.LoopVerge(TInteger.One, TInteger.One).Select(GetMersenneNumber);
      ...
      #region PockHammer (ambiguous, remarked out)

      // Pockhammer is rather ambiguous and can represent either the rising or the falling power.
      //public static TInteger Pockhammer<TInteger>(TInteger x, TInteger n)
      //  => RisingFactorial(x, n);
      ...
      /// <param name="n"></param>
      /// <returns></returns>
      private static System.Collections.Generic.IEnumerable<TInteger> GetAscendingPossiblePrimes(TInteger n)
      {
        ...
        checked
        {
          var multiple = (quotient + (remainder >= two ? TInteger.One : TInteger.Zero)) * six;

          if (remainder <= TInteger.One) // Either a prime pillar or on right of. E.g. 12 or 13.
          {
      ...
      public static System.Collections.Generic.IEnumerable<TInteger> GetAscendingPrimes(TInteger n)
        => GetAscendingPossiblePrimes(n).AsParallel().AsOrdered().Where(IsPrimeNumber);

      /// <summary>Creates a new sequence of descending possible primes, less-than-or-equal-to a specified number.</summary>
      private static System.Collections.Generic.IEnumerable<TInteger> GetDescendingPossiblePrimes(TInteger n)
      {
        if (TInteger.CreateChecked(5) is var five && n >= five)
        {
          var six = TInteger.CreateChecked(6);
          ...
          checked
          {
            ...
            if (remainder == TInteger.Zero || remainder == five) // Either on a prime pillar or on left of. E.g. 12 or 11.
            {
              yield return multiple - TInteger.One;
      ...
      public static System.Collections.Generic.IEnumerable<TInteger> GetDescendingPrimes(TInteger n)
        => GetDescendingPossiblePrimes(n).AsParallel().AsOrdered().Where(IsPrimeNumber);
      ...
      /// <param name="n"></param>
      /// <returns></returns>
      public static bool IsPossiblePrime(TInteger n)
      ...
      public static bool IsPrimeNumber(TInteger n)
      {
        ...
        if (n < two) // Less than 2; not a prime number.
          return false;

        if (n <= three) // Less or equal to 3 makes it either 2 or 3; a prime number.
          return true;

        if (TInteger.IsZero(n % two) || TInteger.IsZero(n % three)) // Even or a multiple of 3; not a prime number.
          return false;
      ...
      public static bool IsProbablePrime(TInteger n)
        => System.Numerics.BigInteger.IsProbablePrime(System.Numerics.BigInteger.CreateChecked(n));
      ...
      /// <returns></returns>
      public static System.Collections.Generic.IEnumerable<(TInteger Root, TInteger Number)> GetSequenceOfRootN(TInteger nth)
      {
        ...
        checked
        {
          for (var root = System.Numerics.BigInteger.Zero; ; root++)
            yield return (TInteger.CreateChecked(root), TInteger.CreateChecked(System.Numerics.BigInteger.Pow(System.Numerics.BigInteger.CreateChecked(root), int.CreateChecked(nth))));
        }
      }
    ...
    #region NaiveFactorial (private helper)
    ...
    #region SplitFactorial (private helper)
    ...
    #region StaticFactorial (private helper)
    ...
    public static bool TryStaticFactorial<TInteger>(TInteger n, out TInteger factorial)
      where TInteger : System.Numerics.IBinaryInteger<TInteger>
    {
      try
      {
      ...
      where TInteger : System.Numerics.IBinaryInteger<TInteger>
    {
      ...
      {
        if (minLength <= 0) minLength = Units.Radix.GetMaxDigitCount(value.GetBitCount(), 10, value.GetType().IsNumericsISignedNumber());
      ...
      {
        if (minLength <= 0) minLength = Units.Radix.GetMaxDigitCount(value.GetBitCount(), 16, value.GetType().IsNumericsISignedNumber());
      ...
      {
        if (minLength <= 0) minLength = Units.Radix.GetMaxDigitCount(value.GetBitCount(), 8, value.GetType().IsNumericsISignedNumber());
      ...
      public string ToOrdinalIndicatorString()
        => value.ToString() + BinaryIntegers.GetOrdinalIndicatorSuffix(value);
        ...
        where TRadix : System.Numerics.IBinaryInteger<TRadix>
      {
        ...
        {
          if (minLength <= 0) minLength = Units.Radix.GetMaxDigitCount(value.GetBitCount(), rdx, value.GetType().IsNumericsISignedNumber());
