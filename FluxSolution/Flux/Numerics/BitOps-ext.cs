namespace Flux
{
  ...
  public static partial class BitOps
  {
      ...
      where TInteger : System.Numerics.IBinaryInteger<TInteger>
    {
      ...
      //  var ms1b = IBinaryInteger.MostSignificant1Bit(value);

      //  return (ms1b, ms1b << 1);
      //}

      //public static TInteger Pow2Tz(TInteger value)
      //  => TInteger.IsNegative(value)
      //  ? Pow2Tz(TInteger.Abs(value))
      //  : TInteger.IsPow2(value)
      //  ? value
      //  : IBinaryInteger.MostSignificant1Bit(value);
