namespace Flux
{
  ...
  {
    public static Numerics.EuclideanRotations.AxisAngle ToAxisAngle(this Numerics.EuclideanRotations.EulerAngles source)
    {
    ...
    public static System.Numerics.Matrix4x4 ToMatrixTaitBryanXYZ(this Numerics.EuclideanRotations.EulerAngles source)
    {
    ...
    public static System.Numerics.Matrix4x4 ToMatrixLhTaitBryanYXZ(this Numerics.EuclideanRotations.EulerAngles source)
    {
      var (s1, c1) = double.SinCos(source.Yaw.Value);
      var (s2, c2) = double.SinCos(source.Pitch.Value);
      var (s3, c3) = double.SinCos(source.Roll.Value);
    ...
    public static System.Numerics.Matrix4x4 ToMatrixLhTaitBryanZYX(this Numerics.EuclideanRotations.EulerAngles source)
    {
    ...
    public static System.Numerics.Matrix4x4 ToMatrixLhProperEulerZXZ(this Numerics.EuclideanRotations.EulerAngles source)
    {
      var (s1, c1) = double.SinCos(source.Yaw.Value);
      var (s2, c2) = double.SinCos(source.Pitch.Value);
      var (s3, c3) = double.SinCos(source.Roll.Value);
    ...
    public static (Units.Angle yaw, Units.Angle pitch, Units.Angle roll) ToQuantities(this Numerics.EuclideanRotations.EulerAngles source)
      => (
        source.Yaw,
        source.Pitch,
        source.Roll
    ...
    public static System.Numerics.Quaternion ToQuaternion(this Numerics.EuclideanRotations.EulerAngles source)
    {
      var (yaw, pitch, roll) = source;

      var (x, y, z, w) = Numerics.EuclideanRotations.EulerAngles.ConvertEulerAnglesToQuaternion(yaw, pitch, roll);
