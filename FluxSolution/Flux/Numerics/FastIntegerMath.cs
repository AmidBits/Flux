namespace Flux
{
  ...
  {
    public static (TFloat Floor, TFloat Ceiling) FloorAndCeilingWithinTolerance<TFloat>(TFloat value, TFloat absoluteTolerance, TFloat relativeTolerance)
      ...
      where TNumber : System.Numerics.INumber<TNumber>
    {
      ...
      return (TNumber.CreateChecked(double.Floor(cbrt)), TNumber.CreateChecked(double.Ceiling(cbrt)));
    }
      ...
      where TRadix : System.Numerics.INumber<TRadix>
    {
      checked
      {
        ...
        if (log >= 0)
        {
          //var (ilogf, ilogc) = FloorAndCeilingWithinTolerance(log, 1e-10, 1e-10);
      ...
      where TPower : System.Numerics.INumber<TPower>
    {
      ...
      return (TNumber.CreateChecked(double.Floor(pow)), TNumber.CreateChecked(double.Ceiling(pow)));
    }
    ...
    public static (TNumber IrootnTz, TNumber IrootnAfz) FastIntegerRootN<TNumber, TNth>(this TNumber value, TNth nth, out double rootn)
      where TNumber : System.Numerics.INumber<TNumber>
      where TNth : System.Numerics.INumber<TNth>
    {
      rootn = double.RootN(double.CreateChecked(value), int.CreateChecked(nth));

      return (TNumber.CreateChecked(double.Floor(rootn)), TNumber.CreateChecked(double.Ceiling(rootn)));
    }
      ...
      where TNumber : System.Numerics.INumber<TNumber>
    {
      checked
      {
        ...
        return (TNumber.CreateChecked(double.Floor(sqrt)), TNumber.CreateChecked(double.Ceiling(sqrt)));
      }
    }
