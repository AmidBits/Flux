namespace Flux
{
  public static partial class FinancialFunctions
  {
    /// <summary>
    ...
    public static TFloat AmortizedMonthlyPayment<TFloat>(this TFloat principalAmount, TFloat monthlyInterestRate, TFloat numberOfPaymentPeriods)
    ...
    public static TFloat CompoundInterest<TFloat>(this TFloat nominalInterestRate, TFloat compoundingFrequency, TFloat overallLengthOfTime)
      where TFloat : System.Numerics.IFloatingPoint<TFloat>, System.Numerics.IPowerFunctions<TFloat>
