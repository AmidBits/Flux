namespace Flux.Numerics.Geometry.Polygons
{
    ...
    : System.IFormattable, IFigurable
  {
    ...
    public Polygon(System.Collections.Generic.IEnumerable<System.Runtime.Intrinsics.Vector128<double>> vertices) : this(vertices.ToList()) { }
    ...
    /// </summary>
    public virtual System.Runtime.Intrinsics.Vector128<double> Centroid => m_vertices.ComputeCentroid(out var _);
    ...
    public bool IsClockwise => SurfaceAreaSigned > 0;
    ...
    /// </summary>
    public virtual double Perimeter => m_vertices.ComputePerimeter();
    ...
    /// <para><see href="https://en.wikipedia.org/wiki/Polygon#Area"/></para>
    /// </summary>
    public virtual double SurfaceAreaSigned => m_vertices.ComputeSurfaceArea();// m_vertices.PartitionTuple2(true, (v1, v2, i) => v1[0] * v2[1] - v2[0] * v1[1]).Sum() / 2;
