namespace Flux
{
  public static partial class BitOps
  {
    ...
    public static TNumber Log2AwayFromZero<TNumber>(this TNumber source)
      ...
      ? source
      : TNumber.CopySign(TNumber.Abs(source) is var abs && TNumber.Log2(abs) is var log2 && TNumber.IsPow2(abs) ? log2 : log2 + TNumber.One, source);
    ...
    public static TNumber Log2TowardZero<TNumber>(this TNumber source)
      ...
      => TNumber.IsZero(source)
      ? source
      : TNumber.CopySign(TNumber.Log2(TNumber.Abs(source)), source);
