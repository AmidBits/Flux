namespace Flux
{
  public static partial class FloatingPoint
  {
    ...
    /// </returns>
    public static int CompareToFractionMidpoint<TFloat>(this TFloat value)
    ...
    /// </returns>
    public static int CompareToFractionPercent<Float>(this Float value, Float percent)
      where Float : System.Numerics.IFloatingPoint<Float>
      => (value - Float.Floor(value)).CompareTo(percent);
  }
}
