namespace Flux
{
  ...
  {
    public readonly System.Numerics.Vector<T> m_vector;

    public CartesianCoordinate(T x) => m_vector = new System.Numerics.Vector<T>(x);
    public CartesianCoordinate(T x, T y) => m_vector = System.Numerics.Vector<T>.Create(x, y);
    public CartesianCoordinate(T x, T y, T z) => m_vector = System.Numerics.Vector<T>.Create(x, y, z);
    public CartesianCoordinate(T x, T y, T z, T w) => m_vector = System.Numerics.Vector<T>.Create(x, y, z, w);
  ...
  public static partial class CartesianCoordinate
  {
    /// <summary>
    /// <para>Converts cartesian 2D (<paramref name="x"/>, <paramref name="y"/>) coordinates to a linear index of a grid with the <paramref name="width"/> (the length of the x-axis).</para>
    /// </summary>
