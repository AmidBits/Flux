namespace Flux
{
  public static partial class Interpolations
  {
      ...
      where TFloat : System.Numerics.IFloatingPoint<TFloat>, System.Numerics.ITrigonometricFunctions<TFloat>
    {
      ...
      /// <returns></returns>
      public TFloat InterpolateCosine(TFloat y1, TFloat mu)
      {
      ...
      where TFloat : System.Numerics.IFloatingPoint<TFloat>
    {
      ...
      /// <param name="mu"></param>
      /// <returns></returns>
      public TFloat InterpolateCubic(TFloat y1, TFloat y2, TFloat y3, TFloat mu)
      {
        var mu2 = mu * mu;
      ...
      /// <param name="mu"></param>
      /// <returns></returns>
      public TFloat InterpolateCubicPb(TFloat y1, TFloat y2, TFloat y3, TFloat mu)
      {
      ...
      /// <returns></returns>
      public TFloat InterpolateHermite(TFloat y1, TFloat y2, TFloat y3, TFloat mu, TFloat tension, TFloat bias)
      {
        var one = TFloat.One;
        var two = one + one;
        var three = two + one;
      ...
      /// <para><see href="http://paulbourke.net/miscellaneous/interpolation/"/></para>
      /// </summary>
      public TFloat InterpolateLinear(TFloat y1, TFloat mu)
