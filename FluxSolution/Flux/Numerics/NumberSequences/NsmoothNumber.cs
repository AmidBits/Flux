...
//      => m_primeNumbers = System.Numerics.BigInteger.CreateChecked(2).GetAscendingPrimes().TakeWhile(p => p <= n).ToList();
...
//      => System.Numerics.BigInteger.One.LoopVerge(System.Numerics.BigInteger.One).Where(IsNsmoothNumber);
