namespace Flux.Numerics
{
  public static partial class NumberSequence
  {
    ...
    /// <returns></returns>
    public static System.Collections.Generic.IEnumerable<(TSelf Root, TSelf Number)> GetPerfectNthRootSequence<TSelf>(int nth)
      where TSelf : System.Numerics.IBinaryInteger<TSelf>, System.Numerics.IMinMaxValue<TSelf>
    {
      ...
      var nthRoot = System.Numerics.BigInteger.CreateChecked(TSelf.MaxValue).IntegerRootN(nth);
