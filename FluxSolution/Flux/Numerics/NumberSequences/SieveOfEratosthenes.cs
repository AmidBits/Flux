...
//    public static DataStructures.BitArray64 SieveOfEratosthenes<TInteger>(this TInteger limit)
//      where TInteger : System.Numerics.IBinaryInteger<TInteger>
//    {
//      var llimit = long.CreateChecked(limit);

//      System.ArgumentOutOfRangeException.ThrowIfNegativeOrZero(llimit);
//      System.ArgumentOutOfRangeException.ThrowIfGreaterThan(llimit, 64L * System.Array.MaxIndexArrayOfMultiByteStructures);

//      var ba = new Flux.DataStructures.BitArray64(llimit + 1, unchecked((long)0xAAAAAAAAAAAAAAAAUL)); // Bits represents the number line, so we start with all odd numbers being set to 1 and all even numbers set to 0.
...
//      while (factor * factor <= llimit)
//      {
//        for (var n = factor; n <= llimit; n += 2)
//          if (ba.Get(n))
//          {
//            factor = n;
//            break;
...
//        for (var n = factor * factor; n <= llimit; n += factor * 2)
//          ba.Set(n, false);
