namespace Flux
{
  ...
  public static partial class SexagesimalUnitSubdivisions
  {
      ...
      where TFloat : System.Numerics.IFloatingPoint<TFloat>
    {
      ...
      /// <returns></returns>
      public static (TFloat degrees, TFloat decimalMinutes, TFloat minutes, TFloat decimalSeconds) DecimalDegreesToSexagesimalUnitSubdivisions(TFloat decimalDegrees)
      {
        var absDegrees = TFloat.Abs(decimalDegrees);
        var floorAbsDegrees = TFloat.Floor(absDegrees);
        var degrees = TFloat.CopySign(floorAbsDegrees, decimalDegrees);
        var decimalMinutes = TFloat.CreateChecked(60) * (absDegrees - floorAbsDegrees);
        var absMinutes = TFloat.Abs(decimalMinutes);
        var minutes = TFloat.Floor(absMinutes);
        var decimalSeconds = TFloat.CreateChecked(60) * (absMinutes - minutes);
