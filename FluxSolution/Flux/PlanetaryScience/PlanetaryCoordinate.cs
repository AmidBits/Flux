...
//  public readonly record struct PlanetaryCoordinate
//    : System.IFormattable
//  {
//    public const double MaxAltitudeInMeters = 1500000000;
//    public const double MinAltitudeInMeters = -11000;

//    public static PlanetaryCoordinate Empty { get; }

//    public static PlanetaryCoordinate GreenwichMeridian { get; } = new(51.477811, Units.AngleUnit.Degree, -0.001475, Units.AngleUnit.Degree);
...
//    public PlanetaryCoordinate(double latitudeRadian, double longitudeRadian, double altitudeMeter)
//    {
...
//    /// <summary>
//    /// <para>Create a new <see cref="PlanetaryCoordinate"/> from the specified <paramref name="latitude"/>, <paramref name="longitude"/> and <paramref name="altitude"/>.</para>
//    /// </summary>
...
//    public PlanetaryCoordinate(Units.Angle latitude, Units.Angle longitude, Units.Length altitude)
//      : this(latitude.Value, longitude.Value, altitude.Value)
//    { }

//    /// <summary>
//    /// <para>Create a new <see cref="PlanetaryCoordinate"/> from the specified <paramref name="latitudeValue"/>, <paramref name="latitudeUnit"/>, <paramref name="longitudeValue"/>, <paramref name="longitudeUnit"/>, <paramref name="altitudeValue"/> and <paramref name="altitudeUnit"/>.</para>
//    /// </summary>
...
//    /// <exception cref="System.ArgumentOutOfRangeException"></exception>
//    public PlanetaryCoordinate(double latitudeValue, Units.AngleUnit latitudeUnit, double longitudeValue, Units.AngleUnit longitudeUnit, double altitudeValue = 1, Units.LengthUnit altitudeUnit = Units.LengthUnit.Meter)
...
//    /// <summary>
//    /// <para>Deconstructs the <see cref="PlanetaryCoordinate"/> to <paramref name="latitudeRadian"/>itude (radians), <paramref name="longitudeRadian"/>gitude (radians) and <paramref name="altitudeMeter"/>itude (meters).</para>
//    /// </summary>
...
//    /// <summary>The diametrical opposite of the <see cref="PlanetaryCoordinate"/>, i.e. the opposite side of Earth's surface. This is a plain mathematical antipode.</summary>
//    public PlanetaryCoordinate Antipode
//      => new(
//        -m_latitude,
...
//    /// <summary>Creates a new <see cref="CoordinateSystems.SphericalCoordinate"/> from the <see cref="PlanetaryCoordinate"/>.</summary>
...
//      => Units.Angle.Ahvsin(Units.Angle.Hvsin(lat2 - lat1) + double.Cos(lat1) * double.Cos(lat2) * Units.Angle.Hvsin(lon2 - lon1));
...
//    public static bool TryParse(string latitudeDms, string longitudeDms, out PlanetaryCoordinate result, double earthRadius)
//    {
//      try
//      {
...
//        {
//          result = new PlanetaryCoordinate(latitudeAngle.Value, Units.AngleUnit.Radian, longitudeAngle.Value, Units.AngleUnit.Radian, earthRadius);
//          return true;
//        }
//      }
//      catch { }
...
//      => $"<{Latitude.ToDmsNotationString()} {Longitude.ToDmsNotationString()} ({Latitude.ToDecimalString()}, {Longitude.ToDecimalString()}), {Altitude.ToString(format ?? 3.FormatUpToFractionalDigits(), formatProvider)}>";
