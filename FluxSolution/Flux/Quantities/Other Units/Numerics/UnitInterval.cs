namespace Flux.Quantities
{
    ...
    : System.IComparable, System.IComparable<UnitInterval>, System.IFormattable, IValueQuantifiable<double>
  {
    ...
    /// </summary>
    /// <exception cref="System.ArgumentOutOfRangeException"></exception>
    public static bool IsMember<TSelf>(TSelf unitInterval, IntervalNotation notation)
      where TSelf : System.Numerics.IFloatingPoint<TSelf>
      => notation.IsMember(unitInterval, TSelf.CreateChecked(MinValue), TSelf.CreateChecked(MaxValue));
