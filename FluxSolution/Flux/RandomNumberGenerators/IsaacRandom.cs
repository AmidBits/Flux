namespace Flux.RandomNumberGenerators
{
  ...
  public class IsaacRandom
    : ASystemRandom32
  {
    private static readonly System.Threading.ThreadLocal<System.Random> m_shared = new(() => new IsaacRandom());
    ...
    public IsaacRandom() : this((ulong)System.Diagnostics.Stopwatch.GetTimestamp()) { }
