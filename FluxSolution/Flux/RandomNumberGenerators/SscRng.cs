namespace Flux.RandomNumberGenerators
{
    ...
    : System.Random
  {
    ...
    public override int Next(int maxValue) => maxValue == 0 ? 0 : System.Security.Cryptography.RandomNumberGenerator.GetInt32(maxValue); // For some reason .GetInt32(toExclusive) does not work like Random.Next(toExclusive), zero appears not allowed.
