...
{
  /// <summary>
  /// <para>The 64-bit random number generator xoshiro256** (XOR/shift/rotate) is our all-purpose, rock-solid (though not a cryptographically secure) generator. It has excellent (sub-ns) speed, a state space (256 bits) that is large enough for any parallel application, and it passes all tests we are aware of.</para>
  ...
  public sealed class Xoshiro256SS
    : ARandom64
  {
    private static readonly System.Threading.ThreadLocal<System.Random> m_shared = new(() => new Xoshiro256SS());
