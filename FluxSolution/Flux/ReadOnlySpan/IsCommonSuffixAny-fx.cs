namespace Flux
{
  public static partial class ReadOnlySpans
  {
    ...
    /// <returns></returns>
    public static bool IsCommonSuffixAny<T>(this System.ReadOnlySpan<T> source, int length, System.Collections.Generic.IEqualityComparer<T>? equalityComparer, params T[] values)
      => source.IsCommonSuffix(length, c => values.Contains(c, equalityComparer));
    ...
    /// </summary>
    public static bool IsCommonSuffixAny(this System.ReadOnlySpan<char> source, int maxLength, System.Collections.Generic.IEqualityComparer<char>? equalityComparer, params string[] values)
    {
    ...
    public static bool IsCommonSuffixAny(this System.ReadOnlySpan<char> source, System.Collections.Generic.IEqualityComparer<char>? equalityComparer, params string[] values)
      => source.IsCommonSuffixAny(int.MaxValue, equalityComparer, values);
