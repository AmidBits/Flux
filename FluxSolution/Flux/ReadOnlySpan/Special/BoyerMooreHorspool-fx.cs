namespace Flux
{
  public static class BoyerMooreHorspool
  {
    ...
    private static bool IsSame<T>(System.ReadOnlySpan<T> source, System.ReadOnlySpan<T> target, int length, System.Collections.Generic.IEqualityComparer<T> equalityComparer)
      where T : notnull
    {
