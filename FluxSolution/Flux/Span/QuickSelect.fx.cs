namespace Flux
{
  public static partial class Spans
  {
    ...
    private static int QuickSelectPartition<T>(System.Span<T> source, int pivotIndex, int leftIndex, int rightIndex, System.Collections.Generic.IComparer<T>? comparer)
    {
