namespace Flux.Statistics.Quantile
{
  ...
  /// </summary>
  /// <remarks>
  /// <para>Equivalent to Excel's PERCENTILE.EXC, and Python's default "exclusive" method.</para>
  /// <para>This quantile is equivalent to <see cref="Quartile.Method4"/>.</para>
  /// </remarks>
