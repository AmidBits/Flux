namespace Flux.Statistics.Quantile
{
    ...
    : IQuantileEstimatable
  {
    ...
    public TPercent EstimateQuantileRank<TCount, TPercent>(TCount count, TPercent p)
      ...
      => (TPercent.CreateChecked(count) + TPercent.CreateChecked(OneThird)) * Units.UnitInterval.AssertWithin(p, IntervalNotation.Closed, nameof(p)) + TPercent.CreateChecked(OneThird);
