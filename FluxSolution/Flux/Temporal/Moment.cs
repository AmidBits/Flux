namespace Flux.Temporal
{
    ...
    : System.IComparable, System.IComparable<Moment>, System.IFormattable
  {
    ...
    public System.DateTime ToDateTime() => new(m_year, m_month, m_day, m_hour, m_minute, m_second, m_millisecond, m_microsecond);
    ...
    public System.TimeSpan ToTimeSpan() => new(m_day, m_hour, m_minute, m_second, m_millisecond, m_microsecond);
    ...
    /// </remarks>
    public static double ConvertTimePartsToTotalSeconds(int day, int hour, int minute, int second, int millisecond, int microsecond, int nanosecond)
