namespace Flux
{
  public static partial class TextElementEnumeratorExtensions
  {
    extension(System.IO.TextReader source)
    {
      public System.Collections.Generic.IEnumerable<Text.TextElement> EnumerateTextElements()
  ...
  namespace Text
  {
    /// <summary>Creates an enumerator of <see cref="BaseLibrary.Source.Text.TextElement"/> from a stream of <see cref="System.Char"/>.</summary>
