namespace Flux.Transflex
{
  public sealed class Brotli
    : ITransflexable
  {
    public static ITransflexable Default { get; } = new Brotli();
    public static ITransflexable Max { get; } = new Brotli() { BrotliCompressionOptions = new System.IO.Compression.BrotliCompressionOptions() { Quality = 11 } };
