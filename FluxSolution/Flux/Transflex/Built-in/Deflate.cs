namespace Flux.Transflex
{
  public sealed class Deflate
    : ITransflexable
  {
    public static ITransflexable Default { get; } = new Deflate();
    public static ITransflexable Max { get; } = new Deflate() { ZLibCompressionOptions = new System.IO.Compression.ZLibCompressionOptions() { CompressionLevel = 9 } };
