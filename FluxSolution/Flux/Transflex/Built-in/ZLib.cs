namespace Flux.Transflex
{
  public sealed class ZLib
    : ITransflexable
  {
    public static ITransflexable Default { get; } = new ZLib();
    public static ITransflexable Max { get; } = new ZLib() { ZLibCompressionOptions = new System.IO.Compression.ZLibCompressionOptions() { CompressionLevel = 9 } };
