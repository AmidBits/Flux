namespace Flux
{
  public static partial class XtensionDecimal
  {
    ...
    extension(System.Decimal source)
    {
      /// <summary>
      ...
      /// <returns></returns>
      public (System.Numerics.BigInteger Significand, byte Scale, bool Sign) GetComponents()
      {
      ...
      /// <returns></returns>
      public (System.Numerics.BigInteger IntegerPart, decimal FractionalPart, System.Numerics.BigInteger FractionalPartAsInteger) GetParts(out System.Numerics.BigInteger significand, out byte scale, out System.Numerics.BigInteger scaleFactor, out bool sign)
      {
        (significand, scale, sign) = source.GetComponents();
      ...
      public (System.Numerics.BigInteger IntegerPart, decimal FractionalPart, System.Numerics.BigInteger FractionalPartAsWholeNumber) GetParts()
        => GetParts(source, out var _, out var _, out var _, out var _);
    }
  }
}
