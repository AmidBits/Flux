namespace Flux
{
  public static partial class XtensionDouble
  {
    ...
    extension(System.Double source)
    {
      /// <summary>
      ...
      /// </returns>
      public (int Binary64Sign, int Binary64ExponentUnbiased, long Binary64Significand53) GetBinary64Components(out int binary64SignBit, out int binary64ExponentBiased, out long binary64Significand52)
      {
      ...
      /// </returns>
      public (double IntegralPart, double FractionalPart) GetParts()
      {
        var integralPart = double.Truncate(source);
