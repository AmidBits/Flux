namespace Flux
{
  public static partial class EnumExtensions
  {
    ...
    {
      var (ExtremumMinItem, ExtremumMinIndex, ExtremumMinValue, ExtremumMaxItem, ExtremumMaxIndex, ExtremumMaxValue) = IEnumerable.Extremum(System.Enum.GetValues<T>(), e => (int)(object)e);
