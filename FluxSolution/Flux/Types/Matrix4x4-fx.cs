namespace Flux
{
  public static partial class Matrix4x4Extensions
  {
    ...
    public static Numerics.EuclideanRotations.EulerAngles ToEulerAnglesTaitBryanZYX(this System.Numerics.Matrix4x4 source)
      => new(
    ...
    public static Numerics.EuclideanRotations.EulerAngles ToEulerAnglesProperEulerZXZ(this System.Numerics.Matrix4x4 source)
      => new(
