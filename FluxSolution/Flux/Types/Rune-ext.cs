namespace Flux
{
  public static partial class XtensionRune
  {
    extension(System.Text.Rune source)
    {
      ...
      public string FoldToAscii()
      {
        switch (source.Value)
        {
          ...
          case '\uFF48': // [FULLWIDTH LATIN SMALL LETTER H]
            return "h";
          case '\u01F6': // [LATIN CAPITAL LETTER HWAIR]
            return "HV";
          ...
          case '\uA74E': // [LATIN CAPITAL LETTER OO]
            return "OO";
          case '\u0222': // [LATIN CAPITAL LETTER OU]
      ...
      /// <returns></returns>
      public System.Text.Rune GetControlPicture()
        => source.Value is >= '\u0000' and <= '\u0020' // C0 control codes, U+0000—U+001F, from the Basic Latin block.
        ? (System.Text.Rune)(source.Value + 2400) // Yields C0 control pictures.
        : source.Value is '\u007F' // Delete character.
        ? (System.Text.Rune)'\u2421' // Yields DEL
        : source.Value is '\u0085' // The NEL (Next Line) is the only C1 control code that has a designated Unicode "control picture".
        ? (System.Text.Rune)'\u2424' // Yields NL (Newline)
        ///: source is >= '\u2028' and <= '\u2029'
        ///? '\u2424' // LS and PS (Line Separator and Paragraph Separator).
        : source.Value is >= '\u0080' and <= '\u009F' // C1 control codes, U+0080-U+009F, from the Latin-1 Supplement block.
        ? (System.Text.Rune)'\uFFFD' // There are no Unicode "control picture" for these (except NEL, above) so here we use the replacement character (seealso above) for these.
        : source;
      ...
      /// <returns></returns>
      public bool TryGetControlPicture(out System.Text.Rune picture)
      {
        try { picture = GetControlPicture(source); }
      ...
      /// <param name="source"></param>
      /// <returns></returns>
      public bool IsNonRenderingCategory(bool nonRenderCategoryFormat = false, bool nonRenderCategoryPrivateUse = false)
      ...
      /// <param name="source"></param>
      /// <returns></returns>
      public bool IsPrintableUnicode()
