namespace Flux
{
  public static partial class SingleExtensions
  {
    ...
    extension(System.Single source)
    {
      /// <summary>
      ...
      /// </returns>
      public (int Binary32Sign, int Binary32ExponentUnbiased, long Binary32Significand24) GetBinary32Components(out int binary32SignBit, out int binary32ExponentBiased, out int binary32Significand23)
      {
        var bits = System.BitConverter.SingleToUInt32Bits(source);
      ...
      /// </returns>
      public (float IntegerPart, float FractionalPart) GetParts()
      {
        var integralPart = float.Truncate(source);
        var fractionalPart = source - integralPart;
