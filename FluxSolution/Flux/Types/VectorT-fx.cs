namespace Flux
{
  public static partial class XtensionVectorT
  {
      ...
      where T : System.Numerics.INumber<T>
    {
      ...
      public T ChebyshevLength(T edgeLength)
        => Max(System.Numerics.Vector.Abs(source)) / edgeLength;
      ...
      /// <param name="center"></param>
      /// <returns></returns>
      public int GetOctant(System.Numerics.Vector<T> center)
      ...
      /// <param name="center"></param>
      /// <returns></returns>
      public int GetOctantNegativeAs1(System.Numerics.Vector<T> center)
        => GetQuadrantNegativeAs1(source, center) + (source[2] < center[2] ? 4 : 0);
      ...
      /// <param name="center"></param>
      /// <returns></returns>
      public int GetOctantPositiveAs1(System.Numerics.Vector<T> center)
        => GetQuadrantPositiveAs1(source, center) + (source[2] >= center[2] ? 4 : 0);
      ...
      /// <param name="center"></param>
      /// <returns></returns>
      public int GetQuadrant(System.Numerics.Vector<T> center)
      ...
      /// <param name="center"></param>
      /// <returns></returns>
      public int GetQuadrantNegativeAs1(System.Numerics.Vector<T> center)
      ...
      /// <param name="center"></param>
      /// <returns></returns>
      public int GetQuadrantPositiveAs1(System.Numerics.Vector<T> center)
        => (source[0] >= center[0] ? 1 : 0) + (source[1] >= center[1] ? 2 : 0);
