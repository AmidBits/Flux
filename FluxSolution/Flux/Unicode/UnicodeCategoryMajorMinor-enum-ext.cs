namespace Flux
{
  ...
  public static class UnicodeCategoryMajorMinorExtensions
  {
    extension(UnicodeCategoryMajorMinor)
    {
      ...
      public static bool TryParse(char unicodeCategoryMajor, char unicodeCategoryMinor, out UnicodeCategoryMajorMinor result)
      {
        try
        {
          result = Parse(unicodeCategoryMajor, unicodeCategoryMinor);
          return true;
        }
        catch { }
    ...
    extension(UnicodeCategoryMajorMinor unicodeCategoryMajorMinor)
    {
      /// <summary>
