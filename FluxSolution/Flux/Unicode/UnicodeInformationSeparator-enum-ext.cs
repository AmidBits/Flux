namespace Flux
{
  ...
  public static class UnicodeInformationSeparatorExtensions
  {
    extension(UnicodeInformationSeparator)
    {
      /// <summary>
    ...
    extension(UnicodeInformationSeparator separator)
    {
      /// <summary>
      /// <para></para>
      /// </summary>
      ...
      /// <param name="separator"></param>
      /// <returns></returns>
      public UnicodeSymbolForInformationSeparator ConvertToUnicodeSymbolForInformationSeparator()
