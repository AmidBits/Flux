namespace Flux
{
  public static partial class Em
  {
    ...
    public static System.Collections.Generic.Dictionary<(Units.MetricPrefix, TUnit), string> ToStringsOfSiPrefixes<TValue, TUnit>(this Units.ISiUnitValueQuantifiable<TValue, TUnit> source, bool preferUnicode = false, Unicode.UnicodeSpacing unitSpacing = Unicode.UnicodeSpacing.Space, bool useFullName = false)
