namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<MidiNote>, System.IFormattable, IValueQuantifiable<int>
  {
    ...
    /// </summary>
    public Units.Frequency ToFrequency() => new(ConvertNoteNumberToFrequency(m_value));
    ...
    /// </summary>
    public static bool TryConvertFrequencyToMidiNote(Units.Frequency frequency, out MidiNote result)
    {
      try
      {
