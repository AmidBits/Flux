namespace Flux.Units
{
    ...
    , IValueQuantifiable<double>
  {
    ...
    public static bool IsProperFraction(BigRational value)
      => System.Numerics.BigInteger.Abs(value.m_numerator) < value.m_denominator; // If the numerator is strictly less than the denominator, it is a proper fraction.
    ...
    public string ToString(string? format, System.IFormatProvider? formatProvider)
      ...
      ? RatioNotation.AslashB.ToRatioNotationString(m_numerator, m_denominator, format, formatProvider)
      : TryGetMixedParts(this, out var wholeNumber, out var properNumerator, out var properDenominator)
      ? $"{wholeNumber} {RatioNotation.AslashB.ToRatioNotationString(properNumerator, properDenominator, format, formatProvider)}"
