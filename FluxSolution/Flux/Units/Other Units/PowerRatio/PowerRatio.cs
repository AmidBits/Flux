namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<PowerRatio>, System.IFormattable, IUnitValueQuantifiable<double, PowerRatioUnit>
  {
    ...
    public PowerRatio(MetricPrefix prefix, double decibelWatt) => m_value = prefix.ConvertPrefix(decibelWatt, MetricPrefix.Unprefixed);
    ...
    public string ToUnitString(PowerRatioUnit unit = PowerRatioUnit.DecibelWatt, string? format = null, System.IFormatProvider? formatProvider = null, UnicodeSpacing spacing = UnicodeSpacing.Space, bool fullName = false)
    {
