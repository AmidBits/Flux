namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<RelativeHumidity>, System.IFormattable, IUnitValueQuantifiable<double, RelativeHumidityUnit>
  {
    ...
    public RelativeHumidity(MetricPrefix prefix, double percent) => m_value = prefix.ConvertPrefix(percent, MetricPrefix.Unprefixed);
    ...
    public string ToUnitString(RelativeHumidityUnit unit = RelativeHumidityUnit.Percent, string? format = null, System.IFormatProvider? formatProvider = null, UnicodeSpacing spacing = UnicodeSpacing.Space, bool fullName = false)
    {
