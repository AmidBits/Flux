namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<LuminousIntensity>, System.IEquatable<LuminousIntensity>, System.IFormattable, ISiUnitValueQuantifiable<double, LuminousIntensityUnit>
  {
    ...
    public string ToSiUnitString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null)
      => GetSiUnitValue(prefix).ToSiFormattedString(format, formatProvider) + Unicode.UnicodeSpacing.ThinSpace.ToSpacingString() + prefix.GetMetricPrefixSymbol() + LuminousIntensityUnit.Candela.GetUnitSymbol();
