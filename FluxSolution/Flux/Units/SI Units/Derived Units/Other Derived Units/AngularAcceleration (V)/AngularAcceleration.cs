namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<AngularAcceleration>, System.IFormattable, ISiUnitValueQuantifiable<double, AngularAccelerationUnit>
  {
    ...
    public string ToSiUnitString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null)
      => GetSiUnitValue(prefix).ToSiFormattedString(format, formatProvider) + Unicode.UnicodeSpacing.ThinSpace.ToSpacingString() + prefix.GetMetricPrefixSymbol() + AngularAccelerationUnit.RadianPerSecondSquared.GetUnitSymbol();
