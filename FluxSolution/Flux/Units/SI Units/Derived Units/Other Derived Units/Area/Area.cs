namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<Area>, System.IFormattable, ISiUnitValueQuantifiable<double, AreaUnit>
  {
    ...
    public string ToSiUnitString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null)
      => GetSiUnitValue(prefix).ToSiFormattedString(format, formatProvider) + Unicode.UnicodeSpacing.ThinSpace.ToSpacingString() + prefix.GetMetricPrefixSymbol() + AreaUnit.SquareMeter.GetUnitSymbol();
