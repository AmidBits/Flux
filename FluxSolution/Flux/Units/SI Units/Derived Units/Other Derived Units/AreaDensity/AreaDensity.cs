namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<AreaDensity>, System.IFormattable, IUnitValueQuantifiable<double, AreaDensityUnit>
  {
    ...
    public AreaDensity(MetricPrefix prefix, double gramPerSquareMeter) => m_value = prefix.ConvertPrefix(gramPerSquareMeter, MetricPrefix.Unprefixed);
    ...
    public string ToSiUnitString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null, bool fullName = false)
      => GetSiUnitValue(prefix).ToSiFormattedString(format, formatProvider) + UnicodeSpacing.ThinSpace.ToSpacingString() + (fullName ? GetSiUnitName(prefix, Numbers.IsConsideredPlural(GetSiUnitValue(prefix))) : GetSiUnitSymbol(prefix, false));
    ...
    public string ToUnitString(AreaDensityUnit unit = AreaDensityUnit.KilogramPerSquareMeter, string? format = null, System.IFormatProvider? formatProvider = null, UnicodeSpacing spacing = UnicodeSpacing.Space, bool fullName = false)
    {
