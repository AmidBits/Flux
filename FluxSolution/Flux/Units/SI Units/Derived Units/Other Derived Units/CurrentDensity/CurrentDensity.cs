namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<CurrentDensity>, System.IFormattable, ISiUnitValueQuantifiable<double, CurrentDensityUnit>
  {
    ...
    public CurrentDensity(MetricPrefix prefix, double amperePerSquareMeter) => m_value = prefix.ChangePrefix(amperePerSquareMeter, MetricPrefix.Unprefixed);
    ...
    public string ToSiUnitString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null)
      => GetSiUnitValue(prefix).ToSiFormattedString(format, formatProvider) + Unicode.UnicodeSpacing.ThinSpace.ToSpacingString() + prefix.GetMetricPrefixSymbol() + CurrentDensityUnit.AmperePerSquareMeter.GetUnitSymbol();
