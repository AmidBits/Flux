namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<Density>, System.IFormattable, ISiUnitValueQuantifiable<double, DensityUnit>
  {
    ...
    public string ToSiUnitString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null)
      => GetSiUnitValue(prefix).ToSiFormattedString(format, formatProvider) + Unicode.UnicodeSpacing.ThinSpace.ToSpacingString() + prefix.GetMetricPrefixSymbol() + DensityUnit.GramPerCubicMeter.GetUnitSymbol();
