namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<ElectricChargeDensity>, System.IFormattable, ISiUnitValueQuantifiable<double, ElectricChargeDensityUnit>
  {
    ...
    public ElectricChargeDensity(MetricPrefix prefix, double coulombPerCubicMeter) => m_value = prefix.ChangePrefix(coulombPerCubicMeter, MetricPrefix.Unprefixed);
    ...
    public string ToSiUnitString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null)
      => GetSiUnitValue(prefix).ToSiFormattedString(format, formatProvider) + Unicode.UnicodeSpacing.ThinSpace.ToSpacingString() + prefix.GetMetricPrefixSymbol() + ElectricChargeDensityUnit.CoulombPerCubicMeter.GetUnitSymbol();
