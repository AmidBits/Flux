namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<EnergyDensity>, System.IFormattable, ISiUnitValueQuantifiable<double, EnergyDensityUnit>
  {
    ...
    public EnergyDensity(MetricPrefix prefix, double joulePerCubicMeter) => m_value = prefix.ConvertPrefix(joulePerCubicMeter, MetricPrefix.Unprefixed);
    ...
    public string ToSiUnitString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null)
      => GetSiUnitValue(prefix).ToSiFormattedString(format, formatProvider) + UnicodeSpacing.ThinSpace.ToSpacingString() + prefix.GetMetricPrefixSymbol() + EnergyDensityUnit.JoulePerCubicMeter.GetUnitSymbol();
    ...
    public string ToUnitString(EnergyDensityUnit unit = EnergyDensityUnit.JoulePerCubicMeter, string? format = null, System.IFormatProvider? formatProvider = null, UnicodeSpacing spacing = UnicodeSpacing.Space, bool fullName = false)
    {
