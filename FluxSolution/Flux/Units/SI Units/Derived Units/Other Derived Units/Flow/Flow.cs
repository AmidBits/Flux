namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<Flow>, System.IFormattable, ISiUnitValueQuantifiable<double, FlowUnit>
  {
    ...
    public string ToSiUnitString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null)
      => GetSiUnitValue(prefix).ToSiFormattedString(format, formatProvider) + Unicode.UnicodeSpacing.ThinSpace.ToSpacingString() + prefix.GetMetricPrefixSymbol() + FlowUnit.CubicMeterPerSecond.GetUnitSymbol();
