namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<LinearDensity>, System.IFormattable, ISiUnitValueQuantifiable<double, LinearDensityUnit>
  {
    ...
    public LinearDensity(MetricPrefix prefix, double gramPerMeter) => m_value = prefix.ChangePrefix(gramPerMeter, MetricPrefix.Unprefixed);
    ...
    public string ToSiUnitString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null)
      => GetSiUnitValue(prefix).ToSiFormattedString(format, formatProvider) + Unicode.UnicodeSpacing.ThinSpace.ToSpacingString() + prefix.GetMetricPrefixSymbol() + LinearDensityUnit.GramPerMeter.GetUnitSymbol();
