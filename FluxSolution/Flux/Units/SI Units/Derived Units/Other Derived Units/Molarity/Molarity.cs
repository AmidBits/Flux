namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<Molarity>, System.IFormattable, ISiUnitValueQuantifiable<double, MolarityUnit>
  {
    ...
    public string ToSiUnitString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null)
      => GetSiUnitValue(prefix).ToSiFormattedString(format, formatProvider) + Unicode.UnicodeSpacing.ThinSpace.ToSpacingString() + prefix.GetMetricPrefixSymbol() + MolarityUnit.MolesPerCubicMeter.GetUnitSymbol();
