namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<Permeability>, System.IFormattable, ISiUnitValueQuantifiable<double, PermeabilityUnit>
  {
    ...
    public string ToSiUnitString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null)
      => GetSiUnitValue(prefix).ToSiFormattedString(format, formatProvider) + Unicode.UnicodeSpacing.ThinSpace.ToSpacingString() + prefix.GetMetricPrefixSymbol() + PermeabilityUnit.HenryPerMeter.GetUnitSymbol();
