namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<RadiationExposure>, System.IFormattable, ISiUnitValueQuantifiable<double, RadiationExposureUnit>
  {
    ...
    public RadiationExposure(MetricPrefix prefix, double coulombPerKilogram) => m_value = prefix.ChangePrefix(coulombPerKilogram, MetricPrefix.Unprefixed);
    ...
    public string ToSiUnitString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null)
      => GetSiUnitValue(prefix).ToSiFormattedString(format, formatProvider) + Unicode.UnicodeSpacing.ThinSpace.ToSpacingString() + prefix.GetMetricPrefixSymbol() + RadiationExposureUnit.CoulombPerKilogram.GetUnitSymbol();
