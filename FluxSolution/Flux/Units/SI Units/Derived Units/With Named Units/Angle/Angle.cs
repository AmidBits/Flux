namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<Angle>, System.IFormattable, ISiUnitValueQuantifiable<double, AngleUnit>
  {
    ...
    public static Angle AsAzimuth(Angle angle) => new(angle.Value.Wrap(0, double.Tau, IntervalNotation.Closed) % double.Tau);
    ...
    public static Angle AsLongitude(Angle angle) => new(angle.Value.Wrap(-double.Pi, double.Pi, IntervalNotation.Closed));
    ...
    public string ToUnitString(AngleUnit unit = AngleUnit.Radian, string? format = null, System.IFormatProvider? formatProvider = null, UnicodeSpacing spacing = UnicodeSpacing.Space, bool fullName = false)
    {
      ...
      return value.ToString(format, formatProvider)
          + (fullName
          ? spacing.ToSpacingString() + unit.GetUnitName(value.IsConsideredPlural())
