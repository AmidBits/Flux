namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<Angle>, System.IFormattable, ISiUnitValueQuantifiable<double, AngleUnit>
  {
    ...
    public static string ToStringDmsNotation(double decimalDegrees, AngleDmsNotation dmsNotation, PlanetaryScience.CompassCardinalAxis axis, int decimalPoints = -1, Unicode.UnicodeSpacing componentSpacing = Unicode.UnicodeSpacing.None)
    {
    ...
    public string ToSiUnitString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null)
      => GetSiUnitValue(prefix).ToSiFormattedString(format, formatProvider) + Unicode.UnicodeSpacing.ThinSpace.ToSpacingString() + prefix.GetMetricPrefixSymbol() + AngleUnit.Radian.GetUnitSymbol();
    ...
    public string ToUnitString(AngleUnit unit = AngleUnit.Radian, string? format = null, System.IFormatProvider? formatProvider = null, bool fullName = false)
    {
      ...
      return value.ToString(format, formatProvider)
          + (fullName
          ? Unicode.UnicodeSpacing.Space.ToSpacingString() + unit.GetUnitName(value.IsConsideredPlural())
          : (unit.HasUnitSpacing(true) ? Unicode.UnicodeSpacing.Space : Unicode.UnicodeSpacing.None).ToSpacingString() + unit.GetUnitSymbol(true)
          );
    }
