namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<CatalyticActivity>, System.IFormattable, ISiUnitValueQuantifiable<double, CatalyticActivityUnit>
  {
    ...
    public CatalyticActivity(MetricPrefix prefix, double katal) => m_value = prefix.ConvertPrefix(katal, MetricPrefix.Unprefixed);
    ...
    public string ToSiUnitString(MetricPrefix prefix, string? format = null, System.IFormatProvider? formatProvider = null)
      => GetSiUnitValue(prefix).ToSiFormattedString(format, formatProvider) + UnicodeSpacing.ThinSpace.ToSpacingString() + prefix.GetMetricPrefixSymbol() + CatalyticActivityUnit.Katal.GetUnitSymbol();
    ...
    public string ToUnitString(CatalyticActivityUnit unit = CatalyticActivityUnit.Katal, string? format = null, System.IFormatProvider? formatProvider = null, UnicodeSpacing spacing = UnicodeSpacing.Space, bool fullName = false)
    {
