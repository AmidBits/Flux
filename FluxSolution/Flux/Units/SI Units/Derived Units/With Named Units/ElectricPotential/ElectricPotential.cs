namespace Flux.Units
{
    ...
    : System.IComparable, System.IComparable<ElectricPotential>, System.IFormattable, ISiUnitValueQuantifiable<double, ElectricPotentialUnit>
  {
    ...
    public ElectricPotential(MetricPrefix prefix, double volt) => m_value = prefix.ConvertPrefix(volt, MetricPrefix.Unprefixed);
    ...
    public string ToUnitString(ElectricPotentialUnit unit = ElectricPotentialUnit.Volt, string? format = null, System.IFormatProvider? formatProvider = null, UnicodeSpacing spacing = UnicodeSpacing.Space, bool fullName = false)
    {
