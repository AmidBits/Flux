namespace Flux
{
  ...
  public enum UniversalRounding
  {
    ...
    /// </summary>
    HalfToAlternating = HalfRounding.ToAlternating,

    /// <summary>
    /// <para></para>
    /// </summary>
    IntegralToEven = IntegralRounding.ToEven,
    ...
    /// </remarks>
    IntegralAwayFromZero = IntegralRounding.AwayFromZero,
    ...
    /// </remarks>
    IntegralTowardZero = IntegralRounding.TowardZero,
    ...
    /// </remarks>
    IntegralToNegativeInfinity = IntegralRounding.ToNegativeInfinity,
    ...
    /// </remarks>
    IntegralToPositiveInfinity = IntegralRounding.ToPositiveInfinity,

    /// <summary>
    /// <para></para>
    /// </summary>
    IntegralToOdd = IntegralRounding.ToOdd,

    /// <summary>
    /// <para></para>
    /// </summary>
    IntegralToRandom = IntegralRounding.ToRandom,
  }

  public static class XtensionUniversalRounding
  {
    /// <summary>
    ...
    public static TValue RoundUniversal<TValue>(this TValue value, UniversalRounding mode)
      ...
      => value.TryRoundToIntegral((IntegralRounding)mode, out var whole)
      ? whole
      : value.TryRound((HalfRounding)mode, out var half)
      ? half
