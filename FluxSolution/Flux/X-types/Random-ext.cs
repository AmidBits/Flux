...
namespace Flux
{
  public static partial class RandomExtensions
  {
    ...
    extension(System.Random source)
    {
      ...
      /// <summary>
      /// <para>Generates a new random <see cref="System.Numerics.BigInteger"/> in the interval [0, {<c>bitLength</c> sized mask}).</para>
      /// <para>Since <see cref="System.Numerics.BigInteger"/> is a variable sized type, this enables a random value by a number-of-bits instead of a maxValue.</para>
      /// </summary>
      /// <param name="bitLength"></param>
      /// <returns></returns>
      public System.Numerics.BigInteger NextBigInteger(int bitLength)
      {
        System.ArgumentOutOfRangeException.ThrowIfNegativeOrZero(bitLength);

        return NextBigInteger(source, new System.Numerics.BigInteger(BitOps.CreateBitMaskRight(bitLength)));
      }

      /// <summary>
      /// <para>Creates a new random <see cref="System.Numerics.BigInteger"/> in the interval [0, <paramref name="maxValue"/>).</para>
      /// </summary>
      ...
      public System.Numerics.BigInteger NextBigInteger(System.Numerics.BigInteger maxValue)
      {
        ...
        if (maxValue == System.Numerics.BigInteger.One)
          return System.Numerics.BigInteger.Zero;

        var byteCount = int.CreateChecked(double.Ceiling(System.Numerics.BigInteger.Log(maxValue, 256)));
        ...
        do
        {
          ...
          byteArray[^1] &= 0x7F; // ensure positive

          result = new System.Numerics.BigInteger(byteArray);
        }
        while (result >= maxValue); // reject if out of range

        return result;
      }

      /// <summary>
      /// <para>Creates a new random <see cref="System.Numerics.BigInteger"/> in the interval [<paramref name="minValue"/>, <paramref name="maxValue"/>).</para>
      /// </summary>
