  ...
  public static partial class ReadOnlySpanExtensions
  {
    ...
    extension<T>(System.ReadOnlySpan<T> source)
    {
      ...
      */
      ...
      public System.Collections.Generic.IEnumerable<System.Range> SplitByLength(int length)
        => BinaryIntegers.GenerateSubRanges(source.Length, length);
    ...
    extension(System.ReadOnlySpan<byte> source)
    {
        ...
        where TInteger : System.Numerics.IBinaryInteger<TInteger>
      {
        ...
        if (prefixBits > 0)
        {
          bitBuffer = TInteger.CreateChecked(source[byteIndex++] & BitOps.CreateBitMaskRight(prefixBits)); // Note that byteIndex advances if there are prefixBits.
        ...
        if (suffixBits > 0)
          bitBuffer = (bitBuffer << suffixBits) | (TInteger.CreateChecked((source[byteIndex + byteLength] >> (8 - suffixBits)) & BitOps.CreateBitMaskRight(suffixBits)));
