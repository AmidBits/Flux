namespace FluxNet.Numerics
{
  public static partial class Maths
  {
      ...
      where TInteger : System.Numerics.IBinaryInteger<TInteger>
    {
      ...
      return checked(value.SplitFactorial() / (value - exponent).SplitFactorial());
    }
      ...
      where TInteger : System.Numerics.IBinaryInteger<TInteger>
    {
      ...
      return checked((value + exponent - TInteger.One).SplitFactorial() / (value - TInteger.One).SplitFactorial());
    }
  }
}
