namespace FluxNet.Numerics
{
  public static partial class Maths
  {
    ...
    public static TNumber FastIntegerPow<TNumber, TPower>(this TNumber number, TPower power, MidpointRounding mode, out double pow)
      where TNumber : System.Numerics.INumber<TNumber>
      where TPower : System.Numerics.INumber<TPower>
      => checked(TNumber.CopySign(TNumber.CreateChecked(double.Round(pow = double.Pow(double.CreateChecked(TNumber.Abs(number)), double.CreateChecked(power)), mode)), number));
  }
}
