namespace FluxNet.Numerics
{
  public static partial class Maths
  {
    ...
    public static TNumber FastIntegerSqrt<TNumber>(this TNumber number, MidpointRounding mode, out double sqrt)
      where TNumber : System.Numerics.INumber<TNumber>
      => checked(TNumber.CopySign(TNumber.CreateChecked(double.Round(sqrt = double.Sqrt(double.CreateChecked(TNumber.Abs(number))), mode)), number));
  }
}
