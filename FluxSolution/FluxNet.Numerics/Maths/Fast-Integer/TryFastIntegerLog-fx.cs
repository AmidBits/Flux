namespace FluxNet.Numerics
{
  public static partial class Maths
  {
    ...
    public static bool TryFastIntegerLog<TINumber, TIRadix, TILog>(this TINumber value, TIRadix radix, System.MidpointRounding mode, out TILog integerLog, out double log)
