namespace FluxNet.Numerics.Statistics.Quantile
{
  /// <summary>
    ...
    : IQuantileEstimatable
  {
    ...
    public TPercent EstimateQuantileRank<TCount, TPercent>(TCount count, TPercent p)
      ...
      => (TPercent.CreateChecked(count) + TPercent.CreateChecked(OneFourth)) * Extensions.AssertPercent(p) + TPercent.CreateChecked(ThreeEights);
