namespace Flux
{
  ...
  public static partial class SpanExtensions
  {
    extension<T>(System.Span<T> source)
    {
      ...
      /// <summary>
      /// <para>Find the Kth smallest element in an unordered list, between min/max-index.</para>
      /// <para><see href="https://en.wikipedia.org/wiki/Quickselect"/></para>
      /// </summary>
      ...
      /// <returns></returns>
      public T QuickSelect(int minIndex, int maxIndex, int kth, System.Collections.Generic.IComparer<T>? comparer = null)
      {
        ...
        while (true)
        {
          var pivotIndex = QuickSelectPartition(source, kth, minIndex, maxIndex, comparer);

          if (kth < pivotIndex) maxIndex = pivotIndex - 1;
          else if (kth > pivotIndex) minIndex = pivotIndex + 1;
      ...
      public System.Span<T> Replace(System.Func<T, int, T> replacementSelector, System.Collections.Generic.IEqualityComparer<T>? equalityComparer = null)
      {
        ...
        for (var i = source.Length - 1; i >= 0; i--)
          if (source[i] is var sourceT && replacementSelector(sourceT, i) is var replacementT && !equalityComparer.Equals(replacementT, sourceT))
            source[i] = replacementT;

        return source;
      }

      /// <summary>Replace all values in <paramref name="source"/> using the specified <paramref name="replacementSelector"/>.</summary>
      public System.Span<T> Replace(System.Func<T, T> replacementSelector, System.Collections.Generic.IEqualityComparer<T>? equalityComparer = null)
        => Replace(source, (e, i) => replacementSelector(e), equalityComparer);
      ...
      /// <summary>
      /// <para>Rotates all items in a <see cref="System.Span{T}"/> a specified <paramref name="count"/> number of steps (in both positive and negative directions).</para>
      /// </summary>
      /// <param name="count">
    ...
    extension(System.Span<char> source)
    {
      ...
      /// <returns></returns>
      public System.Span<char> CapitalizeWords(System.Globalization.CultureInfo? cultureInfo = null)
      {
      ...
      /// <param name="cultureInfo">If null, then use <see cref="System.Globalization.CultureInfo.CurrentCulture"/>.</param>
      /// <returns></returns>
      public System.Span<char> UncapitalizeWords(System.Globalization.CultureInfo? cultureInfo = null)
      {
        cultureInfo ??= System.Globalization.CultureInfo.CurrentCulture;
      ...
      public System.Span<char> ToLower(System.Globalization.CultureInfo? cultureInfo = null)
      {
        ...
        return Replace(source, e => char.IsUpper(e) ? char.ToLower(e, cultureInfo) : e);
      }
      ...
      public System.Span<char> ToUpper(System.Globalization.CultureInfo? cultureInfo = null)
      {
        ...
        return Replace(source, e => char.IsLower(e) ? char.ToUpper(e, cultureInfo) : e);
      }
    ...
    //  /// <param name="cultureInfo">If null, then use <see cref="System.Globalization.CultureInfo.CurrentCulture"/>.</param>
    //  /// <returns></returns>
    //  public System.Span<System.Text.Rune> CapitalizeWords(System.Globalization.CultureInfo? cultureInfo = null)
    //  {
    //    cultureInfo ??= System.Globalization.CultureInfo.CurrentCulture;

    //    var r = source[0];
    //    if (System.Text.Rune.IsLower(r))
    //      source[0] = System.Text.Rune.ToUpper(r, cultureInfo);
    ...
    //    {
    //      r = source[i];
    //      if (System.Text.Rune.IsWhiteSpace(source[i - 1]) && System.Text.Rune.IsLower(r) && System.Text.Rune.IsLower(source[i + 1]))
    ...
    //    var r = source[0];
    //    if (System.Text.Rune.IsUpper(r))
    //      source[0] = System.Text.Rune.ToLower(r, cultureInfo);
    ...
    //    {
    //      r = source[i];
    //      if (System.Text.Rune.IsWhiteSpace(source[i - 1]) && System.Text.Rune.IsUpper(r) && System.Text.Rune.IsLower(source[i + 1]))
    ...
    //    return Replace(source, e => System.Text.Rune.IsUpper(e) ? System.Text.Rune.ToLower(e, cultureInfo) : e);
    //  }
    ...
    //    return Replace(source, e => System.Text.Rune.IsLower(e) ? System.Text.Rune.ToUpper(e, cultureInfo) : e);
    //  }
    ...
    /// <summary>
    /// <para>Group a list (from left to right index) into two parts, those less than a certain element, and those greater than or equal to the element.</para>
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="source"></param>
