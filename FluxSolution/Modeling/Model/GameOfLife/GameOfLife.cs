...
//        {
//          var index = Geometry.CoordinateSystems.CartesianCoordinate.ConvertCartesian2ToLinearIndex(c, r, m_cellGrid.X);
...
//          var pointIndex = Geometry.CoordinateSystems.CartesianCoordinate.ConvertCartesian2ToLinearIndex(x1, y1, m_cellGrid.X);

//          cn += m_deadOrAlive[(int)pointIndex] ? 1 : 0;
//        }
//      }

//      var positionIndex = Geometry.CoordinateSystems.CartesianCoordinate.ConvertCartesian2ToLinearIndex(x, y, m_cellGrid.X);
...
//        {
//          var index = Geometry.CoordinateSystems.CartesianCoordinate.ConvertCartesian2ToLinearIndex(x, y, m_cellGrid.X);
