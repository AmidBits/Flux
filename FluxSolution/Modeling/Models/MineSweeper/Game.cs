...
namespace Flux.Model.MineSweeper
{
  public static class Game
  {
    ...
    public static void PlayInConsole()
    {
      ...
      {
        if (Numerics.CartesianCoordinate2<int>.TryParse(line, out var point))
        {
    ...
    private static Covers UncoverDeep(this Covers covers, MineField mineField, Numerics.CartesianCoordinate2<int> point)
    {
