...
namespace Flux.Model.MineSweeper
{
    ...
    : System.Collections.Generic.IReadOnlySet<System.Drawing.Point>
  {
    ...
    public static Mines Create(Field field, int count)
      => new(System.Linq.Enumerable.Repeat(Random.NumberGenerators.Crypto, count * 2).Select(r => new System.Drawing.Point(r.Next(field.Size.X), r.Next(field.Size.Y))).Distinct().Take(count).ToHashSet());
