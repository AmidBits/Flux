namespace Flux.Win32.User32
{
  ...
  public static class NativeMethods
  {
    ...
    private static extern bool GetCursorPos(out CoordinateSystems.CartesianCoordinate2<int> lpPoint);
    /// <summary>Retrieves the position of the mouse cursor, in screen coordinates.</summary>
    public static bool TryGetCursorPos(out CoordinateSystems.CartesianCoordinate2<int> point)
    ...
    public static bool TrySetCursorPos(CoordinateSystems.CartesianCoordinate2<int> point)
