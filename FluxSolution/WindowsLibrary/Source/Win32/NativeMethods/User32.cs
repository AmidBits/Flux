namespace Flux.Win32.User32
{
  ...
  public static class NativeMethods
  {
    ...
    private static extern bool GetCursorPos(out Numerics.CartesianCoordinate2<int> lpPoint);
    /// <summary>Retrieves the position of the mouse cursor, in screen coordinates.</summary>
    public static bool TryGetCursorPos(out Numerics.CartesianCoordinate2<int> point)
    ...
    public static bool TrySetCursorPos(Numerics.CartesianCoordinate2<int> point)
