namespace Flux.Wpf
{
  public static partial class Windows
  {
    ...
    {
      var angle = Flux.Units.Angle.ConvertCartesian2ToRotationAngleEx(point.X, point.Y);

      return inDegrees ? Units.Angle.ConvertRadianToDegree(angle) : angle;
    }
    ...
    {
      var (x, y) = Flux.Units.Angle.ConvertRotationAngleToCartesian2Ex(inDegrees ? Units.Angle.ConvertDegreeToRadian(angularRotation) : angularRotation);
