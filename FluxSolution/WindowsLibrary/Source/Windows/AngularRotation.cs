...
namespace Flux.Wpf
{
  public static partial class Windows
  {
    ...
    {
      var (_, azimuth) = Flux.Geometry.PolarCoordinate.ConvertCartesian2ToPolarEx(point.X, point.Y);
    ...
    {
      var (x, y) = Flux.Geometry.PolarCoordinate.ConvertPolarToCartesian2Ex(magnitude, inDegrees ? Units.Angle.ConvertDegreeToRadian(angularRotation) : angularRotation);
