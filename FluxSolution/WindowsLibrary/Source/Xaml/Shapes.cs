namespace Flux.Wpf
{
  public static partial class Media
  {
    public static partial class Shapes
    {
      ...
      {
        var step = double.Tau / numberOfSides;

        for (var angle = 0.0; angle < double.Tau; angle += step)
      ...
      public static System.Windows.Point PatternCircle(double unitRatio)
      {
        ...
        return Units.Angle.ConvertDegreeToRadian(unitRatio * 360.0).AngularRotationToPoint();
      }
