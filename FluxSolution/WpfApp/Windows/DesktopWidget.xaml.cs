...
namespace WpfApp
{
	...
	{
		private readonly System.Windows.Media.Brush m_foreground = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Colors.AntiqueWhite);

		private readonly System.Windows.Media.FontFamily m_fontFamily = new System.Windows.Media.FontFamily(@"Segoe UI");
		private readonly double m_fontSize = 15;

		private readonly int m_windowOffsetLeft = 410;
		private readonly int m_windowOffsetTop = 10;

		private readonly int m_updateIntervalInSeconds = 59;

		private readonly string m_itdNocPhoneNumber = @"72-48471";
		private readonly System.Uri m_itdServiceDeskUri = new System.Uri(@"http://support.pima.gov/");
		...
		private readonly System.Windows.Threading.DispatcherTimer m_timer = new System.Windows.Threading.DispatcherTimer();
		...
		System.Collections.Generic.List<System.Collections.Generic.KeyValuePair<string, object>> GenerateValues()
		{
			...
			properties.Add(new System.Collections.Generic.KeyValuePair<string, object>(@"Operating System", Flux.Locale.OperatingSystemTitle));
