namespace Flux.Wpf
{
  public static partial class Windows
  {
    ...
    public static double PointToAngularRotation(this System.Windows.Point point, bool inDegrees = false)
      => inDegrees ? Flux.Media.Units.Angle.ConvertRadianToDegree(Flux.Media.Units.Angle.ConvertCartesianToRotationAngleEx(point.X, point.Y)) : Flux.Media.Units.Angle.ConvertCartesianToRotationAngleEx(point.X, point.Y);
    ...
    {
      Flux.Media.Units.Angle.ConvertRotationAngleToCartesianEx(inDegrees ? Flux.Media.Units.Angle.ConvertDegreeToRadian(angularRotation) : angularRotation, out var x, out var y);
