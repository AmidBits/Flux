namespace Flux.Wpf
{
  public static partial class Windows
  {
    ...
    public static double PointToAngularRotation(this System.Windows.Point point, bool inDegrees = false)
      => inDegrees ? Angle.RadianToDegree(Angle.CartesianToRotationAngleEx(point.X, point.Y)) : Angle.CartesianToRotationAngleEx(point.X, point.Y);
    ...
    {
      Angle.RotationAngleToCartesianEx(inDegrees ? Angle.DegreeToRadian(angularRotation) : angularRotation, out var x, out var y);
