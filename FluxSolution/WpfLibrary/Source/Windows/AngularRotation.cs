namespace Flux.Wpf
{
  public static partial class Windows
  {
    ...
    public static double PointToAngularRotation(this System.Windows.Point point, bool inDegrees = false)
      => inDegrees ? Units.Angle.ConvertRadianToDegree(Units.Angle.ConvertCartesianToRotationAngleEx(point.X, point.Y)) : Units.Angle.ConvertCartesianToRotationAngleEx(point.X, point.Y);
    ...
    {
      Units.Angle.ConvertRotationAngleToCartesianEx(inDegrees ? Units.Angle.ConvertDegreeToRadian(angularRotation) : angularRotation, out var x, out var y);
