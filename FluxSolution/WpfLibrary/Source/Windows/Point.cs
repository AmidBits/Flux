...
namespace Flux.Wpf
{
	public static partial class Windows
	{
		...
		public static double GetAngleTo(this System.Windows.Point self, System.Windows.Point point, bool inDegrees = false)
		{
			...
			if (inDegrees)
				return Flux.Media.Units.Angle.ConvertRadianToDegree(angleInRadians);
		...
		{
			if (inDegrees)
				relativeRotationAngle = Flux.Media.Units.Angle.ConvertDegreeToRadian(relativeRotationAngle);
