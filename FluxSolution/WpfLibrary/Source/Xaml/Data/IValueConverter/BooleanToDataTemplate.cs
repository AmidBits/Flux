namespace Flux.Wpf.IValueConverter
{
  ...
  public class BooleanToDataTemplate : ValueConverter
  {
    ...
    {
      if (value is System.Boolean && targetType == typeof(System.Windows.DataTemplate))
      ...
      if (value is System.Windows.DataTemplate && targetType == typeof(System.Boolean))
      {
        if ((System.Windows.DataTemplate)value == DataTemplateWhenFalse)
          return BooleanInverse ^ false;
        if ((System.Windows.DataTemplate)value == DataTemplateWhenTrue)
