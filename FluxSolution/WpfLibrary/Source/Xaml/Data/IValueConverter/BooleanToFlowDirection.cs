namespace Flux.Wpf.IValueConverter
{
  ...
  public class BooleanToFlowDirection : ValueConverter
  {
    ...
    public object UniversalConversion(object value, System.Type targetType, object parameter, System.Globalization.CultureInfo culture, string caller)
    {
      if (value is System.Boolean && targetType == typeof(System.Windows.FlowDirection))
        switch (BooleanInverse ^ (bool)value)
        {
          case false:
      ...
      if (value is System.Windows.FlowDirection && targetType == typeof(System.Boolean))
        switch ((System.Windows.FlowDirection)value)
        {
